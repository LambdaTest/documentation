...
<div className="support_main">
  ...
  <a href = "/support/docs/hyperexecute-job-reports/#playwright-html">
  <div className="support_inners">
  ...
  <a href="/support/docs/hyperexecute-artifacts/#construct-urls-for-your-artifacts">
  <div className="support_inners">
...
Pick your language and framework below. Each variant uses its own <BrandName /> sample repository (with a ready-to-run HyperExecute YAML), configures the YAML for that framework, and triggers the job from the repository root.
...
<Tabs className="docs__val" groupId="pw-js">

<TabItem value="vanillajs" label="VanillaJS" default>
...
Download or Clone the code sample for the VanillaJS from the <BrandName /> GitHub repository to run the tests on the HyperExecute.
...
Download or Clone the code sample for the Jest from the <BrandName /> GitHub repository to run the tests on the HyperExecute.
...
Download or Clone the code sample for the CodeceptJS from the <BrandName /> GitHub repository to run the tests on the HyperExecute.
...
Download or Clone the code sample for the DotNet from the <BrandName /> GitHub repository to run the tests on the HyperExecute.
...
<Tabs className="docs__val" groupId="pw-python">
...
Download or Clone the code sample for the Python from the <BrandName /> GitHub repository to run the tests on the HyperExecute.
...
Download or Clone the code sample for the PyTest from the <BrandName /> GitHub repository to run the tests on the HyperExecute.
