...
<img loading="lazy" src="/assets/images/sso/ping-identity/1.png" alt="setup sso button" className="doc_img"/>
...
- Select **PingFederate** as your identity provider (PingIdentity & PingFederate has identical setup from <BrandName /> side).
   <img loading="lazy" src="/assets/images/sso/ping-identity/select-ping.png" alt="select identity provider" width="944" height="407" className="doc_img"/>

### Step 3: Add a New Application in PingIdentity
- Navigate to the Applications menu on the toolbar.
- Click on Add Application.
  <img loading="lazy" src="/assets/images/sso/ping-identity/2.png" alt="add application" className="doc_img"/>

- In the Add Application window, select Create New App to create a new application for <BrandName /> SSO integration.
  <img loading="lazy" src="/assets/images/sso/ping-identity/3.png" alt="create new app" className="doc_img"/>

### Step 4: Add SAML configuration
- In <BrandName /> SSO setup copy the **ACS URLs** and **Entity ID**.
  <img loading="lazy" src="/assets/images/sso/ping-identity/sso-setup.png" alt="ping-integration-sso-setup" width="944" height="487" className="doc_img"/>
...
- In Pingidentity, select the **Manually Enter** option in **SAML Configuration** and enter **ACS URLs** and **Entity ID** copied from above step.
  <img loading="lazy" src="/assets/images/sso/ping-identity/4.png" alt="setup sso button" className="doc_img"/>

### Step 5: Configure Attribute Mappings
- Copy following attribute from Lambdatest SSO setup.
   <img loading="lazy" src="/assets/images/sso/ping-identity/sso-attribute.png" alt="ping-integration-attribute-mapping" width="944" height="487" className="doc_img"/>
...
- Add and update the other attributes
  <img loading="lazy" src="/assets/images/sso/ping-identity/6.png" alt="attribute-mapping" className="doc_img"/>
...
- Copy the **IDP Metadata URL** from PingIdentity
  <img loading="lazy" src="/assets/images/sso/ping-identity/7.png" alt="ping-integration-idp-url" width="944" height="487" className="doc_img"/>

- Go back to <BrandName /> and paste the copied URL in the **Issuer URL** field and click on **Create Connection**:
  <img loading="lazy" src="/assets/images/sso/ping-identity/issuer-url.png" alt="sso-self serve" width="945" height="542" className="doc_img"/>
