...
<img loading="lazy" src={require('../assets/images/local-testing-windows/local-windows-13.webp').default} alt="Testing Local folder on <BrandName />" width="1342" height="608" className="doc_img"/>
...
<img loading="lazy" src={require('../assets/images/local-testing-windows/close tunnel.webp').default} alt="disconnecting <BrandName /> tunnel" width="1349" height="622" className="doc_img"/> 
