...
<img loading="lazy" src={require('../assets/images/hyperexecute/robot/robot_autosplit_1.png').default} alt="automation-dashboard"  width="1920" height="868" className="doc_img"/>
