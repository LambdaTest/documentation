...
**Step 5:** You can also perform a step directly in the instance window instead of describing it. While your session is in the **Authoring Steps** state, KaneAI captures the action and creates an automation step for it — there is nothing to switch on. See [Manual Interaction](/support/docs/kaneai-manual-interaction/).
