...
sidebarTitle: "Bulk-Update Modules Across Tests"
keywords: ['lambdatest automation', 'lambdatest kaneai', 'kaneai modules', 'bulk update', 'module version', 'test case management']
...
<img loading="lazy" src="/assets/images/kane-ai/features/bulk-module-update/module-detail-cta.png" alt="module-detail-cta" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/kane-ai/features/bulk-module-update/test-case-summary-cta.png" alt="test-case-summary-cta" className="doc_img"/>
...
{/* <img loading="lazy" src="/assets/images/kane-ai/features/bulk-module-update/disabled-cta.png" alt="disabled-cta" className="doc_img"/> */}
...
<img loading="lazy" src="/assets/images/kane-ai/features/bulk-module-update/test-case-selection.png" alt="test-case-selection" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/kane-ai/features/bulk-module-update/summary-screen.png" alt="summary-screen" className="doc_img"/>

---

After triggering the update, you will see a success banner along with a toast message as shown in the screenshot below

<img loading="lazy" src="/assets/images/kane-ai/features/bulk-module-update/toast-notification.png" alt="toast-notification" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/kane-ai/features/bulk-module-update/code-gen-section.png" alt="code-gen-section" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/kane-ai/features/bulk-module-update/linked-test-cases.png" alt="linked-test-cases" className="doc_img"/>
