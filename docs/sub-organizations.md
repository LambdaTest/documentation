...
**Step 1:** Sign in to your <BrandName /> account. If you don't have an account, <a href="https://accounts.lambdatest.com/register" onClick={CookieTrackingSignup}>register for free</a>.
