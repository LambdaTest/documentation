...
title: SmartUI Testing on HyperExecute with Hooks
sidebar_label: Test with Hooks
description: Run SmartUI visual regression tests on HyperExecute using SmartUI Hooks with Selenium, Cypress, and Playwright, plus no-code URL capture with the SmartUI CLI.
keywords:
  - smartui hooks hyperexecute
  - visual regression testing
  - smartui capture
  - selenium cypress playwright hyperexecute
url: https://www.testmuai.com/support/docs/smartui-hooks-with-hyperexecute/
site_name: TestMu AI
slug: smartui-hooks-with-hyperexecute/
canonical: https://www.testmuai.com/support/docs/smartui-hooks-with-hyperexecute/
---
...
<Tabs className="docs__val" groupId="dom-config">
...
<Tabs className="docs__val" groupId="dom-config-select">
