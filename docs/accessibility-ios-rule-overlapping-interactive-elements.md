---
id: accessibility-ios-rule-overlapping-interactive-elements
title: Overlapping Interactive Elements
sidebar_label: Overlapping Interactive Elements
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/accessibility-ios-rule-overlapping-interactive-elements/"
    },
    "headline": "Overlapping Interactive Elements",
    "description": "Rule-level Accessibility guidance for Overlapping Interactive Elements on iOS.",
    "url": "https://www.testmuai.com/support/docs/accessibility-ios-rule-overlapping-interactive-elements/",
    "image": {
      "@type": "ImageObject",
