      ...
      "step": [
        {
          ...
          "position": 1,
          "name": "Step 1: Clone the Sample Project",
          "text": "Install the TestMu AI npm plugin for TestCafe.",
          "url": "https://www.testmuai.com/support/docs/npm-plugin-for-testcafe-integration-with-testmu/#step-1-clone-the-sample-project"
        },
        {
          "@type": "HowToStep",
          "position": 2,
          ...
          "url": "https://www.testmuai.com/support/docs/npm-plugin-for-testcafe-integration-with-testmu/#step-2-set-your-credentials"
        },
        {
          "@type": "HowToStep",
          "position": 3,
          "name": "Step 3: Configure Your Test Capabilities",
          "text": "Configure your tests using environment variables for resolution, build name, and other settings. Generate capabilities for your test requirements with the Capabilities Generator.",
          "url": "https://www.testmuai.com/support/docs/npm-plugin-for-testcafe-integration-with-testmu/#step-3-configure-your-test-capabilities"
        },
        {
          "@type": "HowToStep",
          "position": 4,
          "name": "Step 4: Run the Test",
          "text": "Execute the test using the following command. Single test: Parallel tests: Using the API: To list all available browser aliases:",
          "url": "https://www.testmuai.com/support/docs/npm-plugin-for-testcafe-integration-with-testmu/#step-4-run-the-test"
        },
        {
          "@type": "HowToStep",
          "position": 5,
          ...
          "url": "https://www.testmuai.com/support/docs/npm-plugin-for-testcafe-integration-with-testmu/#step-5-view-your-results"
        }
      ]
    }
  ]) }}
