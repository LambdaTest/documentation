---
title: "How to Write Kane CLI Objectives"
...
Pointing a mobile run at a website is not supported yet. WebViews inside the app under test are handled. See [Mobile Testing](/docs/kane-cli-mobile/).
