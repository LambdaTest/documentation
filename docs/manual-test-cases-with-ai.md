...
keywords:
  ...
  - test cases
  - test case
url: https://www.testmuai.com/support/docs/manual-test-cases-with-ai/
site_name: TestMu AI
slug: manual-test-cases-with-ai/
canonical: https://www.testmuai.com/support/docs/manual-test-cases-with-ai/
---
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/manual-test-cases-with-ai/"
    },
    "headline": "Manual Test Cases with AI",
    "description": "Enhance your manual test cases with AI from TestMu AI's Test Manager, facilitating efficient management of all testing activities on a single platform.",
    "url": "https://www.testmuai.com/support/docs/manual-test-cases-with-ai/",
    "image": {
      "@type": "ImageObject",
