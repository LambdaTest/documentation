...
<img loading="lazy" src="/assets/images/ai-capabilities/settings-menu.png" alt="Navigate to Settings" width="404" height="206" className="doc_img img_center"/>

**Step 3:** Navigate to the **Org Product Preferences** tab.

**Step 4:** Select **AI Capabilities** from the left sidebar.

<img loading="lazy" src="/assets/images/ai-capabilities/ai-capabilities-page.png" alt="AI Capabilities Settings Page" width="404" height="206" className="doc_img img_center"/> 
...
<img loading="lazy" src="/assets/images/ai-capabilities/disable-confirmation.png" alt="Disable AI Confirmation Dialog" width="404" height="206" className="doc_img img_center"/>
