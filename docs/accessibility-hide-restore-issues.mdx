...
sidebarTitle: "Hide & Restore Issues"
...
"og:description": "Hide or restore accessibility issues at the URL, rule, element group, or element level, add reasons, and control whether the preference should also apply to future scheduled web scans."
---
...
<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/hierarchy-switch.png" alt="Hierarchy switch in the accessibility report showing the URL, rule, element group, and element structure" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/hide-issue-icon.png" alt="Hide issue action icon in the accessibility report" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/hide-issue-url.png" alt="Hide action initiated from the URL level in the accessibility report" className="doc_img"/>

<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/hide-issue-url-modal.png" alt="Hide issue confirmation modal for the URL level" className="doc_img"/>

**Hide at rule level**

Use this when the hide action should apply to one rule and the issues grouped under that rule.

<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/hide-issue-rule.png" alt="Hide action initiated from the rule level in the accessibility report" className="doc_img"/>

<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/hide-issue-rule-modal.png" alt="Hide issue confirmation modal for the rule level" className="doc_img"/>

**Hide at element group level**

Use this when the issue set should be hidden only for a specific group of similar elements.

<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/hide-issue-elementgroup.png" alt="Hide action initiated from the element group level in the accessibility report" className="doc_img"/>

<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/hide-issue-elementgroup-modal.png" alt="Hide issue confirmation modal for the element group level" className="doc_img"/>

**Hide at element level**

Use this when only a single element-level issue should be hidden.

<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/hide-issue-element.png" alt="Hide action initiated from the individual element level in the accessibility report" className="doc_img"/>

<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/hide-issue-element-modal.png" alt="Hide issue confirmation modal for the element level" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/hide-reason-inmodal.png" alt="Hide modal showing the reason selection for hidden issues" className="doc_img"/>

The selected reason is shown later inside the issue as a **reason tag**.

<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/hide-reason-intag.png" alt="Hidden issue showing the selected reason as a tag in the report" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/hide-issue-future.png" alt="Hide issue modal showing the option to apply the hide preference to future scans" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/hidden-issues-tab.png" alt="Hidden Issues tab in the accessibility report" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/restore-issue-icon.png" alt="Restore issue action icon in the Hidden Issues tab" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/restore-issue-modal-current.png" alt="Restore issue modal for issues hidden only in the current scan" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/restore-issue-modal-future.png" alt="Restore issue modal for issues hidden with future scan preference" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/save-current-state.png" alt="Save button used to persist hide and restore issue preferences" className="doc_img"/>

When the save request is processing, the interface shows the in-progress state.

<img loading="lazy" src="/assets/images/accessibility-testing/features/hide-issues/saving-inprogress.png" alt="Accessibility report showing hide and restore preferences being saved" className="doc_img"/>
