...
sidebarTitle: "Connect Your Chat Agent API"
keywords: ['chat agent api', 'agent integration', 'chatbot api', 'agent testing', 'api integration guide']
...
"og:description": "Learn how the platform communicates with your chatbot via API — request format, connection methods, response schema, and integration requirements."
---
