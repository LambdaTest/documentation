...
url: https://www.testmuai.com/support/docs/linear-app-integration/
site_name: TestMu AI
slug: linear-app-integration/
canonical: https://www.testmuai.com/support/docs/linear-app-integration/
---
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/linear-app-integration/"
    },
    "headline": "Linear App Integration",
    "description": "With TestMu AI and Linear App integration, you can perform one-click bug logging to your Linear App projects and capture screenshots, annotate issues, and share them across your teammates and colleagues.",
    "url": "https://www.testmuai.com/support/docs/linear-app-integration/",
    "image": {
      "@type": "ImageObject",
