...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/accessibility-web-rule-3-2-2-on-input/"
    },
    "headline": "On Input (3.2.2)",
    "description": "Rule-level Accessibility guidance for On Input (WCAG 3.2.2 Level A).",
    "url": "https://www.testmuai.com/support/docs/accessibility-web-rule-3-2-2-on-input/",
    "image": {
      "@type": "ImageObject",
