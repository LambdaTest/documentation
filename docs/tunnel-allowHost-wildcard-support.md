...
keywords:
  ...
  - docker vpn tunnel
url: https://www.testmuai.com/support/docs/tunnel-allowHost-wildcard-support/
site_name: TestMu AI
slug: tunnel-allowHost-wildcard-support/
canonical: https://www.testmuai.com/support/docs/tunnel-allowHost-wildcard-support/
---
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/tunnel-allowHost-wildcard-support/"
    },
    "headline": "Support for Wildcard in --allowHosts Flag",
    "description": "Now you can use wildcard values for the -allow-Host flag for setting up the tunnel at TestMu AI.",
    "url": "https://www.testmuai.com/support/docs/tunnel-allowHost-wildcard-support/",
    "image": {
      "@type": "ImageObject",
