...
<img loading="lazy" className="doc_img" src="/assets/images/browserstack-lambdatest-migration/local-test-script.png" alt="Lambdatest text validation result" width="1024" height="667" />
...
<Tab title="Selenium 4 TestMu AI Capabilities">
...
<Tab title="Selenium 3 TestMu AI Capabilities">
