---
title: "How to Maintain a Kane CLI Test Suite"
sidebarTitle: "Maintaining the Suite"
description: "Keep tests aligned with changing requirements: kane-cli maintain reconcile triages each changed source into an ADD/MODIFY/ARCHIVE plan you approve."
keywords: ['kane cli maintain', 'maintain reconcile', 'test suite maintenance', 'requirements change', 'stale tests', 'kaneai', 'testmu ai']
"og:description": "Keep tests aligned with changing requirements: kane-cli maintain reconcile triages each changed source into an ADD/MODIFY/ARCHIVE plan you approve."
---
