...
sidebarTitle: "Run Tests Sequentially"
keywords: ['sequential test runs', 'kaneai test execution', 'dependent test cases', 'test run order', 'multi-platform testing', 'test manager']
...
"og:description": "Learn how to set up and execute sequential test runs in KaneAI to run dependent test cases in a defined order across single and multi-platform configurations."
---
...
<img loading="lazy" src="/assets/images/kane-ai/test-manager/sequential-test-runs/image1.png" alt="enable-sequential-execution" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/kane-ai/test-manager/sequential-test-runs/image2.png" alt="single-platform-configuration" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/kane-ai/test-manager/sequential-test-runs/image3.png" alt="multi-platform-sequential-test-cases" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/kane-ai/test-manager/sequential-test-runs/image4.png" alt="multi-platform-configurations" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/kane-ai/test-manager/sequential-test-runs/image5.png" alt="multi-platform-execution-preview" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/kane-ai/test-manager/sequential-test-runs/image6.png" alt="execute-sequential-run" className="doc_img"/>

<img loading="lazy" src="/assets/images/kane-ai/test-manager/sequential-test-runs/image7.png" alt="sequential-run-results" className="doc_img"/>
