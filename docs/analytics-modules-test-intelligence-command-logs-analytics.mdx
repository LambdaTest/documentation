...
sidebarTitle: "View Command Log Insights"
keywords: ['analytics', 'command logs', 'test intelligence', 'error insights']
---
...
### **Command Status Summary Widget** <span className="border-2 border-[#bf3989] text-[#bf3989] rounded-full px-2 py-0 font-bold text-[0.8em] ml-[0.5em] align-middle inline-block text-xs">BETA</span>
...
### **Command Error Status Trends Widget** <span className="border-2 border-[#bf3989] text-[#bf3989] rounded-full px-2 py-0 font-bold text-[0.8em] ml-[0.5em] align-middle inline-block text-xs">BETA</span>
...
### **Command Type Trends Widget** <span className="border-2 border-[#bf3989] text-[#bf3989] rounded-full px-2 py-0 font-bold text-[0.8em] ml-[0.5em] align-middle inline-block text-xs">BETA</span>
...
### **Command Error Messages Categorization Widget** <span className="border-2 border-[#bf3989] text-[#bf3989] rounded-full px-2 py-0 font-bold text-[0.8em] ml-[0.5em] align-middle inline-block text-xs">BETA</span>
   ...
   **Widget Simulation**
   ...
   <img src="assets/images/analytics/widget.png" alt="cmd" width="768" height="373" />
