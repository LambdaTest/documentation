...
sidebarTitle: "Roles and Permissions (RBAC)"
keywords: ['rbac', 'roles and permissions', 'custom roles', 'access control', 'lambdatest rbac', 'product access', 'granular permissions']
...
"og:description": "Learn how to use Custom Roles and Permissions (RBAC) on LambdaTest to control product-level access and granular permissions across your organization."
---
...
<img loading="lazy" src="/assets/images/rbac-roles-and-permissions/roles-and-permissions-page.png" alt="Roles and Permissions page showing default roles" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/rbac-roles-and-permissions/roles-and-permissions-page.png" alt="Roles and Permissions page showing default roles and Create New Role button" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/rbac-roles-and-permissions/create-new-role.png" alt="Create New Role dialog with entity dropdown showing Select Specific, Product Access, and Granular Control sections" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/rbac-roles-and-permissions/apply-custom-roles.png" alt="Apply custom roles to users from the Members page" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/rbac-roles-and-permissions/team-custom-role-access.png" alt="Assign custom roles to teams" className="doc_img"/>
