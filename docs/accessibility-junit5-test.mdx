---
title: "JUnit 5"
sidebarTitle: "JUnit 5"
keywords: ['TestMu AI', 'Accessibility', 'JUnit 5', 'Selenium', 'Jupiter']
description: "Run Accessibility Automation with Selenium and JUnit 5—capabilities, lifecycle hooks, and dashboard reporting."
"og:description": "Run Accessibility Automation with Selenium and JUnit 5—capabilities, lifecycle hooks, and dashboard reporting."
---
