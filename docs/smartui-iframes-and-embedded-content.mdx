...
sidebarTitle: "Iframes & Embeds"
keywords: ['SmartUI iframe', 'embedded content', 'cross-origin iframe', 'visual regression iframe', 'SmartUI YouTube embed', 'TestMu AI SmartUI']
...
"og:description": "How SmartUI treats same-origin and cross-origin iframes for screenshots and comparison, with practical tips for videos, widgets, and automation context."
---
