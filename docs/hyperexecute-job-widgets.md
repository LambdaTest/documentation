...
keywords:
  ...
  - HyperExecute Jobs
url: https://www.testmuai.com/support/docs/hyperexecute-job-widgets/
site_name: TestMu AI
slug: hyperexecute-job-widgets/
canonical: https://www.testmuai.com/support/docs/hyperexecute-job-widgets/
---
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/hyperexecute-job-widgets/"
    },
    "headline": "HyperExecute Job Widgets",
    "description": "Quickly and easily set up Hyperexecute Widgets for efficient analysis of test results.",
    "url": "https://www.testmuai.com/support/docs/hyperexecute-job-widgets/",
    "image": {
      "@type": "ImageObject",
