      ...
      "step": [
        {
          ...
          "url": "https://www.testmuai.com/support/docs/appium-csharp-nunit/#step-1-get-a-sample-project"
        },
        {
          "@type": "HowToStep",
          "position": 2,
          ...
          "url": "https://www.testmuai.com/support/docs/appium-csharp-nunit/#step-2-setup-the-environment-variables"
        },
        {
          "@type": "HowToStep",
          "position": 3,
          ...
          "url": "https://www.testmuai.com/support/docs/appium-csharp-nunit/#step-3-upload-your-application"
        },
        {
          "@type": "HowToStep",
          "position": 4,
          ...
          "url": "https://www.testmuai.com/support/docs/appium-csharp-nunit/#step-4-update-your-automation-script"
        },
        {
          "@type": "HowToStep",
          "position": 5,
          ...
          "url": "https://www.testmuai.com/support/docs/appium-csharp-nunit/#step-5-configure-the-test-capabilities"
        },
        {
          "@type": "HowToStep",
          "position": 6,
          "name": "Step 6: Execute and Monitor your Tests",
          "text": "Run the following command in your project directory to execute your build and run the tests parallelly. OR Go to Build menu in Visual Studio Code menu bar and click on Build Solution. After the solution is built navigate built navigate to Test menu and click on Test All to execute the tests. Make sure that DotNetSeleniumExtras.WaitHelpers in the NuGet packages which you can check from Project Menu -> Manage NuGet Packages. Your test results would be displayed on the test console (or CLI if you are using terminal/cmd) and on the TestMu AI App Automation Dashboard.",
