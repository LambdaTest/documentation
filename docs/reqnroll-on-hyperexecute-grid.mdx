...
<a href="https://github.com/LambdaTest/reqnroll-selenium-hyperexecute-sample" className="github__anchor"><img loading="lazy" src="/assets/images/icons/github.png" alt="Image" className="doc_img"/> View on GitHub</a>
