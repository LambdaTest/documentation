...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/accessibility-web-rule-2-4-11-focus-not-obscured/"
    },
    "headline": "Focus Not Obscured (Minimum) (2.4.11)",
    "description": "Rule-level Accessibility guidance for Focus Not Obscured (WCAG 2.4.11 Level AA).",
    "url": "https://www.testmuai.com/support/docs/accessibility-web-rule-2-4-11-focus-not-obscured/",
    "image": {
      "@type": "ImageObject",
