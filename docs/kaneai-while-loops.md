...
title: How to Use While Loops With KaneAI
hide_title: true
toc_max_heading_level: 2
sidebar_label: While Loops
description: Use While Loops in KaneAI to repeat steps on dynamic conditions, iterate collections with JavaScript, and reference the built-in loop_counter variable.
keywords:
  - kaneai while loop
  - kaneai loops
  - kaneai iteration
...
<img loading="lazy" src={require('../assets/images/kane-ai/features/while-loops/insert-while-loop.png').default} alt="Empty While Loop block inserted into the test flow" className="doc_img"/>
...
<img loading="lazy" src={require('../assets/images/kane-ai/features/while-loops/add-condition.png').default} alt="Toggle between natural language and operand & operator modes" className="doc_img"/>
...
<img loading="lazy" src={require('../assets/images/kane-ai/features/while-loops/loop-body-steps.png').default} alt="Adding steps inside a While Loop body" className="doc_img"/>
...
<img loading="lazy" src={require('../assets/images/kane-ai/features/while-loops/while-loop-completed.png').default} alt="Completed While Loop showing the final condition outcome and total iterations" className="doc_img"/>
