...
canonical: https://www.testmuai.com/support/docs/wordpress-plugin/
---
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/wordpress-plugin/"
    },
    "headline": "TestMu AI WordPress Plugin For Browser Testing",
    "description": "With TestMu AI plugin for WordPress, you can generate automated screenshots of your web pages and post directly from your WordPress platform.",
    "url": "https://www.testmuai.com/support/docs/wordpress-plugin/",
    "image": {
      "@type": "ImageObject",
