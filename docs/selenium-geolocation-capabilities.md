...
title: How to Test Geolocation With Selenium on TestMu AI
toc_max_heading_level: 2
hide_title: true
sidebar_label: "Geolocation Testing"
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "headline": "Selenium Testing from Different Geolocations",
...
<details>
<summary>View all supported countries (100+)</summary>
...
<details>
<summary>View all supported timezones</summary>

| City | IANA Timezone | Windows Equivalent |
| ---- | ------------- | ------------------ |
...
| Buenos_Aires | America/Argentina/Buenos_Aires | N/A |
| Catamarca | America/Argentina/Catamarca | N/A |
| Cordoba | America/Argentina/Cordoba | N/A |
| Jujuy | America/Argentina/Jujuy | N/A |
| La_Rioja | America/Argentina/La_Rioja | Argentina Standard Time |
| Mendoza | America/Argentina/Mendoza | N/A |
...
| Indianapolis | America/Indiana/Indianapolis | N/A |
...
| Louisville | America/Kentucky/Louisville | N/A |
...
| Metlakatla | America/Metlakatla | N/A |
| Mexico_City | America/Mexico_City | Central Standard Time (Mexico) |
| Miquelon | America/Miquelon | N/A |
...
| South_Pole | Antarctica/South_Pole | N/A |
| Syowa | Antarctica/Syowa | E. Africa Standard Time |
| Troll | Antarctica/Troll | N/A |
...
| Gaza | Asia/Gaza | N/A |
| Harbin | Asia/Harbin | N/A |
| Hebron | Asia/Hebron | N/A |
| Ho_Chi_Minh | Asia/Ho_Chi_Minh | N/A |
...
| Kashgar | Asia/Kashgar | N/A |
| Kathmandu | Asia/Kathmandu | N/A |
...
| Chatham | Pacific/Chatham | N/A |
| Chuuk | Pacific/Chuuk | N/A |
| Easter | Pacific/Easter | N/A |
...
| Pitcairn | Pacific/Pitcairn | N/A |
| Pohnpei | Pacific/Pohnpei | N/A |
...
- [Configure Timezones](/support/docs/configure-timezones/)
- [Network Throttling](/support/docs/network-throttling/)
