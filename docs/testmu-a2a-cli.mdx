...
sidebarTitle: "Test Agents from the CLI"
keywords: ['testmu a2a cli', 'agent testing cli', 'ai agent testing cli', 'chat agent testing', 'phone agent testing', 'red team testing', 'a2a cli installation']
...
"og:description": "Install and use TestMu A2A CLI to test chat and phone AI agents from your terminal with scenario generation, red team security, and CI/CD support."
---
