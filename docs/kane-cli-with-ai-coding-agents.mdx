---
title: "How to Use Kane CLI with AI Coding Agents"
sidebarTitle: "AI Coding Agents"
description: "See how Kane CLI gives AI coding agents a real browser, with walkthroughs for Claude Code, Cursor, Gemini CLI, and Kiro, plus patterns that work in any agent."
keywords: ['kane cli ai coding agents', 'claude code browser testing', 'lovable testing', 'cursor kane cli', 'gemini cli', 'kiro power', 'antigravity', 'kane cli agent mode']
"og:description": "See how Kane CLI gives AI coding agents a real browser, with walkthroughs for Claude Code, Cursor, Gemini CLI, and Kiro, plus patterns that work in any agent."
---
...
<img loading="lazy" src="/assets/images/kane-cli/sketchnotes/ai-coding-agents-architecture.svg" alt="Architecture of AI coding agents working with Kane CLI: any builder such as Claude Code, Cursor, Gemini CLI, Codex CLI, Kiro, Lovable, Antigravity, or GLM reads one skill file, runs a single kane-cli command, drives a real Chrome session, and gets back an NDJSON stream and an evidence pack it can act on" width="1000" height="563" />
...
<iframe
  width="100%"
  height="480"
  src="https://www.youtube.com/embed/cdiPVU2JBEs"
  title="Claude Code x Kane CLI"
  frameborder="0"
...
<iframe
  width="100%"
  height="480"
  src="https://www.youtube.com/embed/u5vi-9Sn97A"
  title="Lovable x Kane CLI"
  frameborder="0"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
  allowfullscreen
></iframe>
...
<source src="https://assets.testmuai.com/resources/videos/kane-cli/agents/cursor-x-kane-cli.mp4" type="video/mp4" />
</video>
...
<video class="right-side" width="100%" controls id="vid">
<source src="https://assets.testmuai.com/resources/videos/kane-cli/agents/gemini-cli-x-kane-cli.mp4" type="video/mp4" />
</video>
...
<video class="right-side" width="100%" controls id="vid">
<source src="https://assets.testmuai.com/resources/videos/kane-cli/agents/kiro-x-kane-cli.mp4" type="video/mp4" />
</video>
...
<video class="right-side" width="100%" controls id="vid">
<source src="https://assets.testmuai.com/resources/videos/kane-cli/agents/antigravity-x-kane-cli.mp4" type="video/mp4" />
</video>
...
<video class="right-side" width="100%" controls id="vid">
<source src="https://assets.testmuai.com/resources/videos/kane-cli/agents/glm-x-kane-cli.mp4" type="video/mp4" />
</video>
...
- [Skills](/docs/kane-cli-skills/): install and customize the skill for Claude Code, Codex CLI, or Gemini CLI
- [Agent Mode](/docs/kane-cli-agent-mode/): the `--agent` flag, the NDJSON event schema, and the `run_end` event
- [Test.md](/docs/kane-cli-testmd/): committable, replay-cached tests and the cascade rule
- [Generate Test Cases](/docs/kane-cli-generate/): author scenarios and cases from a plain-English description
- [Parallel Execution](/docs/kane-cli-parallel-execution/): fan out independent runs and consolidate the results
- [Error Codes](/docs/kane-cli-error-codes/): `result_code` values and the recommended action for each
