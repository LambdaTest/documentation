...
<img loading="lazy" src="/assets/images/teamcity-integration/teamcity.webp" alt="Create a new project on TeamCity" width="963" height="286" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/teamcity-integration/teamcity-1.webp" alt="Create a new VCS root using the below form" width="800" height="573" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/teamcity-integration/teamcity-2.webp" alt="Now, create a build configuration" width="273" height="167" className="doc_img"/>

**Step 7:** Go to Build Step page and add a build step as below.

<img loading="lazy" src="/assets/images/teamcity-integration/teamcity-3.webp" alt="Go to Build Step page" width="983" height="586" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/teamcity-integration/teamcity-4.webp" alt="Create two environment variables"  width="1042" height="446" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/teamcity-integration/teamcity-5.webp" alt="Go to Project Dashboard and Run your project" width="1269" height="258" className="doc_img"/>
