...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/kane-ai-secrets/"
    },
    "headline": "Utilizing KaneAI Secrets Feature: A Step-by-Step Guide",
    "description": "Learn how to create, update and use custom secrets from the test manager and while executing your tests using the Kane AI",
    "url": "https://www.testmuai.com/support/docs/kane-ai-secrets/",
    "image": {
      "@type": "ImageObject",
    ...
    "hasPart": [
      {
        ...
        "text": "use the value of {{secrets.user.email}} in the email text field"
      }
    ],
