      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "@type": "ListItem",
          "position": 3,
          "name": "Pause, Stop, Hide (2.2.2)",
          "item": `${BRAND_URL}/support/docs/accessibility-web-rule-2-2-2-pause-stop-hide/`
        }]
      })
    }}
></script>
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/accessibility-web-rule-2-2-2-pause-stop-hide/"
    },
    "headline": "Pause, Stop, Hide (2.2.2)",
    "description": "Rule-level Accessibility guidance for Pause, Stop, Hide (WCAG 2.2.2 Level A).",
    "url": "https://www.testmuai.com/support/docs/accessibility-web-rule-2-2-2-pause-stop-hide/",
    "image": {
      "@type": "ImageObject",
