...
keywords:
 ...
 - real-time video agent evaluation
 - conversational video testing
url: https://www.testmuai.com/support/docs/video-agent/
site_name: TestMu AI
slug: video-agent/
canonical: https://www.testmuai.com/support/docs/video-agent/
---
      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "@type": "ListItem",
          "position": 3,
          "name": "Video Agent Testing",
          "item": `${BRAND_URL}/support/docs/video-agent`
        }]
      })
    }}
></script>
