...
canonical: https://www.testmuai.com/support/docs/zoho-bugtracker-integration/
---
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/zoho-bugtracker-integration/"
    },
    "headline": "Zoho BugTracker Integration",
    "description": "Integrate TestMu AI with Zoho BugTracker and perform effortless one-click bug logging from TestMu AI platform to Zoho BugTracker projects. Capture screenshots, annotate bugs, and more.",
    "url": "https://www.testmuai.com/support/docs/zoho-bugtracker-integration/",
    "image": {
      "@type": "ImageObject",
