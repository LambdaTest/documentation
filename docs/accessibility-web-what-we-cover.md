...
description: Supported WCAG accessibility rules for Web, iOS, and Android with links to rule pages, plus manual test checklists for areas that need human review.
keywords:
  - TestMu AI
  - Accessibility
  - Web
