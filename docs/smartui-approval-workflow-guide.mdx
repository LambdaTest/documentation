...
sidebarTitle: "Approve, Reject & Merge"
...
# Use the "Move to Baseline" action in the SmartUI dashboard
```
...
**Solution**:
```bash
# After approving in B1, use the "Move to Baseline"
# function in the SmartUI dashboard
```
