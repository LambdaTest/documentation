...
<a href="https://github.com/LambdaTest/Java-TestNG-Selenium" className="github__anchor" target="_blank"><img loading="lazy" src="/assets/images/icons/github.png" alt="Image" className="doc_img"/> View on GitHub</a>
</div>
</Tip>
...
<img loading="lazy" src="/assets/images/selenium/running-first-test/run-first-test.png" alt="TestMu AI Automation Dashboard showing test results"  className="doc_img"/>
