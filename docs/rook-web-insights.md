---
id: rook-web-insights
title: Rook Web UI — Insights
sidebar_label: Insights
description: Interpret Rook's run trends, tool failures, category coverage gaps, unverifiable expectations, and adversarial results without overstating coverage.
slug: rook-web-insights/
canonical: https://www.testmuai.com/support/docs/rook-web-insights/
---
...
:::caution Stage aggregate limitations
