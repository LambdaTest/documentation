...
hide_title: true
sidebar_label: C#
description: You can now run C# Selenium automated test cases on online scalable LambdaTest Selenium grid of 10000+ real desktop browsers and real operating systems.
keywords:
  - c# selenium
  - c# selenium tutorial
