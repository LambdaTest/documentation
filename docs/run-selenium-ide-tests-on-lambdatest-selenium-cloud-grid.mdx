...
<img loading="lazy" src="/assets/images/uploads/profile-1.webp" alt="<BrandName /> Access Key" width="462" height="325" className="doc_img"/>
...
*   Right click on the test suite and go to Settings. <img loading="lazy" src="/assets/images/uploads/open-settings-in-Selenium-IDE.webp" alt="Test Suite Settings" width="898" height="422" className="doc_img"/>
*   In the Settings window, tick the **Run in Parallel** checkbox. <img loading="lazy" src="/assets/images/uploads/enable-parallel-testing-in-Selenium-ide.webp" alt="Test Suite Properties" width="893" height="323" className="doc_img"/>
...
Below are the execution snapshots of the SIDE Runner and the automation timeline instance, that shows the successful execution of the desired tests: <img loading="lazy" src="/assets/images/uploads/SIDE-Runner-execution-snapshot-1.webp" alt="test execution snapshots" width="1353" height="493" className="doc_img"/> <img loading="lazy" src="/assets/images/uploads/automation-timeline-snapshot.webp" alt="automation test timeline" width="1353" height="493" className="doc_img"/>
...
1.  Click over the three dot option of the test suite. Choose the setting option. <img loading="lazy" src="/assets/images/uploads/click-on-3-dots-1.webp" alt="test suite settings" width="1905" height="1025"  className="doc_img"/>
2.  Then choose persist session option and submit. <img loading="lazy" src="/assets/images/uploads/select-persist-sessions-1.webp" alt="persist session" width="1905" height="1025" className="doc_img"/>
