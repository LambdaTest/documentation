...
**Step 1:** Login to your <a href="https://stage-accounts.lambdatestinternal.com/login" onClick={CookieTrackingLogin}><BrandName /> account</a>. Make sure you have an Admin or User level access to see and install 3rd party integrations.
