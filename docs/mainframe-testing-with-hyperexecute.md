...
keywords:
  ...
  - tn3270 automation testing
  - robotframework mainframe3270
  - robot framework mainframe testing
  - hyperexecute background services
url: https://www.testmuai.com/support/docs/mainframe-testing-with-hyperexecute/
site_name: TestMu AI
slug: mainframe-testing-with-hyperexecute/
canonical: https://www.testmuai.com/support/docs/mainframe-testing-with-hyperexecute/
---
      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "item": `${BRAND_URL}/support/docs/mainframe-testing-with-hyperexecute/`
        }]
      })
    }}
></script>
...
:::info What a mainframe suite needs on the grid
...
> For any query, contact us via <span className="doc__lt" onClick={() => window.openLTChatWidget()}>**24x7 chat support**</span> or email **support@testmuai.com**.
