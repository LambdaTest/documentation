...
canonical: https://www.testmuai.com/support/docs/testing-locally-hosted-pages/
---
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/testing-locally-hosted-pages/"
    },
    "headline": "Test Locally Hosted Web Pages",
    "description": "TestMu AI Tunnel securely connects your local machine to cloud-based real devices for testing locally hosted web apps, with multiple connectivity options like TCP or Websocket.",
    "url": "https://www.testmuai.com/support/docs/testing-locally-hosted-pages/",
    "image": {
      "@type": "ImageObject",
