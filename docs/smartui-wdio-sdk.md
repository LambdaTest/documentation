...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/smartui-wdio-sdk/"
    },
    "headline": "Integrate SmartUI SDK with WebdriverIO Tests",
    "description": "In this documentation, learn how integrate your WebdriverIO automated tests with TestMu AI's SmartUI.",
    "url": "https://www.testmuai.com/support/docs/smartui-wdio-sdk/",
    "image": {
      "@type": "ImageObject",
    ...
    "dependencies": "Basic understanding of Command Line Interface and WebdriverIO is required.; Login to TestMu AI SmartUI with your credentials..",
    "author": {
      "@type": "Organization",
    ...
    "hasPart": [
      {
        ...
        "codeRepository": "https://github.com/LambdaTest/smartui-wdio-sample",
        "text": "git clone https://github.com/LambdaTest/smartui-wdio-sample\ncd smartui-wdio-sample"
      },
      {
        "@type": "SoftwareSourceCode",
        ...
        "codeSampleType": "code snippet",
        "programmingLanguage": "Shell",
        "text": "npm install @lambdatest/smartui-cli @lambdatest/wdio-driver webdriverio wdio-lambdatest-service"
      },
      {
        "@type": "SoftwareSourceCode",
      ...
      },
      {
        ...
        "codeSampleType": "code snippet",
        "programmingLanguage": "Shell",
        "text": "npx smartui --config .smartui.json exec -- wdio run ./wdio.conf.js"
      },
      {
        "@type": "SoftwareSourceCode",
      ...
      },
      {
        ...
        "codeSampleType": "code snippet",
        "programmingLanguage": "Shell",
        "text": "   npm view @lambdatest/wdio-driver version\n   npm view @lambdatest/smartui-cli version"
      },
      {
        "@type": "SoftwareSourceCode",
