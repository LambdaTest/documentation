...
<a href="https://github.com/LambdaTest/CSharp-NUnit-Selenium" className="github__anchor" target="_blank"><img loading="lazy" src="/assets/images/icons/github.png" alt="Image" className="doc_img"/> View on GitHub</a>
</div>
</Tip>
...
<p align="center">
<img loading="lazy" src="/assets/images/uploads/Single-Test-Explorer.webp" alt="cmd" width="768" height="373" className="doc_img"/>
</p>
