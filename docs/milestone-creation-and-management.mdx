...
sidebarTitle: "Group Runs into Milestones"
description: "Create and manage milestones in TestMu AI Test Manager to group test runs, track feature-release progress, and oversee associated testing activities."
keywords: ['milestone creation']
"og:description": "Create and manage milestones in TestMu AI Test Manager to group test runs, track feature-release progress, and oversee associated testing activities."
---
