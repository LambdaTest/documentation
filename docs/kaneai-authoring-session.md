...
Adding or editing steps inside a module updates the module and creates a new module version, following normal [module versioning](/support/docs/kane-ai-modules/#module-versioning). A module cannot contain another module.
...
- [Rename Steps](/support/docs/kaneai-manual-interaction/#rename-test-steps)
