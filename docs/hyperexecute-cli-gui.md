...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/hyperexecute-cli-gui/"
    },
    "headline": "HyperExecute GUI App",
    "description": "This documentation outlines the steps on how to trigger a job on hyperexecute using the underpass app - gui app for hyperexecute cli.",
    "url": "https://www.testmuai.com/support/docs/hyperexecute-cli-gui/",
    "image": {
      "@type": "ImageObject",
...
**1. HyperExecute Access** : You need a <BrandName /> account to use the HyperExecute GUI. If you don’t have one, <a href="https://www.testmuai.com/register/" onClick={CookieTrackingSignup}>sign up</a> now. Ensure your account includes HyperExecute access (free or paid plan) to get started.
