...
# Codeception with Selenium: Tutorial to Run Your First Test on <BrandName />
***
...
## Using the Codeception Agent Skill with TestMu AI
***

The [codeception-skill](https://github.com/LambdaTest/agent-skills/tree/main/codeception-skill) is a part of [TestMu AI Skills](https://github.com/LambdaTest/agent-skills/) that guide AI coding assistants in generating production-ready test automation.

The codeception-skill package includes:
...
### Installing Codeception Agent Skill
***

Install a Codeception Agent Skill using the command below:
...
**Note**: If you prefer installing all available framework skills instead of only codeception-skill, clone the repository directly into your tool's skills directory (for example, .claude/skills/, .cursor/skills/, .gemini/skills/, or .agent/skills/).
