...
sidebarTitle: "Customize Tests With Lambda Hooks"
...
<Note>
: These hooks will only work if you're connected to your [LambdaTest Hub URL](/support/docs/hyperexecute-faqs/#17-how-can-i-access-my-hub-url). If you use these hooks on any other platform, you might see the error: `javascript error: Invalid left-hand side in assignment`
</Note>