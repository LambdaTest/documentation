...
## Using the Geb Agent Skill with TestMu AI
***

The [geb-skill](https://github.com/LambdaTest/agent-skills/tree/main/geb-skill) is a part of [TestMu AI Skills](https://github.com/LambdaTest/agent-skills/) that guide AI coding assistants in generating production-ready test automation.

The geb-skill package includes:
...
### Installing Geb Agent Skill
***

Install a Geb Agent Skill using the command below:
...
**Note**: If you prefer installing all available framework skills instead of only geb-skill, clone the repository directly into your tool's skills directory (for example, .claude/skills/, .cursor/skills/, .gemini/skills/, or .agent/skills/).
