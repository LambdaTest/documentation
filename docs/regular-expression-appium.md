...
url: https://www.testmuai.com/support/docs/regular-expression-appium/
site_name: TestMu AI
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/regular-expression-appium/"
    },
    "headline": "Regular Expression - Appium",
    "description": "If your chosen device for testing on TestMu AI is unavailable, use REGEX to broaden the search request for alternative devices to run the test.",
    "url": "https://www.testmuai.com/support/docs/regular-expression-appium/",
    "image": {
      "@type": "ImageObject",
...
> To run tests on **minor OS versions** while using `platformVersion` capability, please reach out at our <span className="doc__lt" onClick={() => window.openLTChatWidget()}>**24x7 Chat Support**</span> or you could also mail us at [support@testmuai.com](mailto:support@testmuai.com).
