...
<img loading="lazy" src={require('../assets/images/rook/rook-local-result.png').default} alt="Local Rook scenario result showing criterion-level HTTP smoke-test evidence" width="1440" height="900" className="doc_img"/>
...
See [results and evidence](/support/docs/agent-assurance-results-and-evidence/) for incomplete or unverifiable outcomes and [both UI walkthroughs](/support/docs/agent-assurance-results-and-evidence/) for navigation.
