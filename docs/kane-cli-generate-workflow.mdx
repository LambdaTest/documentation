---
title: "How to Use the Kane CLI Generate Flow"
sidebarTitle: "Workflow"
description: "Walk the kane-cli generate loop end to end: generate, refine in plain language, save functional cases as _test.md files, and run them with testmd."
...
"og:description": "Walk the kane-cli generate loop end to end: generate, refine in plain language, save functional cases as _test.md files, and run them with testmd."
---
