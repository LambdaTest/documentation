...
<img loading="lazy" src="/assets/images/aws-codePipeline-integration/aws-codepipeline1.webp" alt="AWS CodePipeline" width="1316" height="419" className="doc_img"/>

**Step 2:** Set your pipeline settings for a **new service role**.

<img loading="lazy" src="/assets/images/aws-codePipeline-integration/aws-codepipeline2.webp" alt="AWS CodePipeline" width="1247" height="461" className="doc_img"/>

**Step 3:** Now, provide your git details in the next step to **Add Source Stage**.

<img loading="lazy" src="/assets/images/aws-codePipeline-integration/aws-codepipeline3.webp" alt="AWS CodePipeline" width="1209" height="460" className="doc_img"/>

**Step 4:** Follow the steps in AWS CodePipeline & fill the form page on the next step to **Add build stage**.

<img loading="lazy" src="/assets/images/aws-codePipeline-integration/aws-codepipeline4.webp" alt="AWS CodePipeline" width="1223" height="425" className="doc_img"/>

**Step 5:** Create a new build project while adding a **Build Stage**.

<img loading="lazy" src="/assets/images/aws-codePipeline-integration/aws-codepipeline5.webp" alt="AWS CodePipeline" width="1025" height="410" className="doc_img"/>

**Step 6:**  Choose a **Deploy Provider** on **deploy stage** screen and click on **Next**.

<img loading="lazy" src="/assets/images/aws-codePipeline-integration/aws-codepipeline6.webp" alt="AWS CodePipeline" width="1160" height="393" className="doc_img"/>
