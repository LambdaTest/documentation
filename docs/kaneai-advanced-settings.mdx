...
sidebarTitle: "Configure Session Settings"
keywords: ['kaneai advanced settings', 'edit advanced settings', 'test case settings', 'network configuration', 'chrome options', 'custom headers', 'timezone', 'version history', 'kaneai test summary']
...
"og:description": "Learn how to edit advanced settings for your KaneAI test cases from the test summary page across desktop web, mobile app, and mobile web platforms."
---
...
<img loading="lazy" src="/assets/images/kane-ai/features/edit-advanced-settings/edit-test-steps-advanced-settings.png" alt="Edit Test Steps - Advanced Settings" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/kane-ai/features/edit-advanced-settings/advanced-settings-in-session.png" alt="Edited Advanced Settings" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/kane-ai/features/edit-advanced-settings/edited-advanced-settings.png" alt="Apply Settings or Edit Test Steps" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/kane-ai/features/edit-advanced-settings/advanced-settings-version-history.png" alt="Advanced Settings Version History" className="doc_img"/>
