      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "position": 3,
          "name": "On Focus (3.2.1)",
          "item": `${BRAND_URL}/support/docs/accessibility-web-rule-3-2-1-on-focus/`
        }]
      })
    }}
></script>
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/accessibility-web-rule-3-2-1-on-focus/"
    },
    "headline": "On Focus (3.2.1)",
    "description": "Rule-level Accessibility guidance for On Focus (WCAG 3.2.1 Level A).",
    "url": "https://www.testmuai.com/support/docs/accessibility-web-rule-3-2-1-on-focus/",
    "image": {
      "@type": "ImageObject",
