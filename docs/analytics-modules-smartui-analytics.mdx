...
sidebarTitle: "View SmartUI Insights"
...
<Info>
The SmartUI Analytics module is currently in <span className="border-2 border-[#bf3989] text-[#bf3989] rounded-full px-2 py-0 font-bold text-[0.8em] mx-[0.2em] align-middle inline-block text-xs">BETA</span>. If you have any feedback or suggestions, please feel free to reach out to us at [support@testmuai.com](mailto:support@testmuai.com).
</Info>
