---
title: "How to Measure Kane CLI Test Coverage"
sidebarTitle: "Coverage"
description: "Measure Kane CLI coverage on two axes with kane-cli cover: what a sealed evidence pack proved and what the design still owes, plus a gaps worklist."
keywords: ['kane cli cover', 'test coverage', 'coverage gaps', 'evidence pack', 'requirements coverage', 'kaneai', 'testmu ai']
"og:description": "Measure Kane CLI coverage on two axes with kane-cli cover: what a sealed evidence pack proved and what the design still owes, plus a gaps worklist."
---
