...
sidebarTitle: "Generate Lighthouse Reports"
...
The code sample for generating the Lighthouse Performance Metrics in the Playwright test can be found on **<BrandName />'s GitHub Repository**. You can either download or clone the repository to quickly run your tests.
...
(async () => {
  ...
  console.log('Connecting to TestMu AI...');
  ...
  console.log('Connected to TestMu AI successfully!');
  ...
  try {
    ...
    console.log('Expected title: "TestMu AI - Search"');
