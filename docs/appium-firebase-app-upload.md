...
url: https://www.testmuai.com/support/docs/appium-firebase-app-upload/
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/appium-firebase-app-upload/"
    },
    "headline": "Uploading app via Firebase",
    "description": "Discover how to test an app uploaded on Firebase seamlessly through Appium at TestMu AI! Our guide simplifies your Appium Firebase app upload process for efficient testing!",
    "url": "https://www.testmuai.com/support/docs/appium-firebase-app-upload/",
    "image": {
      "@type": "ImageObject",
