...
description: Look up the error messages shown when Espresso builds and shards fail on TestMu AI, with the root cause and how to fix each one.
keywords:
...
canonical: https://www.testmuai.com/support/docs/troubleshoot-espresso-tests/
---
      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "item": `${BRAND_URL}/support/docs/troubleshoot-espresso-tests/`
        }]
      })
    }}
></script>
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/troubleshoot-espresso-tests/"
    },
    "headline": "Troubleshoot Your Espresso Tests",
...
<!-- Verified 2026-09-11: each fix restates the root cause given in this table. -->
