...
sidebarTitle: "Test With NVDA (Windows)"
...
"og:description": "Platform-specific screen reader reference for NVDA on Windows—setup, navigation basics, and what to validate after automated scans."
---
