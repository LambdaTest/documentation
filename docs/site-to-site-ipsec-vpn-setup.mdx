...
sidebarTitle: "Site-to-Site VPN Setup"
keywords: ['Site-to-Site VPN', 'IPsec VPN', 'S2S Tunnel', 'Private Network Testing', 'Enterprise VPN', 'IKEv2', 'Network Security']
...
"og:description": "A comprehensive guide to setting up IPsec Site-to-Site VPN for testing privately hosted applications on TestMu AI cloud infrastructure."
---
...
<img loading="lazy" src="/assets/images/s2s-vpn/network-architecture.png" alt="S2S VPN Network Architecture" className="doc_img" width="800"/>
