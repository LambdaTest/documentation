...
<img loading="lazy" src="/assets/images/test-run-issues/test-instance-issue-menu.png" alt="Bug menu on a test instance row with Link Issue and View Issues options" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/test-run-issues/link-issues-dialog.png" alt="Link Issues dialog with tracker selector and issue key field" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/test-run-issues/mark-as-bug-create-issue.png" alt="Create an Issue panel for raising a new bug from a test instance" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/test-run-issues/view-issues-panel.png" alt="View Issues panel listing the bugs associated with a test instance" className="doc_img"/>
