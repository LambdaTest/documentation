...
keywords:
  ...
  - testmu ai
url: https://www.testmuai.com/support/docs/kane-cli-remote-execution/
site_name: TestMu AI
slug: kane-cli-remote-execution/
...
<script type="application/ld+json"
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [{
          ...
          "@type": "ListItem",
          "position": 3,
          "name": "Remote runs on the cloud grid",
          "item": "https://www.testmuai.com/support/docs/kane-cli-remote-execution/"
        }]
      }) }}
></script>
...
- **A member failed or broke** (exit `1`): read it like any other failure. `output-<stem>/Result.md` names the failing step and reason, and the evidence pack has the screenshots and logs. See [Debugging with a pack](/support/docs/kane-cli-troubleshooting/#debugging-a-failed-run-with-its-evidence-pack).
