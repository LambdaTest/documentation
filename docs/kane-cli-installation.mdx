...
<Note>
**Mobile testing**, the iOS Simulator and the Android Emulator, is supported on **macOS Apple Silicon (arm64) only** for the initial release. See [Mobile Testing](/docs/kane-cli-mobile/) for the simulator and emulator prerequisites.
</Note>
