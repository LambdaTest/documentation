...
sidebarTitle: "Export Build Data"
keywords: ['SmartUI export', 'SmartUI PDF', 'SmartUI CSV', 'SmartUI JSON', 'Visual regression export', 'Build export', 'TestMu AI SmartUI']
...
"og:description": "Export a SmartUI build from the dashboard in PDF, CSV, or JSON using the build menu, after the UI finishes loading export data."
---
...
<img loading="lazy" src="/assets/images/smart-visual-testing/export_options/export-button.png" className="doc_img" alt="SmartUI build screen with three-dot menu and Export option highlighted" />
...
<img loading="lazy" src="/assets/images/smart-visual-testing/export_options/loading-data.png" className="doc_img" alt="Export loading state while build data is prepared" />
...
<img loading="lazy" src="/assets/images/smart-visual-testing/export_options/loading-complete-and-export-options.png" className="doc_img" alt="Export ready with PDF CSV and JSON download options" />
