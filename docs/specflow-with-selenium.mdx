...
<a href="https://github.com/LambdaTest/SpecFlow-Selenium-Sample" className="github__anchor" target="_blank"><img loading="lazy" src="/assets/images/icons/github.png" alt="Image" className="doc_img"/> View on GitHub</a>
</div>
</Tip>
...
<p align="center">
<img loading="lazy" src="/assets/images/uploads/Test-Explorer-Screen.webp" alt="cmd" width="768" height="373" className="doc_img"/>
</p>

3. Click **Run** from the Test Explorer to run the sample test.

<p align="center">
<img loading="lazy" src="/assets/images/uploads/SpecFlowTest.webp" alt="cmd" width="768" height="373" className="doc_img"/>
</p>
