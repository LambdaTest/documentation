...
<div className="home_inners_box">
      ...
      <div className="home_inners">
        <a href="/support/docs/real-device-testing-overview/" ><p className="p_home_inners">Real Device App Testing</p></a>
      </div>
        <div className="home_inners">
        <a href="/support/docs/real-device-testing-overview/" ><p className="p_home_inners">Real Device Browser Testing</p></a>
      </div>
      <div className="home_inners">
