...
description: Now you can run your XCUI framework on LambdaTest online grid of 10000+ real desktop browsers and real operating systems with its supported capabilities.
keywords:
  - espresso
  - java
  - lambdatest java
