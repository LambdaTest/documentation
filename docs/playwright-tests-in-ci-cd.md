...
url: https://www.testmuai.com/support/docs/playwright-tests-in-ci-cd/
site_name: TestMu AI
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/playwright-tests-in-ci-cd/"
    },
    "headline": "Running Playwright Tests In CI/CD",
    "description": "Learn how to perform Playwright testing through CI/CD across multiple browser versions on the TestMu AI platform.",
    "url": "https://www.testmuai.com/support/docs/playwright-tests-in-ci-cd/",
    "image": {
      "@type": "ImageObject",
