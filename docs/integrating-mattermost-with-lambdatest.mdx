...
**Step 1:** Login to your <a href="https://www.testmuai.com/login/"><BrandName /> account</a>. Make sure you have an Admin or User level access to see and install 3rd party integrations.
...
<img loading="lazy" src="/assets/images/integrating-mattermost-with-lambdatest/go-to-integrations.webp" alt="Select 'Integrations' " width="1923" height="863"  className="doc_img"/>

**Step 3:** Hover to the 'Mattermost' block under "Communications" category, and click on "**Add**" button that appears.

<img loading="lazy" src="/assets/images/integrating-mattermost-with-lambdatest/hover-to-mattermost-and-click.webp" alt="Hover to the 'Mattermost' "  className="doc_img"  width="1024" height="472"/>
...
<img loading="lazy" src="/assets/images/integrating-mattermost-with-lambdatest/Copy-the-incoming-webhook.webp" alt="copy the webhook URL"  className="doc_img"  width="1921" height="746"/>
...
<img loading="lazy" src="/assets/images/integrating-mattermost-with-lambdatest/paste-the-webhook.webp" alt="Enter your **webhook URL" width="1921" height="869" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/integrating-mattermost-with-lambdatest/Intergration-successful-message.webp" alt="Mattermost will be integrated"  className="doc_img"  width="510" height="157"/>

**Step 7:** Voila! Go to Integrations tab again and you will see a Mattermost under "My Integrations".  
<img loading="lazy" src="/assets/images/integrating-mattermost-with-lambdatest/integration-successful-from-top.webp" alt="you will see a Mattermost under My Integrations"  className="doc_img"  width="1922" height="865"/>
...
<img loading="lazy" src="/assets/images/integrating-mattermost-with-lambdatest/integration-successful-list.webp" alt="Green Tick"  className="doc_img"  width="1922" height="863"/>
...
<img loading="lazy" src="/assets/images/integrating-mattermost-with-lambdatest/real-time-testing-1.webp" alt="Enter the URL of the web-app"  className="doc_img"  width="1348" height="609"/>
...
<img loading="lazy" src="/assets/images/integrating-mattermost-with-lambdatest/select-mark-as-bug.webp" alt="Launch Tests" width="1920" height="865"  className="doc_img"/>
...
<img loading="lazy" src="/assets/images/integrating-mattermost-with-lambdatest/highlight-and-mark-as-bug.webp" alt="A screenshot will be captured and appear on your screen"  className="doc_img"  width="1920" height="853"/>
...
<img loading="lazy" src="/assets/images/integrating-mattermost-with-lambdatest/assign-and-create-issue.webp" alt="send the bug directly to Mattermost workspace"  className="doc_img" width="750" height="793"/>
...
<img loading="lazy" src="/assets/images/integrating-mattermost-with-lambdatest/Bug-marked-message.webp" alt="Image"  width="484" height="178" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/integrating-mattermost-with-lambdatest/issue-marked-in-mattermost-channel.webp" alt="Image"  className="doc_img" width="1904" height="845"/>
...
<img loading="lazy" src="/assets/images/integrating-mattermost-with-lambdatest/remove-from-list.webp" alt="Image"  width="1920" height="848" className="doc_img"/>
