...
## Using the Selenide Agent Skill with TestMu AI
***

The [selenide-skill](https://github.com/LambdaTest/agent-skills/tree/main/selenide-skill) is a part of [TestMu AI Skills](https://github.com/LambdaTest/agent-skills/) that guide AI coding assistants in generating production-ready test automation.

The selenide-skill package includes:
...
### Installing Selenide Agent Skill
***

Install a Selenide Agent Skill using the command below:
...
**Note**: If you prefer installing all available framework skills instead of only selenide-skill, clone the repository directly into your tool's skills directory (for example, .claude/skills/, .cursor/skills/, .gemini/skills/, or .agent/skills/).
