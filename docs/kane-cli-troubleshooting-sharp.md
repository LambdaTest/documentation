...
title: sharp fails to install
sidebar_label: sharp Install Failure
...
<script type="application/ld+json"
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [{
          ...
          "@type": "ListItem",
          "position": 3,
          "name": "sharp fails to install",
          "item": "https://www.testmuai.com/support/docs/kane-cli-troubleshooting-sharp/"
        }]
      }) }}
></script>
## Symptom
