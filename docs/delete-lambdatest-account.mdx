...
<img loading="lazy" src="/assets/images/delete-lambdatest-account/dashboard.webp" alt="Profile" width="1360" height="603" className="doc_img"/>

**Step 2**: From the dropdown, click on **Account Settings**.

<img loading="lazy" src="/assets/images/delete-lambdatest-account/account-settings.webp" alt="Delete account" width="1349" height="612" className="doc_img"/>

**Step 3:** To delete your <BrandName /> account, head to the **Click Here** option.

<img loading="lazy" src="/assets/images/delete-lambdatest-account/click-here.webp" alt="Email Address" width="1353" height="620" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/delete-lambdatest-account/e-mail-.webp" alt="Email Address" width="1353" height="620" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/delete-lambdatest-account/org-settings.webp" alt="manage team" width="1366" height="597" className="doc_img"/>

**Step 3**: Navigate to the user that you want to delete. Click on the **three dots** next to the user.

<img loading="lazy" src="/assets/images/delete-lambdatest-account/three-dots.webp" alt="Delete account" width="1366" height="610" className="doc_img"/>

**Step 4**: From the dropdown, Click on **'Delete'**. 

<img loading="lazy" src="/assets/images/delete-lambdatest-account/delete-user.webp" alt="Delete account" width="1354" height="605" className="doc_img"/> 

**Step 5**: A popup box will appear, Click on **'Delete'**. 

<img loading="lazy" src="/assets/images/delete-lambdatest-account/confirm-delete.webp" alt="Delete account" width="1354" height="605" className="doc_img"/> The user will be removed successfully.
