...
canonical: https://www.testmuai.com/support/docs/web-scanner-scheduling-options/
---
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/web-scanner-scheduling-options/"
    },
    "headline": "Scheduling Options in Web Scanner",
    "description": "A guide to the scheduling options available in Web Scanner, including one-time Quick Scans, recurring scans, and how to manage scheduled jobs.",
    "url": "https://www.testmuai.com/support/docs/web-scanner-scheduling-options/",
    "image": {
      "@type": "ImageObject",
