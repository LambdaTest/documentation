---
id: migrate-from-zephyr-enterprise
title: Migrating from Zephyr Enterprise to Test Manager
hide_title: true
sidebar_label: Migrate from Zephyr Enterprise
description: Move your test case library from Zephyr Enterprise into TestMu AI Test Manager using CSV import, with a full field and structure mapping reference.
keywords:
  - zephyr enterprise
  - zephyr enterprise migration
  - migrate from zephyr
  - csv import
  - test case migration
  - test manager
url: https://www.testmuai.com/support/docs/migrate-from-zephyr-enterprise/
site_name: TestMu AI
slug: migrate-from-zephyr-enterprise/
canonical: https://www.testmuai.com/support/docs/migrate-from-zephyr-enterprise/
---
      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "item": `${BRAND_URL}/support/docs/migrate-from-zephyr-enterprise/`
        }]
      })
    }}
></script>
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/migrate-from-zephyr-enterprise/"
    },
    "headline": "Migrating from Zephyr Enterprise to Test Manager",
    "description": "Move your test case library from Zephyr Enterprise into TestMu AI Test Manager using CSV import, with a full field and structure mapping reference.",
    "url": "https://www.testmuai.com/support/docs/migrate-from-zephyr-enterprise/",
    "image": {
      "@type": "ImageObject",
...
- Rich text may export as raw HTML (`<p>`, `<br>`) — strip it or accept it.
