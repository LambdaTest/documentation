...
sidebarTitle: "Scan Behind Login"
...
<img loading="lazy" src="/assets/images/accessibility-testing/features/login/login-configs.png" className="doc_img" alt="Advanced options in the schedule wizard with Add login configurations" />
...
<img loading="lazy" src="/assets/images/accessibility-testing/features/login/login-modal.png" className="doc_img" alt="Login modal listing saved configurations with option to add a new configuration" />
...
<img loading="lazy" src="/assets/images/accessibility-testing/features/login/basic_auth.png" className="doc_img" alt="Basic authentication fields: login URL, username, and password" />
...
<img loading="lazy" src="/assets/images/accessibility-testing/features/login/form_auth.png" className="doc_img" alt="Form authentication with selectors and optional post-login URL" />
...
<img loading="lazy" src="/assets/images/accessibility-testing/features/login/multi-page-username.png" className="doc_img" alt="Multi-page login step one: username page fields" />
...
<img loading="lazy" src="/assets/images/accessibility-testing/features/login/multi-page-password.png" className="doc_img" alt="Multi-page login step two: password page fields" />
