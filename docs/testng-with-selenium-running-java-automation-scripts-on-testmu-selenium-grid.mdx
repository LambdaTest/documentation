---
title: "Selenium With TestNG Tutorial"
sidebarTitle: "TestNG"
keywords: ['java selenium', 'testng selenium', 'testng', 'testng tutorial', 'testng selenium framework', 'java selenium tutorial', 'java selenium webdriver', 'java selenium testing']
---
...
In this topic, you will learn how to configure and run tests using **TestNG** on <BrandName />'s [Selenium testing cloud platform](https://www.lambdatest.com/selenium-automation).
...
<suite thread-count="3" name="LambaTestSuite" parallel="tests">
  ...
  <parameter name="platform" value="WIN8"/>
    <classes>
      <class name="TestMu AI.TestNGToDo"/>
    </classes>
  </test> <!-- Test -->
