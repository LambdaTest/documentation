...
<img loading="lazy" src={require('../assets/images/rook/commands/rook-command-logout.png').default} alt="Rook logout command help" width="1556" height="1466" className="doc_img"/>
...
- Switch to another LambdaTest account.
