...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/accessibility-android-rule-insufficient-color-ratio/"
    },
    "headline": "Insufficient Color Ratio",
    "description": "Rule-level Accessibility guidance for Insufficient Color Ratio on Android.",
    "url": "https://www.testmuai.com/support/docs/accessibility-android-rule-insufficient-color-ratio/",
    "image": {
      "@type": "ImageObject",
