...
<img loading="lazy" src={require('../assets/images/real-time-browser-testing/mark-as-bug-5.webp').default} alt="ui observation" width="1365" height="650" className="doc_img"/>
