...
<p align="center">
<img loading="lazy" src={require('../assets/videos/real-time/chromeos/launch-chromos-web.gif').default} alt="generating gitlab token" width="1340" height="617" className="doc_img"/>
</p>
...
<p align="center">
<img loading="lazy" src={require('../assets/videos/real-time/chromeos/device-control.gif').default} alt="generating gitlab token" width="1340" height="617" className="doc_img"/>
</p>
...
<p align="center">
<img loading="lazy" src={require('../assets/videos/real-time/chromeos/screenshot.png').default} alt="generating gitlab token" width="1340" height="617" className="doc_img"/>
</p>
...
<p align="center">
<img loading="lazy" src={require('../assets/videos/real-time/chromeos/recording.gif').default} alt="generating gitlab token" width="1340" height="617" className="doc_img"/>
</p>
...
<source src= {require('../assets/videos/real-time/chromeos/mark-bug.mp4').default} type="video/mp4" />
</video>

## Gallery
All screenshots and video recordings from test sessions are stored in the Gallery. To access, select Gallery from the left toolbar and you'll find the saved screenshots and videos.

To download the screenshots or videos to your local machine, click on the Download icon. You can also mark them as bug by clicking on the Bug icon.

<p align="center">
<img loading="lazy" src={require('../assets/videos/real-time/chromeos/gallery.png').default} alt="generating gitlab token" width="1340" height="617" className="doc_img"/>
</p>
...
<p align="center">
<img loading="lazy" src={require('../assets/videos/real-time/chromeos/ip.png').default} alt="generating gitlab token" width="1340" height="617" className="doc_img"/>
</p>
...
<p align="center">
<img loading="lazy" src={require('../assets/videos/real-time/chromeos/network.png').default} alt="generating gitlab token" width="1340" height="617" className="doc_img"/>
</p>
...
<p align="center">
<img loading="lazy" src={require('../assets/videos/real-time/chromeos/project.png').default} alt="generating gitlab token" width="1340" height="617" className="doc_img"/>
</p>
...
<p align="center">
<img loading="lazy" src={require('../assets/videos/real-time/chromeos/settings.gif').default} alt="generating gitlab token" width="1340" height="617" className="doc_img"/>
</p>
