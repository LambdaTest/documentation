...
canonical: https://www.testmuai.com/support/docs/hyperexecute-smart-ui-sdk-using-playwright/
  ...
  dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
      "@context": "https://schema.org",
      "@type": "HowTo",
      "name": "UI Testing with Playwright using HyperExecute and SmartUI SDK",
      "description": "Supercharge Hyperexecute UI automation with SmartUI SDK & Playwright. Simplify test creation for all browsers.",
      "step": [
        {
          "@type": "HowToStep",
          ...
          "url": "https://www.testmuai.com/support/docs/hyperexecute-smart-ui-sdk-using-playwright/#step-1-create-a-smartui-project"
        },
        {
          "@type": "HowToStep",
          "position": 2,
          "name": "Step 2: Setup Your Test Suite",
          "text": "You can use your own project to configure and test it. For demo purposes, we are using the sample repository. Download or Clone the code sample for the Maestro framework from the TestMu AI GitHub repository to run the tests on the HyperExecute. In the playwrightCloud.js file, update the following capabilities",
          "url": "https://www.testmuai.com/support/docs/hyperexecute-smart-ui-sdk-using-playwright/#step-2-setup-your-test-suite"
        },
        {
          "@type": "HowToStep",
          "position": 3,
          ...
          "url": "https://www.testmuai.com/support/docs/hyperexecute-smart-ui-sdk-using-playwright/#step-3-setup-the-cli-in-your-test-suite"
        },
        {
          "@type": "HowToStep",
          "position": 4,
          "name": "Step 4: Configure YAML in your Test Suite",
          "text": "You need to edit the PROJECTTOKEN: \"YOURPROJECT_TOKEN\" flag and enter your project token that show in the SmartUI app after, creating your project. It is mandatory to mention these commands in the pre flag to download all the necessary dependencies",
          "url": "https://www.testmuai.com/support/docs/hyperexecute-smart-ui-sdk-using-playwright/#step-4-configure-yaml-in-your-test-suite"
        },
        {
          "@type": "HowToStep",
          "position": 5,
          ...
          "url": "https://www.testmuai.com/support/docs/hyperexecute-smart-ui-sdk-using-playwright/#step-5-execute-your-test-suite"
        },
        {
          "@type": "HowToStep",
          "position": 6,
          ...
          "url": "https://www.testmuai.com/support/docs/hyperexecute-smart-ui-sdk-using-playwright/#step-6-monitor-the-test-execution"
        }
      ]
    }
  ]) }}
