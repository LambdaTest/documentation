...
sidebarTitle: "View Test Metrics & Trends"
description: "Track test metrics and trends in TestMu AI Test Manager: total, manual, and automated test case counts, automation coverage, build and test case summaries, and test case and issue trends."
keywords: ['insights', 'insights dashboard']
"og:description": "Track test metrics and trends in TestMu AI Test Manager: total, manual, and automated test case counts, automation coverage, build and test case summaries, and test case and issue trends."
---
