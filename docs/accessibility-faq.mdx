...
Yes — TestMu AI supports accessibility testing for native mobile apps. Use the [Accessibility App Scanner](/support/docs/accessibility-app-scanner) to scan Android and iOS apps, or run mobile app accessibility checks through [KaneAI](/support/docs/kaneai-mobile-app-accessibility). See the **Test Mobile App Accessibility** section for the full workflow.

## Do you support accessibility testing for PDFs?
Yes — TestMu AI supports accessibility scanning for PDF documents. See [PDF Accessibility Scanning](/support/docs/accessibility-pdf-accessibility-scanning) to check your PDFs against accessibility standards.
