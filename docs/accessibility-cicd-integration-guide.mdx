...
sidebarTitle: "CI/CD Integration Guide"
keywords: ['TestMu AI', 'Accessibility', 'CI/CD', 'GitHub Actions', 'Jenkins']
...
"og:description": "Connect Accessibility Automation to CI/CD—secrets, matrix jobs, gating, and where to review reports after each build."
---
