...
Open the [hosted Web UI](https://rook.lambdatest.com/projects) for shared projects. Public packages default to <code>ROOK_ENV=prod</code>; use the same service, account, and project in the CLI and browser.
