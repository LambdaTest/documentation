...
url: https://www.testmuai.com/support/docs/hyperexecute-azure-setup-test-plan/
site_name: TestMu AI
slug: hyperexecute-azure-setup-test-plan/
canonical: https://www.testmuai.com/support/docs/hyperexecute-azure-setup-test-plan/
---
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/hyperexecute-azure-setup-test-plan/"
    },
    "headline": "Azure Test Plan",
    "description": "Learn how to set up your Azure Test Plan project for seamless integration with HyperExecute.",
    "url": "https://www.testmuai.com/support/docs/hyperexecute-azure-setup-test-plan/",
    "image": {
      "@type": "ImageObject",
