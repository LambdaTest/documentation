      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "item": `${BRAND_URL}/support/docs/kane-ai-web-test-writing-guidelines`
        }]
      })
    }}
></script>
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/kane-ai-web-test-writing-guidelines/"
    },
    "headline": "KaneAI Web Agent - Guidelines for Writing Instructions",
    "description": "Learn how to write instructions for running the kane ai web agent smoothly and without any problem",
    "url": "https://www.testmuai.com/support/docs/kane-ai-web-test-writing-guidelines/",
    "image": {
      "@type": "ImageObject",
