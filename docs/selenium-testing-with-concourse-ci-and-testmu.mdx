...
![find the nodejs-selenium-sample pipeline in the Concourse Web UI](/assets/images/concource-ci/nodejs-lambda-sample-pipeline.webp)
...
![notice the different stages of test execution](/assets/images/concource-ci/nodejs-lambda-sample-execute.webp)
