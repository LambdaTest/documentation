...
<img loading="lazy" src="/assets/images/playwright-android-build-view.png" alt="Playwright Android build and session details on TestMu AI Automation Dashboard" width="1444" height="703"  className="doc_img"/>
