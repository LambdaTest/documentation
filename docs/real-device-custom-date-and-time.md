...
canonical: https://www.testmuai.com/support/docs/set-date-time-hour-format-real-devices/
---
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "itemListElement": [{
      ...
      "item": `${BRAND_URL}/support/docs/set-date-time-hour-format-real-devices/`
    }]
  }) }}
></script>
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/set-date-time-hour-format-real-devices/"
    },
    "headline": "Set Custom Date, Time & Hour Format on Real Devices",
    "description": "Set custom date, time, and 12/24-hour format on real iOS and Android devices during manual app testing and Appium automation sessions on TestMu AI.",
    "url": "https://www.testmuai.com/support/docs/set-date-time-hour-format-real-devices/",
    "image": {
      "@type": "ImageObject",
