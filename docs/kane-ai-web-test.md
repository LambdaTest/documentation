...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/kane-ai-web-agent/"
    },
    "headline": "Automate your Web App Testing with KaneAI",
    "description": "Author your first test with KaneAI",
    "url": "https://www.testmuai.com/support/docs/kane-ai-web-agent/",
    "image": {
      "@type": "ImageObject",
...
<source src= {require('../assets/images/kane-ai/write-web-test.mp4').default} style={{ height: '300px' }} type="video/mp4" />
</video>
...
<video class="right-side" width="80%" controls id="vid">
<source src= {require('../assets/images/kane-ai/execute-test.mp4').default} style={{ height: '300px' }} type="video/mp4" />
</video>
