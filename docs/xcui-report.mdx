...
sidebarTitle: "Download XCResult Bundle"
keywords: ['xcui','java','xcui junit xml reports','lambdatest java','framework on lambdatest','testng','app testing','real devices']
