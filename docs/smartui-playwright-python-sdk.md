...
url: https://www.testmuai.com/support/docs/smartui-playwright-python-sdk/
slug: smartui-playwright-python-sdk/
canonical: https://www.testmuai.com/support/docs/smartui-playwright-python-sdk/
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/smartui-playwright-python-sdk/"
    },
    "headline": "Integrate SmartUI SDK with Playwright-Python",
    "description": "In this documentation, learn how integrate your Playwright Python automated tests with TestMu AI's SmartUI.",
    "url": "https://www.testmuai.com/support/docs/smartui-playwright-python-sdk/",
    "image": {
      "@type": "ImageObject",
    ...
    "dependencies": "Basic understanding of Command Line Interface and Playwright is required.; Login to TestMu AI SmartUI with your credentials.; Install virtualenv which is the recommended way to run your tests. It will isolate the build from other setups you may have running and ensure that the tests run with the specified versions of the modules..",
    "author": {
      "@type": "Organization",
    ...
    "hasPart": [
      ...
      },
      {
        ...
        "codeSampleType": "code snippet",
        "programmingLanguage": "Shell",
        "codeRepository": "https://github.com/LambdaTest/smartui-playwright-python-sdk-sample",
        "text": "git clone https://github.com/LambdaTest/smartui-playwright-python-sdk-sample\ncd smartui-playwright-python-sdk-sample"
      },
      {
        "@type": "SoftwareSourceCode",
        "name": "Step 1: Create/Update your test",
      ...
      },
      {
        ...
        "codeSampleType": "code snippet",
        "programmingLanguage": "Shell",
        "text": "pip install lambdatest-playwright-driver"
      },
      {
        "@type": "SoftwareSourceCode",
      ...
      },
      {
        ...
        "codeSampleType": "code snippet",
        "programmingLanguage": "Shell",
        "text": "npx smartui --config .smartui.json exec -- python SmartUI_SDK_LT_hub.py"
      },
      {
        "@type": "SoftwareSourceCode",
      ...
      },
      {
        ...
        "codeSampleType": "code snippet",
        "programmingLanguage": "Python",
        "text": "   page.wait_for_selector(\"#content\", state=\"visible\")\n   page.wait_for_selector(\".main-content\", state=\"visible\")\n   page.wait_for_load_state(\"networkidle\")"
      },
      {
        "@type": "SoftwareSourceCode",
      ...
      },
      {
        ...
        "codeSampleType": "code snippet",
        "programmingLanguage": "Shell",
        "text": "   pip index versions lambdatest-playwright-driver"
      },
      {
        "@type": "SoftwareSourceCode",
      ...
      "step": [
        {
          ...
          "position": 1,
          "name": "Step 1: Create/Update your test",
          "text": "You can clone the sample repository to run LambdaTest automation tests with SmartUI and use the SmartUISDKLT_hub.py file. Create a virtual environment in your project folder (the environment name is arbitrary). Activate the environment.",
          "url": "https://www.testmuai.com/support/docs/smartui-playwright-python-sdk/#step-1-createupdate-your-test"
        },
        {
          "@type": "HowToStep",
          "position": 2,
          "name": "Step 2: Install the Dependencies",
          "text": "Install required NPM modules for TestMu AI SmartUI Playwright Python SDK in your Frontend project. If you face any problems executing tests with SmartUI-CLI versions >= v4.x.x, upgrade your Node.js version to v20.3 or above.",
          "url": "https://www.testmuai.com/support/docs/smartui-playwright-python-sdk/#step-2-install-the-dependencies"
        },
        {
          "@type": "HowToStep",
          "position": 3,
          ...
          "url": "https://www.testmuai.com/support/docs/smartui-playwright-python-sdk/#step-3-configure-your-project-token"
        },
        {
          "@type": "HowToStep",
          "position": 4,
          ...
          "url": "https://www.testmuai.com/support/docs/smartui-playwright-python-sdk/#step-4-create-and-configure-smartui-config"
        },
        {
          "@type": "HowToStep",
          "position": 5,
          ...
          "url": "https://www.testmuai.com/support/docs/smartui-playwright-python-sdk/#step-6-execute-the-tests-on-smartui-cloud"
        }
      ]
    }
  ]) }}
