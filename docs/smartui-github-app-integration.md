...
title: GitHub & GitLab Pull Request Testing with SmartUI
sidebar_label: GitHub
description: Post SmartUI visual regression results as pull/merge request checks on GitHub (via the GitHub App) and GitLab (via CI/CD PR checks using SmartUI Hooks or SmartUI Exec/SDK). Step-by-step setup for Selenium, Playwright, WebdriverIO, Appium, and more.
keywords:
  - Visual Regression
...
canonical: https://www.testmuai.com/support/docs/smartui-github-app-integration/
