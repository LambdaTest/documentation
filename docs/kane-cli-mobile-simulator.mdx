...
"og:description": "Set up Apple's iOS Simulator so Kane CLI can run mobile tests against a virtual iOS device on macOS Apple Silicon. Install Xcode 16 or newer, point the command line tools at it, then let Kane CLI install its test tooling."
---
