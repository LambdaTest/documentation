...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/ranorex-integration-with-testmu/"
    },
    "headline": "How to Perform Automation Testing with Ranorex Using TestMu AI",
    "description": "TestMu AI offers integration with Ranorex to help you perform automated cross browser testing of your web app on over 3000+ real browsers & browser versions through an on-cloud Selenium Grid. You could perform tests on your locally hosted files and can execute parallel testing to trim down your test cycles drastically.",
    "url": "https://www.testmuai.com/support/docs/ranorex-integration-with-testmu/",
    "image": {
      "@type": "ImageObject",
...
# Ranorex Integration With <BrandName />
...
<img loading="lazy" src={require('../assets/images/ranorex-integration-with-lambdatest/2.webp').default} alt="Website Testing Using Ranorax and <BrandName />" width="1365" height="730" className="doc_img"/>
...
<img loading="lazy" src={require('../assets/images/ranorex-integration-with-lambdatest/7.webp').default} alt="<BrandName /> Ranorex test suite" width="1365" height="730" className="doc_img"/>
...
<img loading="lazy" src={require('../assets/images/ranorex-integration-with-lambdatest/21.webp').default} alt="run automation tests using Ranorex <BrandName /> Integration" width="1365" height="728" className="doc_img"/>
...
<nav aria-label="breadcrumbs">
  <ul className="breadcrumbs">
    ...
    <li className="breadcrumbs__item breadcrumbs__item--active">
      <span className="breadcrumbs__link">Ranorex <BrandName /> Integration</span>
    </li>
  </ul>
</nav>
