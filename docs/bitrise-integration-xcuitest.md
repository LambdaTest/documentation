...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/bitrise-integration-xcuitest/"
    },
    "headline": "Integrating TestMu AI as a Bitrise CI/CD Step [XCUITest]",
    "description": "Integrate TestMu AI with Bitrise CI/CD Step [XCUITest] to run your XCUITest workflow successfully on TestMu AI.",
    "url": "https://www.testmuai.com/support/docs/bitrise-integration-xcuitest/",
    "image": {
      "@type": "ImageObject",
...
Using <BrandName /> with Bitrise, you can effortlessly perform [XCUI testing](https://www.testmuai.com/xcuitest-app-testing) of your mobile apps on an [online device farm](https://www.testmuai.com/online-device-farm) of real Android devices.
