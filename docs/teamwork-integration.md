...
<img loading="lazy" src={require('../assets/images/teamwork-integration/teamwork-9-3.webp').default} alt="teamwork integration bug" width="1365" height="620" className="doc_img"/>
