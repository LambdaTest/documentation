---
id: kaneai-bulk-module-update
title: Bulk Module Update
hide_title: false
sidebar_label: Bulk Module Update
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/kaneai-bulk-module-update/"
    },
    "headline": "Bulk Module Update",
    "description": "Learn how to update module versions across multiple KaneAI test cases in a single action using the Bulk Module Update feature.",
    "url": "https://www.testmuai.com/support/docs/kaneai-bulk-module-update/",
    "image": {
      "@type": "ImageObject",
  ...
  dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
      "@context": "https://schema.org",
      "@type": "HowTo",
      "name": "How to Use Bulk Module Update",
      "description": "Learn how to update module versions across multiple KaneAI test cases in a single action using the Bulk Module Update feature.",
      "step": [
        {
          "@type": "HowToStep",
          "position": 1,
          "name": "Step 1: Access Bulk Module Update",
          "text": "You can start a bulk module update from two places: Navigate to the module whose version you want to bulk-update Click the Update Test Cases button If the module version is not yet authored/validated or there are no eligible test cases, this button will be disabled Open a test case that uses the module version you want to update If there is a newer version of the same module and other test cases still use the older version, you will see an Update Module for all Linked Test Cases button Click this button to open the bulk update flow, pre-filtered for that module and version",
          "url": "https://www.testmuai.com/support/docs/kaneai-bulk-module-update/#step-1-access-bulk-module-update"
        },
        {
          "@type": "HowToStep",
          "position": 2,
          "name": "Step 2: Module Validation Check",
          "text": "Before the bulk update flow starts, the system checks whether the selected module version is authored/validated and whether there are eligible test cases to update. The Update Test Cases button will be disabled if: The module version is not authored/validated yet There are no eligible test cases (e.g., all linked test cases are faulty, unverified, or non-KaneAI) You will see a message such as: \"This module version is not authored yet. Author it in a test to enable bulk update.\" To resolve: Use the module in a test case and complete its authoring/validation, then ensure eligible KaneAI test cases are available. -->",
...
<img loading="lazy" src={require('../assets/images/kane-ai/features/bulk-module-update/module-detail-cta.png').default} alt="module-detail-cta" className="doc_img"/>
...
<img loading="lazy" src={require('../assets/images/kane-ai/features/bulk-module-update/test-case-summary-cta.png').default} alt="test-case-summary-cta" className="doc_img"/>
...
<!-- <img loading="lazy" src={require('../assets/images/kane-ai/features/bulk-module-update/disabled-cta.png').default} alt="disabled-cta" className="doc_img"/> -->
...
<img loading="lazy" src={require('../assets/images/kane-ai/features/bulk-module-update/test-case-selection.png').default} alt="test-case-selection" className="doc_img"/>
...
<img loading="lazy" src={require('../assets/images/kane-ai/features/bulk-module-update/summary-screen.png').default} alt="summary-screen" className="doc_img"/>

---

After triggering the update, you will see a success banner along with a toast message as shown in the screenshot below

<img loading="lazy" src={require('../assets/images/kane-ai/features/bulk-module-update/toast-notification.png').default} alt="toast-notification" className="doc_img"/>
...
<img loading="lazy" src={require('../assets/images/kane-ai/features/bulk-module-update/code-gen-section.png').default} alt="code-gen-section" className="doc_img"/>
...
<img loading="lazy" src={require('../assets/images/kane-ai/features/bulk-module-update/linked-test-cases.png').default} alt="linked-test-cases" className="doc_img"/>
