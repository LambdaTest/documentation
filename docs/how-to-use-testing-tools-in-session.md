...
<img loading="lazy" src={require('../assets/images/real-device-app-testing/device-control-real-device.webp').default} alt="add" width="1346" height="647" className="doc_img"/>
