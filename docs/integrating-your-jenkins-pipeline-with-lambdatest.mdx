...
**Step 1:** Create a new project for Pipeline by going to Jenkins */} New Item. <img loading="lazy" src="/assets/images/uploads/jenkins-pipeline-1.webp" alt="Jenkins" width="1896" height="216" className="doc_img"/>

 **Step 2:** Select the Pipeline.
  <img loading="lazy" src="/assets/images/uploads/jenkins-pipeline-2.webp" alt="jenkins pipeline" width="1902" height="904" className="doc_img"/> 
  
  **Step 3:** Scroll down to Advanced Project Options. Paste the Code in the code pane or fetch it via SCM & hit the **Save** button. <img loading="lazy" src="/assets/images/uploads/jenkins-pipeline-3.webp" alt="Jenkins save button" width="1919" height="906" className="doc_img"/>
