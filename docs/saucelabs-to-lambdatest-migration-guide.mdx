...
***
## Authentication
Firstly, you need to change the authentication in your configuration settings of your test suite. For running tests on <BrandName /> Selenium Grid, you need to have a valid user_name and access_key to perform tests on our Grid. In case you do not have an account on <BrandName />, visit the <a href="https://www.testmuai.com/register/"><BrandName /> signup page</a> and create a new account.
...
<Tab title="TestMu AI Selenium Grid Credentials">
```
...
<Tab title="TestMu AI Selenium Grid URL">
...
<Tab title="TestMu AI Capabilities">
...
<Tab title="TestMu AI Execution With Selenium 4 Capabilities">
...
<Tab title="TestMu AI Execution With Selenium 3 Capabilities">
...
<img loading="lazy" className="doc_img" src="/assets/images/browserstack-lambdatest-migration/lambdatest-safar-execution.png" alt="TestMu AI text validation result" width="1024" height="667" />
