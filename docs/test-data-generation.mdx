...
<img loading="lazy" src="/assets/images/kane-ai/features/datasets/1.png" alt="KaneAI Test Manager Parameters table with Age, Phone number, and Name columns" className="doc_img img_center"/>

<img loading="lazy" src="/assets/images/kane-ai/features/datasets/5.png" alt="Autofill with AI populating dataset values automatically" className="doc_img img_center"/>
...
- [HyperExecute Lambda Masking (Release 2.3.1)](/support/docs/hyperexecute-release-notes/#version-2-3-1)
...
<img loading="lazy" src="/assets/images/kane-ai/features/parameters/1.png" alt="Convert step value as Parameter, Variable, or Secret in KaneAI" className="doc_img img_center"/>

<img loading="lazy" src="/assets/images/kane-ai/features/parameters/3.png" alt="Create Parameter dialog with name and value fields in KaneAI" className="doc_img img_center"/>
