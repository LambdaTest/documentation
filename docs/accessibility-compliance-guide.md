      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "@type": "ListItem",
          "position": 3,
          "name": "Accessibility Compliance Guide (ADA / WCAG / EAA / 508)",
          "item": `${BRAND_URL}/support/docs/accessibility-compliance-guide/`
        }]
      })
    }}
></script>
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/accessibility-compliance-guide/"
    },
    "headline": "Accessibility Compliance Guide (ADA / WCAG / EAA / 508)",
    "description": "High-level reference for common accessibility compliance frameworks and how Accessibility Testing supports those workflows.",
    "url": "https://www.testmuai.com/support/docs/accessibility-compliance-guide/",
    "image": {
      "@type": "ImageObject",
