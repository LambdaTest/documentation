...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/accessibility-android-rule-undersized-touch-target/"
    },
    "headline": "Undersized Touch Target",
    "description": "Rule-level Accessibility guidance for Undersized Touch Target on Android.",
    "url": "https://www.testmuai.com/support/docs/accessibility-android-rule-undersized-touch-target/",
    "image": {
      "@type": "ImageObject",
