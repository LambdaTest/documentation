...
sidebarTitle: "A/B Testing & Variations"
keywords: ['smartui', 'smartui ab testing', 'baseline variations', 'multiple baselines', 'visual regression', 'matched with', 'screenshot comparison', 'pdf visual testing', 'smartui pdf', 'feature flags', 'a/b test ui']
...
"og:description": "Use SmartUI A/B testing on web screenshots and PDF pages to compare captures against multiple baseline variations (up to 20), see Matched with status, manage variations, and end an experiment by picking a winner."
---
...
<img loading="lazy" src="/assets/images/smart-visual-testing/a-b-testing/a-b-testicon.png" alt="A/B testing icon on the SmartUI screenshot review page to open the variations panel" width="960" className="doc_img" />
...
<img loading="lazy" src="/assets/images/smart-visual-testing/a-b-testing/a-b-test-defaultvariation.png" alt="A/B testing panel showing the default variation derived from the current build baseline" width="960" className="doc_img" />
...
<img loading="lazy" src="/assets/images/smart-visual-testing/a-b-testing/a-b-test-addnew.png" alt="Add new variation control in the A/B testing panel to save the current capture as an additional baseline" width="960" className="doc_img" />

Each added variation stays active until you **delete** it or **end A/B testing**.

<img loading="lazy" src="/assets/images/smart-visual-testing/a-b-testing/a-b-test-initiated.png" alt="A/B testing active with multiple variations listed in the right-hand panel for the screenshot" width="960" className="doc_img" />
...
<img loading="lazy" src="/assets/images/smart-visual-testing/a-b-testing/a-b-test-matchedwithvariation.png" alt="Matched with label in the A/B panel showing which variation the latest capture matched" width="960" className="doc_img" />
...
<img loading="lazy" src="/assets/images/smart-visual-testing/a-b-testing/a-b-test-variation-rename.png" alt="Rename a user-added variation in the A/B testing panel" width="960" className="doc_img" />

<img loading="lazy" src="/assets/images/smart-visual-testing/a-b-testing/a-b-test-variation-delete.png" alt="Delete a user-added variation from the A/B testing panel" width="960" className="doc_img" />
...
<img loading="lazy" src="/assets/images/smart-visual-testing/a-b-testing/a-b-test-endtest.png" alt="End A/B testing flow to choose one variation as the winning baseline" width="960" className="doc_img" />

<img loading="lazy" src="/assets/images/smart-visual-testing/a-b-testing/a-b-test-endtest-confirmation.png" alt="Confirmation when ending A/B testing and promoting one variation as the sole baseline" width="960" className="doc_img" />
