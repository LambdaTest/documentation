...
**Step 1:** Login to <BrandName />. If you haven’t signed up yet, click <a href="https://www.testmuai.com/register/">here</a>.

**Step 2:** Visit your Profile on <BrandName /> to fetch your Username and Access Key value.

<img loading="lazy" src="/assets/images/katalon/Katalon-1.webp" alt="katalon integration"  className="doc_img" width="1365" height="652"/>
...
<img loading="lazy" src="/assets/images/katalon/Katalon-2.webp" alt="declaring desired capabilities"  className="doc_img" width="1346" height="652"/>

The below execution is set up on Katalon version 5.10.1.

<img loading="lazy" src="/assets/images/katalon/3.webp" alt="Steup Katalon version 5.10.1"  className="doc_img" width="894" height="596"/>
...
<img loading="lazy" src="/assets/images/katalon/4.webp" alt="<BrandName /> settings"  className="doc_img" width="894" height="596" />
...
<img loading="lazy" src="/assets/images/katalon/5-1.webp" alt="executing automation tests"  className="doc_img" width="894" height="596"/>
