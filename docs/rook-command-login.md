...
sidebar_label: /login
description: Sign in to Rook through the LambdaTest browser authentication flow.
...
<img loading="lazy" src={require('../assets/images/rook/commands/rook-command-login.png').default} alt="Rook login command help" width="1556" height="1466" className="doc_img"/>
...
2. Complete the LambdaTest flow in the browser.
