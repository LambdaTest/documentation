---
id: phone-agent
title: How to Test Phone Agents on the AI Agent Testing Platform
hide_title: false
...
site_name: TestMu AI
slug: phone-agent/
canonical: https://www.testmuai.com/support/docs/phone-agent/
---
      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "@type": "ListItem",
          "position": 3,
          "name": "Phone Agent Testing",
          "item": `${BRAND_URL}/support/docs/phone-agent`
        }]
      })
    }}
></script>

# How to Test Phone Agents on the AI Agent Testing Platform
