      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "item": `${BRAND_URL}/support/docs/accessibility-web-rule-4-1-2-name-role-value/`
        }]
      })
    }}
></script>
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/accessibility-web-rule-4-1-2-name-role-value/"
    },
    "headline": "Name, Role, Value (4.1.2)",
    "description": "Rule-level Accessibility guidance for Name, Role, Value (WCAG 4.1.2 Level A).",
    "url": "https://www.testmuai.com/support/docs/accessibility-web-rule-4-1-2-name-role-value/",
    "image": {
      "@type": "ImageObject",
