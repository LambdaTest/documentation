...
title: "Global Policies in HyperExecute"
toc_max_heading_level: 2
hide_title: false
sidebar_label: "Global Policies"
...
keywords:
  ...
  - HyperExecute Global Policies
  - HyperExecute YAML policies
  - org level YAML enforcement
  - global post policy
url: https://www.testmuai.com/support/docs/hyperexecute-global-policies/
site_name: TestMu AI
slug: hyperexecute-global-policies/
canonical: https://www.testmuai.com/support/docs/hyperexecute-global-policies/
---
      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "@type": "ListItem",
          "position": 3,
          "name": "Global Policies in HyperExecute",
          "item": `${BRAND_URL}/support/docs/hyperexecute-global-policies/`
        }]
      })
    }}
></script>
...
<img loading="lazy" src={require('../assets/images/hyperexecute/features/global-policies/global-policies-list.png').default} alt="Global Policies dashboard listing existing policies with their parameter, mode, severity and enabled state" className="doc_img"/>

Policies are **API-first**, so you can create and maintain them from your automation (Harness, Jenkins, a Git-managed script) exactly like the rest of your pipeline. You can also manage them from the <BrandName /> dashboard under [Org Product Preferences](/support/docs/hyperexecute-org-product-preferences/).
...
<img loading="lazy" src={require('../assets/images/hyperexecute/features/global-policies/manage-policies.png').default} alt="Delete confirmation dialog warning that deleting a policy is permanent, with the option to toggle it off instead" className="doc_img"/>
...
`DELETE /v1.0/policies/{id}?actor=<your-name>` removes the policy permanently. The `actor` query parameter records who performed the deletion.
