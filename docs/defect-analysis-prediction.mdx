...
<img loading="lazy" src="/assets/images/analytics/atx-flakiness-trends.webp" alt="Flaky Test Trends" width="768" height="373" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/analytics/test-intelligence-ai-test-rca-output.webp" alt="AI Root Cause Analysis Output" width="800" height="400" className="doc_img"/>
