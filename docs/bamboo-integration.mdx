...
<img loading="lazy" src="/assets/images/bamboo-integration/1.webp" alt="Bamboo Integration" width="810" height="1010" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/bamboo-integration/2.webp" alt="Bamboo Integration" width="902" height="839" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/bamboo-integration/3.webp" alt="Bamboo Integration" width="900" height="764" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/bamboo-integration/4.webp" alt="Bamboo Integration" width="902" height="323" className="doc_img"/>
