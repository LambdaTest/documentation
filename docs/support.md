...
<div className="home_main">
          ...
          <div className="home_inners_box">
            <h2 className="homeMain_h2"><RealtimeLightIcon className="home_icons home_light_icon" role="presentation"/> <RealtimeDarkIcon className="home_icons home_dark_icon" role="presentation"/>Kane CLI &nbsp;<NewTag value="NEW" /></h2>
            <div className="home_inners">
...
<div className="home_main">
          ...
          <div className="home_inners_box">
            <h2 className="homeMain_h2"><TestManagerLightIcon className="home_icons home_light_icon" role="presentation"/> <TestManagerDarkIcon className="home_icons home_dark_icon" role="presentation"/>TestMu AI MCP Server &nbsp;<NewTag value="NEW" /></h2>
            <div className="home_inners">
