...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/playwright-python-on-hyperexecute/"
    },
    "headline": "Run playwright automation tests on HyperExecute using Python",
    "description": "Learn how to run playwright automation tests on HyperExecute using Python framework",
    "url": "https://www.testmuai.com/support/docs/playwright-python-on-hyperexecute/",
    "image": {
      "@type": "ImageObject",
      ...
      "step": [
        {
          ...
          "text": "You can use your own project to configure and test it. For demo purposes, we are using the sample repository. Download or Clone the code sample for the JUnit from the TestMu AI GitHub repository to run the tests on the HyperExecute. If you are using your own project, make sure you update the Hub endpoint in your tests file. By setting up the Hub endpoint, you establish the communication channel between your tests and the browser nodes, enabling effective test distribution and execution. You can also use dev and beta browser versions. To generate capabilities for your test requirements, you can use our inbuilt \ud83d\udd17 Capabilities Generator.",
          "url": "https://www.testmuai.com/support/docs/playwright-python-on-hyperexecute/#step-1-configure-your-test-suite"
        },
        {
          "@type": "HowToStep",
          "position": 2,
          ...
          "url": "https://www.testmuai.com/support/docs/playwright-python-on-hyperexecute/#step-2-setup-the-cli-in-your-test-suite"
        },
        {
          "@type": "HowToStep",
          "position": 3,
          ...
          "url": "https://www.testmuai.com/support/docs/playwright-python-on-hyperexecute/#step-3-configure-yaml-in-your-test-suite"
        },
        {
          "@type": "HowToStep",
          "position": 4,
          ...
          "url": "https://www.testmuai.com/support/docs/playwright-python-on-hyperexecute/#step-4-execute-your-test-suite"
        },
        {
          "@type": "HowToStep",
          "position": 5,
          ...
          "url": "https://www.testmuai.com/support/docs/playwright-python-on-hyperexecute/#step-5-monitor-the-test-execution"
        },
        {
          "@type": "HowToStep",
          "position": 6,
          ...
          "url": "https://www.testmuai.com/support/docs/playwright-python-on-hyperexecute/#step-6-download-artifacts-and-reports"
        }
      ]
    }
  ]) }}
...
[<img alt="Run in Gitpod" width="200 px" align="center" src="https://user-images.githubusercontent.com/1688653/165307331-fbcf16b0-ce49-40f5-9f87-4f080d674624.png" />](https://www.testmuai.com/login/?redirectTo=https://hyperexecute.lambdatest.com/hyperexecute/jobs?type=gitpod&frameworkType=PlayWright&framework=Python)
