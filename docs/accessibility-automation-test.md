...
title: How to Run First Automated Accessibility Test
sidebar_label: Automate Accessibility Test
      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "@type": "ListItem",
          "position": 3,
          "name": "How to Run First Automated Accessibility Tests",
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "headline": "How to Run First Automated Accessibility Tests",
    "description": "Identify and log accessibility issues with TestMu AI Accessibility Automation, ensuring automated compliance with WCAG accessibility standards.",
    "url": "https://www.testmuai.com/support/docs/accessibility-automation-test/",
    "image": {
      "@type": "ImageObject",
...
# How to Run First Automated Accessibility Test
---

Automated accessibility testing runs WCAG accessibility checks against your web pages inside your existing automation flow — using tools like **Selenium** — then reports the violations in the <BrandName /> Automation dashboard. Enable it with a single capability, choose whether scans fire on demand or automatically, and review the results alongside the rest of your automation run.
