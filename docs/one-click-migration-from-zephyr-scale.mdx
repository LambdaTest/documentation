...
sidebarTitle: "One Click Migration from Zephyr Scale"
---
...
<img loading="lazy" src='/assets/images/xray-migration/import-data-project-listing.png' alt="import-data-project-listing" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/xray-migration/zephyr-enter-credentials.png' alt="enter-zephyr-credentials" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/xray-migration/select-project.png' alt="select-jira-project" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/xray-migration/migration-progress.png' alt="migration-progress" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/xray-migration/email-completion.png' alt="email-completion-notification" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/xray-migration/zephyr-test-cases.png' alt="migration-results" width="1366" height="629"/>
...
<Info>
**Test Data Migration:** Test Data from Zephyr Scale steps is migrated as a single textarea custom field at the test case level, with textual data consolidated together. This is because Test Manager does not currently support a step-level Test Data field.
</Info>
