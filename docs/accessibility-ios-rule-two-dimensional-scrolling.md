---
id: accessibility-ios-rule-two-dimensional-scrolling
title: Two-Dimensional Scrolling Required
sidebar_label: Two-Dimensional Scrolling
description: Rule-level Accessibility guidance for Two-Dimensional Scrolling Required on iOS.
slug: accessibility-ios-rule-two-dimensional-scrolling/
---
      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "@type": "ListItem",
          "position": 3,
          "name": "Two-Dimensional Scrolling Required",
          "item": `${BRAND_URL}/support/docs/accessibility-ios-rule-two-dimensional-scrolling/`
        }]
      })
    }}
></script>
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/accessibility-ios-rule-two-dimensional-scrolling/"
    },
    "headline": "Two-Dimensional Scrolling Required",
    "description": "Rule-level Accessibility guidance for Two-Dimensional Scrolling Required on iOS.",
    "url": "https://www.testmuai.com/support/docs/accessibility-ios-rule-two-dimensional-scrolling/",
    "image": {
      "@type": "ImageObject",
