      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "item": `${BRAND_URL}/support/docs/real-time-locally-hosted-pages/`
        }]
      })
    }}
></script>
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/real-time-locally-hosted-pages/"
    },
    "headline": "Locally Hosted Pages",
    "description": "Securely test your locally hosted websites and application using the real time testing feature of TestMu AI with over 3000+ browsers and different OS.",
    "url": "https://www.testmuai.com/support/docs/real-time-locally-hosted-pages/",
    "image": {
      "@type": "ImageObject",
