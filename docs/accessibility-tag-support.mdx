...
<img loading="lazy" src="/assets/images/accessibility-testing/features/tag-support/assign-tag-icon-in-view.png" alt="Assign tags icon in the accessibility issue view" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/accessibility-testing/features/tag-support/assign-tag-modal.png" alt="Assign Tags modal for accessibility scans" className="doc_img"/>

### Step 3: Review tagged issues

Once saved, the selected tags appear with the affected issue details.

<img loading="lazy" src="/assets/images/accessibility-testing/features/tag-support/tagged-issue.png" alt="Tagged issue shown in the accessibility dashboard" className="doc_img"/>

### Step 4: Filter the dashboard by tag

Use the **Tags** filter to show only the issues or views that match the selected tags.

<img loading="lazy" src="/assets/images/accessibility-testing/features/tag-support/tag-filter.png" alt="Tag filter in the accessibility dashboard" className="doc_img"/>

### Step 5: Use tags in Mobile View

The same tags are also available when you review the test in **Mobile View**.

<img loading="lazy" src="/assets/images/accessibility-testing/features/tag-support/mobile-view-tags.png" alt="Tags visible in mobile view for accessibility scans" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/accessibility-testing/features/tag-support/groupby-view.png" alt="Accessibility issues grouped by views" className="doc_img"/>

**Group by: Issue Types**

<img loading="lazy" src="/assets/images/accessibility-testing/features/tag-support/groupby-issues.png" alt="Accessibility issues grouped by issue types" className="doc_img"/>
