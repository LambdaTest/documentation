      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "item": `${BRAND_URL}/support/docs/browser-testing-on-real-devices/`
        }]
      })
    }}
></script>
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/browser-testing-on-real-devices/"
    },
    "headline": "Getting started with Real Device Browser Testing",
    "description": "With TestMu AI, conduct live interactive testing of websites and web apps on real Android and iOS devices to ensure a seamless user experience.",
    "url": "https://www.testmuai.com/support/docs/browser-testing-on-real-devices/",
    "image": {
      "@type": "ImageObject",
