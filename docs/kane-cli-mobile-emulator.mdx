---
title: "How to Set Up Android Emulator for Kane CLI"
sidebarTitle: "Android Emulator Setup"
description: "Set up Google's Android Emulator so Kane CLI can run mobile tests on a virtual Android device on macOS Apple Silicon: install Android Studio and add an AVD."
...
"og:description": "Set up Google's Android Emulator so Kane CLI can run mobile tests on a virtual Android device on macOS Apple Silicon: install Android Studio and add an AVD."
---
