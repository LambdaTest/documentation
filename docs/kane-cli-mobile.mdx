...
keywords: ['kane cli mobile', 'kane cli emulator', 'kane cli simulator', 'mobile app testing', 'android emulator testing', 'ios simulator testing']
"og:description": "Run Kane CLI tests against local mobile virtual devices. Drive a native Android app on the Android Emulator or a native iOS app on the iOS Simulator, on macOS Apple Silicon."
---
...
|--------|----------------|-------------|-------------|
| iOS | iOS Simulator | Xcode, the full app, version 16 or newer | [iOS Simulator setup](/docs/kane-cli-mobile-simulator/) |
| Android | Android Emulator | Android Studio or the Android SDK, plus one `arm64-v8a` AVD | [Android Emulator setup](/docs/kane-cli-mobile-emulator/) |
...
- [Android Emulator setup](/docs/kane-cli-mobile-emulator/)
