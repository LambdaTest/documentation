...
The prerequisites, the app rules, and what one job can hold are covered in [Remote Runs on the Cloud Grid](/docs/kane-cli-remote-execution/).
...
- [Remote Runs on the Cloud Grid](/docs/kane-cli-remote-execution/) to run mobile suites from any machine
