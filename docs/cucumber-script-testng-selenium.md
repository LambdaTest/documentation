      ...
      "step": [
        {
          ...
          "url": "https://www.testmuai.com/support/docs/running-cucumber-scripts-with-testng-and-selenium/#step-1-clone-the-sample-project"
        },
        {
          "@type": "HowToStep",
          "position": 2,
          ...
          "url": "https://www.testmuai.com/support/docs/running-cucumber-scripts-with-testng-and-selenium/#step-2-set-your-credentials"
        },
        {
          "@type": "HowToStep",
          "position": 3,
          "name": "Step 3: Configure Your Test Capabilities",
          "text": "Define the browser, version, and OS for your test run. Use the Capabilities Generator to auto-generate capabilities for any browser, version, and OS combination. Below is the sample feature file for Cucumber: Here is the TestRunner file to automate the feature file through Selenium using TestNG: Below are the step definitions:",
          "url": "https://www.testmuai.com/support/docs/running-cucumber-scripts-with-testng-and-selenium/#step-3-configure-your-test-capabilities"
        },
        {
          "@type": "HowToStep",
          "position": 4,
          ...
          "url": "https://www.testmuai.com/support/docs/running-cucumber-scripts-with-testng-and-selenium/#step-4-run-the-test"
        },
        {
          "@type": "HowToStep",
          "position": 5,
          ...
          "url": "https://www.testmuai.com/support/docs/running-cucumber-scripts-with-testng-and-selenium/#step-5-view-your-results"
        }
      ]
    }
  ]) }}
