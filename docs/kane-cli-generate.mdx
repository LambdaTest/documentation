---
title: "How to Generate Test Cases with Kane CLI"
sidebarTitle: "Overview"
description: "Turn a plain-language description of what to test into structured scenarios and test cases with kane-cli generate, then save them as runnable _test.md files."
...
"og:description": "Turn a plain-language description of what to test into structured scenarios and test cases with kane-cli generate, then save them as runnable _test.md files."
---
...
| `--username`, `--access-key` | Authentication, same as [`kane-cli run`](/docs/kane-cli-quickstart/). See [Authentication](/docs/kane-cli-authentication/). |
