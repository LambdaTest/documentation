...
sidebarTitle: "Mismatch Thresholds"
---
...
<Info>
**Example:** If you set `approvalThreshold: 2` and `rejectionThreshold: 5`:
...
| 3 (Lowest) | **Project** | Applies to all builds in a project | Configure in the [TestMu AI SmartUI Dashboard](https://smartui.lambdatest.com) |

<Tip>
**Backward Compatible:** If you do not configure build or screenshot-level thresholds, your existing project-level settings continue to apply. No changes are needed to your existing tests.
</Tip>
---
