...
![Smart Visual Testing](/assets/images/smart-visual-testing/git-doc-header.webp)
...
![Smart Visual Testing](/assets/images/smart-visual-testing/git-baseline-non-baseline-diff.webp)
...
![Smart Visual Testing](/assets/images/smart-visual-testing/git-settings.webp)
...
![Smart Visual Testing](/assets/images/smart-visual-testing/git-basic-setup.webp)
...
![Smart Visual Testing](/assets/images/smart-visual-testing/smartui-git-build-meta-data.webp)
...
![Smart Visual Testing](/assets/images/smart-visual-testing/git-working-on-same-branch.webp)
...
![Smart Visual Testing](/assets/images/smart-visual-testing/git-updating-baseline-branch.webp)
...
![Smart Visual Testing](/assets/images/smart-visual-testing/git-compare-with-latest-build.webp)
...
![Smart Visual Testing](/assets/images/smart-visual-testing/git-baseline-non-baseline.webp)
...
![Smart Visual Testing](/assets/images/smart-visual-testing/git-auto-update-baseline-build.webp)
