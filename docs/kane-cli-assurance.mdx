---
title: "The Kane CLI Assurance Lifecycle"
sidebarTitle: "Overview"
description: "Go from requirements to designed, runnable tests with the kane-cli assurance commands: every test linked to what it verifies, coverage from evidence."
keywords: ['kane cli assurance', 'requirements to tests', 'test coverage lifecycle', 'context graph', 'ai test design', 'kaneai', 'testmu ai']
"og:description": "Go from requirements to designed, runnable tests with the kane-cli assurance commands: every test linked to what it verifies, coverage from evidence."
---
...
| Share | [`kane-cli context sync`](/docs/kane-cli-assurance-sharing/) | Share the store with your team through a location, a GitHub repository, an S3-compatible bucket, or a folder, with `kane-cli context push`, `kane-cli context pull` and `kane-cli context clone` |
