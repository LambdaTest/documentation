...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/mstest-with-selenium-running-mstest-automation-scripts-on-testmu-selenium-grid/"
    },
    "headline": "Selenium With MSTest",
    "description": "Run MSTest Selenium tests on TestMu AI cloud grid with 3000+ browsers. Set up, configure, and execute C# tests.",
    "url": "https://www.testmuai.com/support/docs/mstest-with-selenium-running-mstest-automation-scripts-on-testmu-selenium-grid/",
    "image": {
      "@type": "ImageObject",
      ...
      "step": [
        {
          ...
          "url": "https://www.testmuai.com/support/docs/mstest-with-selenium-running-mstest-automation-scripts-on-testmu-selenium-grid/#step-1-clone-the-sample-project"
        },
        {
          "@type": "HowToStep",
          "position": 2,
          ...
          "url": "https://www.testmuai.com/support/docs/mstest-with-selenium-running-mstest-automation-scripts-on-testmu-selenium-grid/#step-2-set-your-credentials"
        },
        {
          "@type": "HowToStep",
          "position": 3,
          ...
          "url": "https://www.testmuai.com/support/docs/mstest-with-selenium-running-mstest-automation-scripts-on-testmu-selenium-grid/#step-3-configure-your-test-capabilities"
        },
        {
          "@type": "HowToStep",
          "position": 4,
          "name": "Step 4: Run the Test",
          "text": "Execute the MSTest test from Visual Studio or the command line. In Visual Studio (Windows): Build the solution by clicking Build > Build Solution. Open Test Explorer in Visual Studio. Click Run from the Test Explorer to run the sample test. In Linux/macOS:",
