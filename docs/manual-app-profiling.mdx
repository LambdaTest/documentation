...
<img loading="lazy" src="/assets/images/mobile-testing-real-devices/sessions-4.png" alt="Enable Advance App Profiling toggle" className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src="/assets/images/mobile-testing-real-devices/sessions-5.png" alt="Start the profiling session" className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src="/assets/images/mobile-testing-real-devices/sessions-6.png" alt="Running profiling session" className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src="/assets/images/mobile-testing-real-devices/sessions-8.png" alt="Enable Network logs and Device logs when starting profiling" className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src="/assets/images/mobile-testing-real-devices/sessions-7.png" alt="Detailed profiling report view on the dashboard" className="doc_img" width="1366" height="629"/>
