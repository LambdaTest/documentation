...
title: Git & Branching in SmartUI
sidebar_label: Git & Branching
description: Learn how Git branching works in SmartUI visual regression testing — baseline branches, Smart Git dynamic branch comparison, and branch-level and build-level merging across the TestMu AI Automation Cloud.
keywords:
  - Visual Regression
      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "position": 3,
          "name": "Git & Branching",
          "item": `${BRAND_URL}/support/docs/smartui-git-branching-strategy/`
        }]
      })
    }}
></script>
...
:::caution Warning
This feature is supported for tests ran through <b>CLI</b> project type ([SDK](/support/docs/smartui-selenium-js-sdk/), [Static CLI](/support/docs/smartui-cli-complete-reference/), [Storybook](/support/docs/smart-ui-storybook/)) projects on the SmartUI platform. Please contact support@testmuai.com for further information or requests.
:::
