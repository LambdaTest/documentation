...
url: https://www.testmuai.com/support/docs/smartui-shadow-dom/
slug: smartui-shadow-dom/
canonical: https://www.testmuai.com/support/docs/smartui-shadow-dom/
      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "item": `${BRAND_URL}/support/docs/smartui-shadow-dom/`
        }]
      })
    }}
></script>
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/smartui-shadow-dom/"
    },
    "headline": "Shadow DOM",
    "description": "In this documentation, learn about about the shadow dom feature of smartui",
    "url": "https://www.testmuai.com/support/docs/smartui-shadow-dom/",
