...
canonical: https://www.testmuai.com/support/docs/pivotal-tracker-integration/
---
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/pivotal-tracker-integration/"
    },
    "headline": "TestMu AI Integration with Pivotal Tracker",
    "description": "TestMu AI provides integrations with Pivotal Tracker to help you log bugs directly from the middle of your test session on TestMu AI to your Pivotal Tracker.",
    "url": "https://www.testmuai.com/support/docs/pivotal-tracker-integration/",
    "image": {
      "@type": "ImageObject",
