---
id: rook-vscode
title: Use Rook in VS Code with GitHub Copilot
sidebar_label: VS Code
description: Set up the public Rook skill in VS Code with GitHub Copilot, verify discovery, test an AI agent safely, and review local and hosted evidence.
hide_title: false
slug: rook-vscode/
---
...
- [Public Rook skill](https://github.com/LambdaTest/rook/blob/main/skill-installer/skills/SKILL.md) and [VS Code with GitHub Copilot skill documentation](https://code.visualstudio.com/docs/agent-customization/agent-skills).
