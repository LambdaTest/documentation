...
title: How to Mask Sensitive Data in Selenium on TestMu AI
toc_max_heading_level: 2
hide_title: true
sidebar_label: "Mask Test Data"
description: Mask sensitive data in Selenium tests on TestMu AI to hide credentials and personal information from logs and network data.
keywords:
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/selenium-mask-your-data/"
    },
    "headline": "Mask Your Sensitive Data in Selenium Tests",
