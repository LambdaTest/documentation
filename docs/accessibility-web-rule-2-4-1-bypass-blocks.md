      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "item": `${BRAND_URL}/support/docs/accessibility-web-rule-2-4-1-bypass-blocks/`
        }]
      })
    }}
></script>
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/accessibility-web-rule-2-4-1-bypass-blocks/"
    },
    "headline": "Bypass Blocks (2.4.1)",
    "description": "Rule-level Accessibility guidance for Bypass Blocks (WCAG 2.4.1 Level A).",
    "url": "https://www.testmuai.com/support/docs/accessibility-web-rule-2-4-1-bypass-blocks/",
    "image": {
      "@type": "ImageObject",
