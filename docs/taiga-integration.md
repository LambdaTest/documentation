...
url: https://www.testmuai.com/support/docs/taiga-integration/
site_name: TestMu AI
slug: taiga-integration/
canonical: https://www.testmuai.com/support/docs/taiga-integration/
---
...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/taiga-integration/"
    },
    "headline": "Taiga Integration with TestMu AI",
    "description": "TestMu AI helps you manage your bugs in Taiga by moving them to your project in a single click. All the details you provide in TestMu AI like task list, assignee, title, and description would automatically be presented in the project on Taiga.",
    "url": "https://www.testmuai.com/support/docs/taiga-integration/",
    "image": {
      "@type": "ImageObject",
