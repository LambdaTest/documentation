---
id: rook-web-projects
title: Rook Web UI — Projects and First Sign-In
sidebar_label: Projects & First Sign-In
description: Sign in to the Rook Web UI, find a synchronized project, and resolve an empty project list.
slug: rook-web-projects/
canonical: https://www.testmuai.com/support/docs/rook-web-projects/
---
