...
<img loading="lazy" src="/assets/images/bigbucket-pipeline/1.webp" alt="Bitbucket Pipelines" width="1267" height="500" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/bigbucket-pipeline/2.webp" alt="Bitbucket Pipelines" width="1286" height="615" className="doc_img"/>

**Step 4:** After adding the environment variables, you need to visit your pipeline & click on **Rerun**.

<img loading="lazy" src="/assets/images/bigbucket-pipeline/3.webp" alt="Bitbucket Pipelines" width="1264" height="528" className="doc_img"/>
