...
**Step 1:** Log in to your <a href="https://www.testmuai.com/login/" onClick={CookieTrackingLogin}>LambdaTest account</a> and navigate to **Insights** from the left sidebar.
