...
| `--os-version <version>` | The device's OS version, for example `14` or `17.5`. On its own, it matches any device running that version | Config value |
