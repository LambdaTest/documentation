...
<a href="https://github.com/LambdaTest/angular-karma-sample" className="github__anchor" target="_blank"><img loading="lazy" src="/assets/images/icons/github.png" alt="Image" className="doc_img"/> View on GitHub</a>
</div>
</Tip>
