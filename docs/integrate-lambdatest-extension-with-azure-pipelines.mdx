...
1.  Go to [Azure DevOps marketplace](https://marketplace.visualstudio.com/) and search for "<BrandName />" in the search box.
    ...
    <img loading="lazy" src="/assets/images/uploads/M1.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>

2.  In the results window, you will see an option showing the <BrandName /> Extension. <img loading="lazy" src="/assets/images/uploads/m2.webp" alt="azure pipeline"  className="doc_img"/>

3.  Open the found result and click on "Get it free", to get the <BrandName /> Extension in your organization for free.

    <img loading="lazy" src="/assets/images/uploads/m3.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>

4.  Select an Azure DevOps organization and press "Install". <BrandName /> Extension will be installed in this organization.

    <img loading="lazy" src="/assets/images/uploads/LT-import-3.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>
...
5.  Once finished, you can see "Done" at the top. It means that <BrandName /> Extension has been installed successfully. You can proceed to your organization to see the extension.
    ...
    <img loading="lazy" src="/assets/images/uploads/LT-import-4.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>
...
**Step 2:** Create a project and download the <BrandName /> extension from the [Azure marketplace](https://marketplace.visualstudio.com/search?term=lambdatest&target=AzureDevOps&category=All%20categories&sortBy=Relevance) as shown above. <img loading="lazy" src="/assets/images/uploads/m4.webp" alt="azure pipeline"  className="doc_img"/>

**Step 3:** In order to use the <BrandName /> extension now, select **Pipelines** from the left side menu bar as shown below:

<img loading="lazy" src="/assets/images/uploads/Step-1.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>

**Step 4:** Select **New Pipelines** from the top right corner of your screen.

<img loading="lazy" src="/assets/images/uploads/Step-2.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>

**Step 5:** Switch to Class Editor from the footer.

<img loading="lazy" src="/assets/images/uploads/Step-3.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/uploads/Step-4.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>

**Step 7:** Select the template as **Empty Job** to begin with. We will create the job as we go.

<img loading="lazy" src="/assets/images/uploads/Step-5.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>

**Step 8:** Add a new task in the job with the help of **+** button, and fill the required details. 

<img loading="lazy" src="/assets/images/uploads/Step-6.webp" alt="azure pipeline"  className="doc_img"/> For this demo purpose, we have used following tasks:
...
<img loading="lazy" src="/assets/images/uploads/search-lambdatest.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>

*   Similarly, add **Command Line Script** and **Python Script** in to this job.
*   Once added, arrange the tasks in below shown order: 

<img loading="lazy" src="/assets/images/uploads/arrange.webp" alt="azure pipeline"  className="doc_img"/>

**Step 9:** Click on **<BrandName /> Configuration Setup** and then click on **New**.

<img loading="lazy" src="/assets/images/uploads/configuration-setup.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>
...
* Enter the desired Service connection name in the Details section and then click Verify and Save button.
    ...
    <img loading="lazy" src="/assets/images/uploads/verify-save.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/uploads/pip.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>

**Step 12:** Select **Run a Python script** as we have selected Python in the above steps.

<img loading="lazy" src="/assets/images/uploads/python.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/uploads/save-queue.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>

**Step 14:** Select OS from Agent Specification as shown below and click "Save and Run".

<img loading="lazy" src="/assets/images/uploads/Step-14.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>

**Step 15:** The pipeline will get activated and you can see your job queued to be executed.

<img loading="lazy" src="/assets/images/uploads/test-ran.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/> 

**Step 16:** To view the test results, click on the Return option.

<img loading="lazy" src="/assets/images/uploads/return.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>

**Step 17:** Click the **<BrandName />** tab.

<img loading="lazy" src="/assets/images/uploads/tab.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>

You'll find your executed tests results.

<img loading="lazy" src="/assets/images/uploads/results.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/uploads/Step-17.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/uploads/LT-ext-4-1024x528.webp" alt="azure pipeline" width="768" height="345" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/azure-devops-integration/assistant.png" alt="azure pipeline" width="768" height="345" className="doc_img"/>

Click on the ```show assistant``` button and search for lambdatest extension tasks and add them in you pipeline YAML.
<img loading="lazy" src="/assets/images/azure-devops-integration/assistantSearch.png" alt="azure pipeline" width="768" height="345" className="doc_img"/>
