...
canonical: https://www.testmuai.com/support/docs/getting-started-with-desktop-browser-real-time-testing/
---
      ...
      dangerouslySetInnerHTML={{ __html: JSON.stringify({
       "@context": "https://schema.org",
        ...
        "itemListElement": [{
          ...
          "item": `${BRAND_URL}/support/docs/getting-started-with-desktop-browser-real-time-testing/`
        }]
      })
    }}
></script>
