...
<script type="application/ld+json"
  dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.testmuai.com/support/docs/smartui-puppeteer-sdk/"
    },
    "headline": "Integrate SmartUI SDK with Puppeteer Tests",
    "description": "In this documentation, learn how integrate your Puppeteer JavaScript automated tests with TestMu AI's SmartUI.",
    "url": "https://www.testmuai.com/support/docs/smartui-puppeteer-sdk/",
    "image": {
      "@type": "ImageObject",
    ...
    "dependencies": "Basic understanding of Command Line Interface and Puppeteer is required.; Login to TestMu AI SmartUI with your credentials..",
    "author": {
      "@type": "Organization",
    ...
    "hasPart": [
      {
        ...
        "codeRepository": "https://github.com/LambdaTest/smartui-puppeteer-sample",
        "text": "git clone https://github.com/LambdaTest/smartui-puppeteer-sample\ncd smartui-puppeteer-sample/sdk"
      },
      {
        "@type": "SoftwareSourceCode",
        ...
        "codeSampleType": "code snippet",
        "programmingLanguage": "Shell",
        "text": "npm install @lambdatest/smartui-cli @lambdatest/puppeteer-driver puppeteer"
      },
      {
        "@type": "SoftwareSourceCode",
      ...
      },
      {
        ...
        "codeSampleType": "code snippet",
        "programmingLanguage": "Shell",
        "text": "npx smartui exec node puppeteerCloud.js --config .smartui.json"
      },
      {
        "@type": "SoftwareSourceCode",
      ...
      },
      {
        ...
        "codeSampleType": "code snippet",
        "programmingLanguage": "Shell",
        "text": "   npm view @lambdatest/puppeteer-driver version\n   npm view @lambdatest/smartui-cli version"
      },
      {
        "@type": "SoftwareSourceCode",
      ...
      "step": [
        {
          ...
          "position": 1,
          "name": "Step 1: Create/Update your test",
          "text": "You can clone the sample repository to run LambdaTest automation tests with SmartUI and use the puppeteerCloud.js file present in the sdk folder.",
          "url": "https://www.testmuai.com/support/docs/smartui-puppeteer-sdk/#step-1-createupdate-your-test"
        },
        {
          "@type": "HowToStep",
          "position": 2,
          "name": "Step 2: Install the Dependencies",
          "text": "Install required NPM modules for TestMu AI SmartUI Puppeteer SDK in your Frontend project. If you face any problems executing tests with SmartUI-CLI versions >= v4.x.x, upgrade your Node.js version to v20.3 or above.",
          "url": "https://www.testmuai.com/support/docs/smartui-puppeteer-sdk/#step-2-install-the-dependencies"
        },
        {
          "@type": "HowToStep",
          "position": 3,
          ...
          "url": "https://www.testmuai.com/support/docs/smartui-puppeteer-sdk/#step-3-configure-your-project-token"
        },
        {
          "@type": "HowToStep",
          "position": 4,
          ...
          "url": "https://www.testmuai.com/support/docs/smartui-puppeteer-sdk/#step-4-create-and-configure-smartui-config"
        },
        {
          "@type": "HowToStep",
          "position": 5,
          "name": "Step 5: Adding SmartUI function to take screenshot",
          "text": "You can incorporate SmartUI into your custom Puppeteer automation test (any platform) script by adding the smartuiSnapshot function in the required segment of Puppeteer script of which we would like to take the screenshot, as shown below:",
          "url": "https://www.testmuai.com/support/docs/smartui-puppeteer-sdk/#step-5-adding-smartui-function-to-take-screenshot"
        },
        {
          "@type": "HowToStep",
          "position": 6,
          ...
          "url": "https://www.testmuai.com/support/docs/smartui-puppeteer-sdk/#step-6-execute-the-tests-on-smartui-cloud"
        }
      ]
    }
  ]) }}
