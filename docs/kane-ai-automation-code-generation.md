...
When code is in the **Unverified** state, the following actions are available:
...
- **Create PR** — Exports the generated code to your connected GitHub or GitLab repository as a pull request.
- **Download** — Downloads the generated code to your local machine.

:::note
When code is Unverified, you will see the message: _"Code is not verified after recent changes. Run sample execution to verify the code."_
:::
...
- Code generation has not been started.
