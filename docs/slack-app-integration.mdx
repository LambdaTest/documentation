...
*To perform the Real-time testing and Screenshot testing, you will need to login with your <BrandName /> Account. If you don’t have an account on <BrandName />, visit the <a href="https://www.testmuai.com/register/"><BrandName /> register page</a>.*
...
<img loading="lazy" src="/assets/images/slack-app-integration/select-slack.webp" alt="Slack App"  width="1362" height="725" className="doc_img"/>

3. You'll be redirect to OAuth page. Enter the Slack channel on which you wish to receive Slack alert notifications.

<img loading="lazy" src="/assets/images/slack-app-integration/oauth-channel.webp" alt="Slack App"  width="1362" height="725" className="doc_img"/>

4. Click on **Allow**.

<img loading="lazy" src="/assets/images/slack-app-integration/oauth-integration.webp" alt="Slack App"  width="1362" height="725" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/slack-app-integration/browse-apps.webp" alt="Slack App"  width="1362" height="725" className="doc_img"/>

**Step 3**: Search for <BrandName /> and then click on the <BrandName /> block.

<img loading="lazy" src="/assets/images/slack-app-integration/search-lambdatest.webp" alt="Slack App" width="1366" height="724" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/slack-app-integration/run-realtimetest.webp" alt="Slack App" width="1360" height="722" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/slack-app-integration/provide-realtimetest-details.webp" alt="Slack App" width="1353" height="721" className="doc_img"/>

**Step 3**: After entering the test environment details, click on **Submit**.

<img loading="lazy" src="/assets/images/slack-app-integration/submit-realtimetest.webp" alt="Slack App" width="1349" height="679" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/slack-app-integration/run-test1.webp" alt="Slack App" width="1366" height="724" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/slack-app-integration/realtime-vm.webp" alt="Slack App" width="1263" height="621" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/slack-app-integration/added-app1.webp" alt="Slack App" width="1366" height="721" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/slack-app-integration/selectscreenshot-config.webp" alt="Slack App" width="1366" height="724" className="doc_img"/>

*You can save your favorite browser-OS combinations as a list from the <BrandName /> Screenshot console page.*

**Step 3**: Click on **Submit**.

<img loading="lazy" src="/assets/images/slack-app-integration/submit-screenshot.webp" alt="Slack App" width="1366" height="724" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/slack-app-integration/view-screenshot.webp" alt="Slack App" width="1263" height="621" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/slack-app-integration/captured-screenshot.webp" alt="Slack App" width="1263" height="621" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/slack-app-integration/remove-app.webp" alt="Slack App" width="1360" height="719" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/slack-app-integration/remove-2.webp" alt="Slack App" width="1360" height="721"  className="doc_img"/>
