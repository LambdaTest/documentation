...
#### 7. **Can I use HyperExecute to run test cases on Microsoft Excel?**
  ...
  Yes, you can configure HyperExecute to run your Microsoft Excel test cases. However, this feature is only available on request at this moment. Visit [our documentation](/support/docs/hyperexecute-winapp-integration/) for this feature or contact support@testmu.ai to know more.
