module.exports = {
  ...
  KaneAISidebar: [
    ...
    [
      ...
      // 2. Author Tests
      {
        ...
        label: "Author Tests",
        items: [
          { type: "doc", id: "kaneai-authoring-session", label: "Authoring Session" },
      ...
      // 6. Reference
      {
        ...
        items: [
          ...
          { type: "doc", id: "kaneai-faqs", label: "FAQs" },
        ],
      },
    ],
  ],
  ...
  TestManagerSidebar: [
    ...
    [
      ...
      {
        type: "category",
        label: "Create Test Runs",
        className: "menu-bold",
        collapsed: true,
        items: [
          { type: "doc", id: "test-run-creation-and-management", label: "Create and Manage Test Runs" },
          { type: "doc", id: "track-issues-in-test-runs", label: "Track Issues in Test Runs" },
          { type: "doc", id: "sync-test-instance", label: "Sync Test Instance" },
  ...
  AppiumTestingSidebar: [
    ...
    [
          ...
          },
          {
            ...
            collapsed: true,
            label: "References",
            items: ["migrate-appium-tests-from-browserstack-and-saucelabs", "appium-troubleshooting"],
          },
    ],
  ],
    ...
    [
...

      {
        ...
        items: [
          ...
          { type: "doc", label: "Weekly Report Email", id: "smartui-weekly-report-email" },
