      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            label: "Web UI",
            collapsed: true,
            link: { type: "doc", id: "rook-web-ui" },
            items: [
              { type: "doc", label: "Projects & First Sign-In", id: "rook-web-projects" },
              { type: "doc", label: "Agents", id: "rook-web-agents" },
              { type: "doc", label: "Agent Summary", id: "rook-web-agent-summary" },
              { type: "doc", label: "Versions & Call Graph", id: "rook-web-versions" },
              { type: "doc", label: "Features", id: "rook-web-features" },
              { type: "doc", label: "Scenarios & Filters", id: "rook-web-scenarios" },
              { type: "doc", label: "Scenario Details", id: "rook-web-scenario-details" },
              { type: "doc", label: "Runs", id: "rook-web-runs" },
              { type: "doc", label: "Run Details & Plan", id: "rook-web-run-details" },
              { type: "doc", label: "Results & Artefacts", id: "rook-web-result-details" },
              { type: "doc", label: "Insights", id: "rook-web-insights" },
            ],
          },
          {
            type: "category",
  ...
  SeleniumTestingSidebar: [
    ...
    [
      ...
      type: "category",
        ...
        label: "Get Started",
        items: [
          { type: "doc", id: "getting-started-with-lambdatest-automation", label: "Overview" },
