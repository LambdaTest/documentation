...
export default function HelpFulArticle() {
    const thumbsUpLight = "https://www.testmuai.com/support/img/thumbsUp_light.svg";
    const thumbsUpDark = "https://www.testmuai.com/support/img/thumbsUp_dark.svg";
    const thumbsDownLight = "https://www.testmuai.com/support/img/thumbsDown_light.svg";
    const thumbsDownDark = "https://www.testmuai.com/support/img/thumbsDown_dark.svg";
    return (
        <HelpFulArticleClass 
            ...
            <div className="feedback__box">
                <div className="support_container">
                    ...
                    {!feedbackSubmitted && !isContactFormSubmitted ? (
                        ...
                        <a role="button" tabIndex="0" href="https://community.lambdatest.com/" target="_blank" className="chat_btn"><img loading="lazy" src="https://www.testmuai.com/support/img/community.svg" alt=" " role="presentation" title='Chat with Us' className='' width="16" height="16" />Ask the Community</a>
