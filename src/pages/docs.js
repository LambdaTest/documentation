        ...
        <div className="primary_main">
          <div className="container">
            ...
            <div className="home_main">
              ...
              <div className="home_inners_box">
                <h2 className="homeMain_h2"><Icon light="Realtime-light-icon.svg" dark="Realtime-dark-icon.svg" alt="" />Agent Assurance Platform</h2>
                <div className="home_inners">
                  <a href="/support/docs/getting-started-with-agent-testing-platform/">
                    <p className="p_home_inners">Conversational Agent Testing</p>
                  </a>

                  <a href="/support/docs/agent-assurance-overview/">
                    <p className="p_home_inners">Autonomous Agent Testing &nbsp;<NewTag value="NEW" /></p>
                  </a>

                  <a href="/support/docs/testing-your-first-ai-agent/">
                    <p className="p_home_inners">Conversational Quickstart</p>
                  </a>

                  <a href="/support/docs/agent-assurance-quickstart/">
                    <p className="p_home_inners">Rook Quickstart</p>
                  </a>

                  <a href="/support/docs/rook-architecture/">
                    <p className="p_home_inners">Rook Architecture</p>
                  </a>

                  <a href="/support/docs/rook-profiles-and-hooks/">
                    <p className="p_home_inners">Profiles, Phases & Hooks</p>
                  </a>

                  <a href="/support/docs/agent-assurance-command-reference/">
                    <p className="p_home_inners">Rook Command Reference</p>
                  </a>

                  <a href="/support/docs/agent-testing-platform-faqs/">
                    <p className="p_home_inners">Frequently Asked Questions</p>
                  </a>
                </div>
              </div>
              <div className="home_inners_box">
