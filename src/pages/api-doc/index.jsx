...
function ApiDoc() {
    ...
    return (
        <>
            {/* Helmet to remove link[rel="alternate"] from SSR side */}
            <Helmet>
                <link rel="alternate" href="" hrefLang="" />
                {/* Add additional Helmet config to ensure link tags are properly removed */}
                <script>
                    {`
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            console.log("SSR-side: Alternate links removed");
                        });
                    `}
                </script>
            </Helmet>
            ...
            <Layout title="LambdaTest API Documentation"
                ...
                <div className="lambda-api">
                    <Tabs groupId="key" queryString>
                        ...
                        <TabItem value="performanceTesting" label="Performance Testing">
                            <iframe className="embed-responsive-item"
                                src="https://stage-swagger-api-support.lambdatestinternal.com/performance_testing/index.html"></iframe>
                        </TabItem>
                    </Tabs>
                </div>
            </Layout>
