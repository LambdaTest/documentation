    ...
    <>
      ...
      <div className="Doc_bottom_Cta">
        <div className="Doc_cta">
          ...
          <img loading="lazy" src="https://assets.testmu.ai/resources/images/DocBottomImg.png" alt="Book Demo" title="Book Demo" width="887" height="477" className='left_sec no-zoom'></img>
        </div>
      </div>
