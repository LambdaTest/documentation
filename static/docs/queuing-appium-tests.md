...
For example, if your TestMu AI account enables 10 concurrent sessions, your queue can hold a maximum of (10 + 150) queued test cases, or 160 queued test cases. TestMu AI will handle the scheduling and parallel execution of Appium test cases in your queue.
...
>
Here are some key points to keep in mind while running Appium automated tests on TestMu AI platform.
1. As mentioned above, the number of tests that can be queued for a single instance is limited. This limit is determined by the amount of concurrent TestMu AI sessions, and exceeding your maximum queuing capacity will result in the test cases being discarded.
...
> That's all about queuing your Appium tests. If you still have any questions for us, please feel free to let us know. Our experts are always **available on chat** to help you out with any roadblock regarding our product.
