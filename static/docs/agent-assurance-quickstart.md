...
For production, use ROOK_ENV=prod; rook ui opens [rook.testmuai.com](https://rook.testmuai.com). Stage and production are separate environments. Selecting stage for Rook does **not** change your target agent's endpoint.
