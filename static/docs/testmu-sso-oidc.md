...
- **TestMu AI Enterprise Plan**: An active TestMu AI organization subscription
- **Administrative Access**: Admin-level access to your TestMu AI organization
- **SSO Request**: Contact TestMu AI support to enable SSO for your organization

> **Note**: If you don't have SSO enabled for your TestMu AI organization, please contact our support team at [support@testmuai.com](mailto:support@testmuai.com)
.
...
2. **Copy Client ID**:
   - Note down the **Client ID** (also called Application ID in Azure AD) - you'll need this for TestMu AI configuration
...
2. **Create New Client Secret**:
   ...
   - **Description**: Enter a descriptive name like "TestMu AI SSO Secret"
...
### Step 6: Contact TestMu AI Support for OIDC Configuration

Since OIDC integration requires server-side configuration, you cannot create the connection directly through the TestMu AI interface. Instead, you need to contact our support team to configure the OIDC integration for you.
...
1. **Gather Required Information**: Collect the following details from your identity provider configuration:
   ...
   - **Connection Name**: A descriptive name like "Company OIDC" or "TestMu AI SSO"

2. **Contact TestMu AI Support**: Reach out to our support team with the configuration details:
...
2. **Assign Users**:
   ...
   - Select the users or groups who should have access to TestMu AI
   - Click **Assign**
...
1. **Access TestMu AI SSO**: Navigate to [https://accounts.lambdatest.com/sso](https://accounts.lambdatest.com/sso)
...
- **Solution**: Verify that the redirect URI in Azure AD exactly matches the one provided by TestMu AI
...
- **Issue**: Users from different domains cannot access TestMu AI
- **Solution**: Ensure all required domains are configured in both Azure AD and TestMu AI settings
