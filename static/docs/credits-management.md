...
Credits are granted by TestMu AI's billing systems on your behalf — when a payment succeeds, a trial starts, a plan renews, or a complimentary grant is issued. They arrive in **dated batches**, and each batch carries its own source and, where one applies, its own expiry date.
...
| **Complimentary credits** | Complimentary | Goodwill, welcome or promotional credits issued by TestMu AI |

**The list of credit types is not fixed**
If TestMu AI issues credits under a new label, that label appears on your balance page as its own group — a new kind of credit is never hidden from you. Your credit history additionally shows **Usage** lines for what you spent.
...
Expiry alerts are **off by default**. Turn them on and TestMu AI emails your admins **7 days before** credits are due to expire, stating how many credits will lapse and the earliest date any of them lapses.
