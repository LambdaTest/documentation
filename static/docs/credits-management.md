...
Alert emails go to the admins in your TestMu AI organization. Add anyone else under **Manage Recipients** with **Add Recipients**; the table lists each recipient with their email and role.
