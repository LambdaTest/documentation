# Test Execution Setup For Running Puppeteer Tests
...
The TestMu AI Capability Generator can auto-create the capabilities class for your Puppeteer scripts. The full set of capabilities you can configure:
