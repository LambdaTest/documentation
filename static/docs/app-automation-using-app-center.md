...
The download_url (For e.g. `https://appcenter-filemanagement-distrib3ede6f06e.azureedge.net/de-25205f705e63/Wikipedia_v2.7.5393-r-2022-02-10_am.apk?sv=2019-&s ig=i170%2FkTlpX%3D&se=202Z&sp=r`) from the above API response will be used to upload your App Release on TestMu AI.
...
Using the `app_url` obtained in the response, you can execute your Appium tests on TestMu AI.
