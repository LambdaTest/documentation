...
**Step 1:** You can login or create your free TestMu AI account here.
...
* Run the following command with your **TestMu AI Username** and **AccessKey**. (as noted in step 4.1 above)
