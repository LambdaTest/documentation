...
**Step 2:** Click on the **Virtual Mobile** option in **Web Browser Testing** section.
**Step 3:** Select the **ChromeOS** option, and enter your URL in the space provided. (We are using the TestMu AI website for the demo purpose)
