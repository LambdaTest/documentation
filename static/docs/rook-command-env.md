...
This topic is now part of a consolidated guide. Read [agent-assurance-command-reference](https://www.testmuai.com/support/docs/agent-assurance-command-reference/#env).
