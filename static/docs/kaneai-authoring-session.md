# Authoring Session States, Cursor, and Running Steps in KaneAI
...
1. You type `click profile` and press Enter. It becomes the new step 4, and the original step 4 becomes step 5. The cursor advances to sit just after the new step.
2. You type `click logout` and press Enter. It becomes step 5, and the cursor advances again.
