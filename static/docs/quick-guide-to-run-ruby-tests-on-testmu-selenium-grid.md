...
The first thing to note in this code is the use of remote webdriver. To access TestMu AI grid, you would have to invoke remote webdriver instead of local webdrivers. In addition, the browser enthronement details are passed on through desired_capabilities.
