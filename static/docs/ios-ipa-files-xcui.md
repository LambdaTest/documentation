...
You can use the generated .ipa file for testing on the **TestMu AI** Platform.
...
Match the iOS version of your app and test runner **iOS Deployment Target**. If they don't match up, the tests will run locally, but won't be able to run on TestMu AI Real Devices.
