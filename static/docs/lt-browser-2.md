...
Download LT Browser 2.0 For Windows

Download LT Browser 2.0 For macOS
...
When you click the Mark as Bug, you'll be presented with a list of TestMu AI integrations. If your favorite integration isn't presented, then you can click **More Integrations** to view all available TestMu AI integrations.
...
Following screenshot shows TestMu AI web-application that is captured after logging in from the TestMu AI website.
