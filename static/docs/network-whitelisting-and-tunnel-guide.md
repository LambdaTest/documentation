...
- By whitelisting TestMu AI’s shared public IPs, your QA team can test directly on the cloud grid.

> Refer to [TestMu AI Public IP](/support/docs/testmu-public-ip/) for list for the IP addresses.
...
- You need to ensure your employees’ browsers and TestMu AI integrations can connect to the platform.
