...
**Step 7:** Provide your TestMu AI authentication credentials in the **Environment Variables** and hit the **"Save and go to Dashboard"** button.

That is it! Now, any changes you commit in your GitHub repository will trigger the build in Codeship and run your test on TestMu AI Selenium Grid.
...
The below example of **pipelinecommand** would demonstrate you to leverage TestMu AI Selenium Grid by performing cross browser testing through the test server contained in your Codeship build.
...
The setup command will be the same as mentioned earlier under the "Integration With Codeship" section. After then commit any changes into the repository and get your test run using TestMu AI Tunnel.
...
Now, any changes commit in your repository will trigger a build and run automation tests in parallel on TestMu AI Selenium Grid.
...
Reliably deploy your code at scale using Codeship integration with TestMu AI, and ensure it looks robust across every browser to provide a seamless user experience to all your visitors. Happy Testing!
