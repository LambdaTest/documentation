...
If your app blocks screenshots and you want to author tests without that hindrance, use this capability. It disables the screenshot block check added in the application so you can author test cases in TestMu AI.
...
Camera image injection lets you author tests with **image capturing, QR code scanning**, and **barcode scanning** functionality in your app across **real devices** on TestMu AI.
...
Video injection lets you test video-based functionality such as **live streaming, real-time video capture,** and **video processing** in your app across **real devices** on TestMu AI.
