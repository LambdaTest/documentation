...
## Integrating Zoho Cliq With TestMu AI
...
**Step 5:** Click the **Accept** button to allow TestMu AI to access data in your Zoho Account.

**Step 6:** You will be redirected back to the TestMu AI dashboard. Select the **Zoho Cliq Channel** from the dropdown. In this case, we will select the **#announcements** channel and click **Confirm Channel**.

You have now successfully integrated TestMu AI with Zoho Cliq.
...
**Step 4:** After marking the bugs, click on the **Bug icon** in front of TestMu AI under the integrations section.
...
**Step 6:** Head to **More Tools** in the TestMu AI dashboard and click on **Issue Tracker**. You'll notice the marked bugs along with the test details.
...
> That was all you need to know for TestMu AI + Zoho Cliq Integration. Increase your productivity with our integrations. If you still have any questions for us, please feel free to let us know. Our experts are always available on **chat** to help you out with any roadblock regarding our product. Happy testing!
