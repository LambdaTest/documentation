...
You can run Puppeteer testing of locally hosted websites and web apps via TestMu AI tunnel binary.
...
3. In order to run your Puppeteer tests, you will need to set your TestMu AI username and access key in the environment variables.
...
4. To establish a tunnel connection between your local device and TestMu AI, download the binary file based on your OS.
