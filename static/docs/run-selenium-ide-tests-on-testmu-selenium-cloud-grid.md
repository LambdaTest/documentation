...
In this document, we will see how to run Selenium IDE tests on TestMu AI cloud [Selenium Grid](https://www.testmuai.com/blog/why-selenium-grid-is-ideal-for-automated-browser-testing/).
