...
- Expanded migration capabilities for easier transition to TestMu AI platform
...
3. **Replace credentials** with your TestMu AI username and access key
4. **Verify connection** by asking your AI assistant to list available MCP tools
5. **Start using** TestMu AI tools directly within your AI assistant
