...
TestMu AI tunnel feature allows you to test your private server URLs or locally hosted web-apps or websites through TestMu AI cloud servers. Through our secure shell tunneling features, you can also test plain HTML, CSS, PHP, Python or other similar web files saved on your local system, on combinations of operating systems, browsers, and screen resolutions that are available on TestMu AI.
...
**Step 1:** If you want to test the local folders and files stored in your system, pass an additional argument ‘dir’ with the directory/folder in double quotes name as you run the command on the terminal to establish a TCP with TLS 1.2 connection with TestMu AI tunnel.
...
Access Key is pivotal for establishing a TCP with TLS 1.2 connection through TestMu AI tunnel to test your locally hosted web-pages or web-apps.
