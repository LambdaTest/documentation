...
Keep your TestMu AI login, access key, and HubURL handy for authentication purposes. They must be configured as environment variables. You can find them on your TestMu AI automation dashboard by clicking on the key symbol next to the help button.
