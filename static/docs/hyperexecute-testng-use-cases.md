# HyperExecute Language-Specific Use Cases
...
\n  <\/test>\n<\/suite>"
      ...
      },
      {
        ...
        "codeSampleType": "code snippet",
        "programmingLanguage": "Shell",
        "text": "./hyperexecute -u  -k  -i  --vars \"abcd=Folder\""
      },
      {
        "@type": "SoftwareSourceCode",
      ...
      },
      {
        ...
        "codeSampleType": "code snippet",
        "programmingLanguage": "Shell",
        "text": "AUTH_HEADER=\"Basic your_encoded_auth_string\" lambdatest-screenshot-pdf  --output "
      },
      {
        "@type": "SoftwareSourceCode",
        "name": "16. Automating Screenshot Download and PDF Generation from TestMu AI",
...
### 16. Automating Screenshot Download and PDF Generation from TestMu AI
...
- Ensure your AUTH_HEADER is a valid Base64-encoded API key from TestMu AI.
