...
Below is the step by step guide to help you integrate TestMu AI with your TestingWhiz app.
...
2.  Go to Cloud Execution menu from the left bar, and you will find **TestMu AI** there.
3.  Now you need to provide access of your TestMu AI account to your TestingWhiz app. To do so, click on **Add** button.
...
That's it. Your TestingWhiz account has been integrated successfully with your TestMu AI account.

## Running First Test From Your TestingWhiz App On Your TestMu AI Account
