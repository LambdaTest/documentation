...
Agent Assurance uses the rook CLI for authoring and execution, with a hosted [Web UI](/support/docs/rook-web-ui/) for reviewing shared results. Give it the materials that describe the agent and connect a live test target. It can then:
