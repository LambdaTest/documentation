...
Download or Clone the code sample for the XCUI framework from the TestMu AI GitHub repository to run the tests on the HyperExecute.
...
Enter your `` and `` in the YAML file
