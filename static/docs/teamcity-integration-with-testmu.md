...
> Clone our [GitHub repository for TeamCity](https://github.com/LambdaTest/protractor-selenium-teamcity-sample.git) to execute your first parallel test of TeamCity + TestMu AI Integration.
...
The above command will trigger the execution of below code for performing parallel testing at TestMu AI Selenium Grid.
...
Kudos! Now you can Deploy your code in a reliable manner at scale using TeamCity integration with TestMu AI, and ensure it looks robust across every browser to provide a seamless user experience to all your visitors. Happy Testing! 🙂
