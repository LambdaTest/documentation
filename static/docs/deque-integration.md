...
2. The TestMu AI Service, which you probably have in your project.

```js
"@wdio/lambdatest-service"
```

3. The next step will be to ensure that our TestMu AI configuration file contains the desired browser configurations and TestMu AI Username and Access Key.
