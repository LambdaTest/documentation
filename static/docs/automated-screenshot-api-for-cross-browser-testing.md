...
This document will help you leverage TestMu AI [Automated Screenshot](https://www.testmuai.com/automated-screenshot). You would learn how to:
...
To get a list of all the available **screen  resolutions** provided by TestMu AI for you to perform cross browser testing, you would need to execute the below **GET** request. The GET request will help you extract the respective response from our cloud servers in a JSON format.
