...
Build Solution. Open Test Explorer in Visual Studio. Click Run from the Test Explorer to run the sample test. To run parallel tests, click Run All in Test Explorer.",
