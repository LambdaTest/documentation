...
Build options let you group screenshots into builds, mark a build as a baseline, and track build status across your testing suite. Using the TestMu AI platform, perform regression testing in just one click and explore various possible solutions for grouping your screenshots into different builds and map as per your testing suite needs.
