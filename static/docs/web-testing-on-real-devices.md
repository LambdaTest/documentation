...
This documentation covers how to perform web testing across real Android and iOS devices on the TestMu AI platform.

>**Note**: Currently Web testing on real devices is in the Beta phase. To access this feature, contact TestMu AI Support.
...
1. Sign into your TestMu AI account. From the left menu, navigate to Real Time Testing and click **Browser Testing** tab.
