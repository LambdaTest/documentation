...
1. **Active TestMu AI Account**: You should have an active TestMu AI account with appropriate permissions.
...
5. **Access to Insights**: You should have access to the TestMu AI Insights platform under **Insights** tab.

## RCA Generation Methods

TestMu AI offers two methods to generate Root Cause Analysis:
...
1. Navigate to **Organization Settings** in your TestMu AI dashboard
