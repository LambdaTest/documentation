# Creating your first Dashboard using TestMu AI Analytics
...
- Should be logged in to the  TestMu AI application using your credentials. If account is not created, please create an new account here.
