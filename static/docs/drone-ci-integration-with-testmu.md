...
In order to perform your tests with TestMu AI, you would need the below things to be already set up:

1. You need to get a VPN setup from TestMu AI as Drone is not publicly accessible. Please contact our customer support or mail us at support@testmuai.com.
