...
> Grids button. Click on Add New Grid button >> select TestMu AI as your Grid Type and click on Next button. Configure your Grid: Enter the name of your Grid. Update your Host and Port number. Enter your TestMu AI Username and Access Key >> click on Add button.",
