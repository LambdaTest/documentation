...
To initiate the VPN setup process, please gather the following details from your Network/Security team and share them with TestMu AI support at **support@testmu.ai**.
...
| Field | Description | Example |
|-------|-------------|---------|
| **Internal Subnets to Expose** | The private subnets (in CIDR format) that TestMu AI test nodes need to reach. List one per line | 10.10.1.0/24, 192.168.5.0/24 |
...
| Tunnel Up, No Traffic | Missing Route | Add route for TestMu AI subnet via tunnel interface |
