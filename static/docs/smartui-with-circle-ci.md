...
This guide explains how to integrate your project with the CircleCI CI/CD pipeline to trigger visual regression testing with TestMu AI SmartUI whenever changes are made to your repository.
