...
keywords: ["smart ui testing in lambdatest", "smart ui testing in hyperexecute", "visual  ui testing,image to image comparison", "perform visual ui testing online", "compare image to image", "playwright parallel tests", "parallel testing with playwright"]
---
...
![automation-dashboard](/assets/images/hyperexecute/integration/lt-products/smart-ui-sdk/playwright.png)