...
![Image](/assets/images/algoshack-integration/access_key.png)
...
![Image](/assets/images/algoshack-integration/remote.png)
...
![Image](/assets/images/algoshack-integration/caps.png)
4. Visit algoQA platform to generate Selenium scripts in Java.

![Image](/assets/images/algoshack-integration/algo_shack.png)

5. After generating the Selenium Java scripts, open algoQA scripts and go to the directory `src/test/java`.

![Image](/assets/images/algoshack-integration/src_directory.png)
...
![Image](/assets/images/algoshack-integration/env_params.png)
...
![Image](/assets/images/algoshack-integration/cmd.png)
