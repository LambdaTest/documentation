...
<img loading="lazy" src='/assets/images/hyperexecute/knowledge-base/widgets/task-trends.png' alt="job-trends" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/knowledge-base/widgets/task-summary.png' alt="job-trends" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/knowledge-base/widgets/task-status-ratio.png' alt="job-trends" className="doc_img"/>