...
<img loading="lazy" src='/assets/images/hyperexecute/knowledge-base/widgets/job-trends.png' alt="job-trends" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/knowledge-base/widgets/job-summary.png' alt="job-trends" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/knowledge-base/widgets/job-queue-time.png' alt="job-trends" className="doc_img"/>