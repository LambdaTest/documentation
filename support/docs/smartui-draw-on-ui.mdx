...
<iframe
  ...
  src="https://app.storylane.io/demo/j5uyv2ol9axz?embed=inline"
...
![Annotations icon](/assets/images/smart-visual-testing/annotation-tool/annotationsicon.png)
...
Start with **Ignore Region** for simple dynamic content like timestamps or notification counters. It's the most straightforward annotation type.
</Tip>
...
![Ignore region annotation](/assets/images/smart-visual-testing/annotation-tool/ignore_region.png)

**Step 3:** Select **Ignore Region** from the annotation type dropdown and click **Save**.

![Apply annotation modal](/assets/images/smart-visual-testing/annotation-tool/applyannotationmodal.png)
...
![Result of ignore region](/assets/images/smart-visual-testing/annotation-tool/resultofignoreregion.png)
...
You can define multiple select regions. All selected regions will be compared, and everything outside these regions will be ignored.
</Note>
...
![Floating region annotation](/assets/images/smart-visual-testing/annotation-tool/floating_region.png)
...
![Result of floating region](/assets/images/smart-visual-testing/annotation-tool/resultoffloatingregion.png)

<Tip>
TIP

Make the blue region large enough to encompass all possible positions of the element, and keep the yellow region focused on the specific element you want to test.
</Tip>
...
![Ignore colors region annotation](/assets/images/smart-visual-testing/annotation-tool/ignorecolor_region.png)
...
![Result of ignore colors](/assets/images/smart-visual-testing/annotation-tool/resultofignorecolors.png)

<Note>
Ignore Colors is particularly effective when combined with other annotation types for comprehensive visual testing.
</Note>
...
Use Select Ignore when you need granular control over comparison areas within a larger component. Ensure the ignore region is completely within the select region.
</Tip>
...
![Viewing annotations](/assets/images/smart-visual-testing/annotation-tool/changes_found.png)
...
Deleting annotations will trigger a re-run of the comparison, and the previously ignored/selected areas will be included in future comparisons.
</Note>
...
Use keyboard shortcuts for precise control when resizing annotation boxes, especially for small or complex regions.
</Tip>
