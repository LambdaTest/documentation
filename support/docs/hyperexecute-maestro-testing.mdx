...
<a href="https://github.com/<BrandName />/hyperexecute-maestro-sample-test" className="github__anchor"><img loading="lazy" src='/assets/images/icons/github.png' alt="Image" /> View on GitHub</a>
</Tip>
...
https://github.com/TestMu AI/hyperexecute-maestro-sample-test/blob/main/android-realdevice.yaml
```
</Tab>
...
```yaml reference title="hyperexecute.yaml"
https://github.com/TestMu AI/hyperexecute-maestro-sample-test/blob/main/ios-realdevice.yaml
```
</Tab>
...
```yaml reference title="hyperexecute.yaml"
https://github.com/TestMu AI/hyperexecute-maestro-sample-test/blob/main/android-emulator.yaml
```
</Tab>
...
```yaml reference title="hyperexecute.yaml"
https://github.com/TestMu AI/hyperexecute-maestro-sample-test/blob/main/ios-simulator.yaml
```
</Tab>
...
```yaml reference
https://github.com/TestMu AI/hyperexecute-maestro-sample-test/blob/main/maestro-test/runTest.sh
```
...
```yaml reference
https://github.com/TestMu AI/hyperexecute-maestro-sample-test/blob/main/maestro-test/runTest_ios_realdevice.sh
```
...
https://github.com/TestMu AI/hyperexecute-maestro-sample-test/blob/main/android-launch.yaml
```
