...
keywords: ['regular expression lambdatest', 'regular expression app automation', 'regex', 'appium', 'mobile testing', 'lambdatest']
---
...
<Warning>
To run tests on **minor OS versions** while using `platformVersion` capability, please reach out at our **24x7 Chat Support** or you could also mail us at [support@lambdatest.com](mailto:support@lambdatest.com).
</Warning>
