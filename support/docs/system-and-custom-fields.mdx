...
<img loading="lazy" src='/assets/images/mobile-app-testing/system-and-customs-step-one.webp' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/system-fields.png' alt="Real "  className="doc_img" width="1366" height="629"/>

These System Fields can have Custom Values which can be added by simply selecting any field and clicking on **Add Value**.

<img loading="lazy" src='/assets/images/mobile-app-testing/edit-system-fields.png' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/create-new-fields.webp' alt="Real "  className="doc_img" width="1366" height="629"/>

For Dropdown types (Single Select and Multi Select), you also have the option to add values.

<img loading="lazy" src='/assets/images/mobile-app-testing/dropdown-types.webp' alt="Real "  className="doc_img" width="1366" height="629"/>

Enter the name, placeholder, mark the field, apply it to all future projects if required and click create.

<img loading="lazy" src='/assets/images/mobile-app-testing/custom-fields.webp' alt="Real "  className="doc_img" width="1366" height="629"/>

You can also link a single or multiple projects of your choice to the custom fields and click on **Save changes**.

<img loading="lazy" src='/assets/images/mobile-app-testing/link-projects.webp' alt="Real "  className="doc_img" width="1366" height="629"/>
