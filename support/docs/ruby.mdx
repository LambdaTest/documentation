...
>**Note:** All the code samples in this documentation can be found in the [<BrandName />'s Repository on GitHub](https://github.com/<BrandName />/ruby-selenium-sample.git). You can either download or clone the repository to quickly run your tests.
...
**Step 1:** Clone the <BrandName />’s [ruby-selenium-sample repository](https://github.com/<BrandName />/ruby-selenium-sample) and navigate to the code directory as shown below:
```bash
git clone https://github.com/TestMu AI/ruby-selenium-sample.git
