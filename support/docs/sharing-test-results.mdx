...
<img loading="lazy" src='/assets/images/uploads/sharing-test-results-2.webp' alt="cmd" width="768" height="373" className="doc_img"/>

After clicking on the "i" button, you will get the required test meta information. 

<img loading="lazy" src='/assets/images/uploads/sharing-test-results-1.webp' alt="cmd" width="768" height="373" className="doc_img"/>
