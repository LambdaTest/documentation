...
<img loading="lazy" src='/assets/images/analytics/analytics-regex-view.webp' alt="cmd" width="768" height="373" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/analytics/analytics-regex-main.webp' alt="cmd" width="768" height="373" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/analytics/analytics-regex-preview.webp' alt="cmd" width="768" height="373" className="doc_img"/>
