...
description: <BrandName /> tunnel allows you to test locally and privately hosted apps across various real Android and iOS devices. In this documentation, learn how to configure <BrandName /> tunnel to test locally or privately hosted apps while running app automation.
