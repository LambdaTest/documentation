...
keywords: ['cypress command logs', 'cypress terminal report', 'cypress debugging', 'cypress lambdatest']
---
...
<img loading="lazy" src="/assets/images/cypress/detailed-cypress-logs.png" alt="Image" className="doc_img"/>