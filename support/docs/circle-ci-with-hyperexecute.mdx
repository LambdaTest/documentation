...
<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/circle-ci/circle-ci-new.png' alt="Create New Project"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/circle-ci/circle-config.png' alt="Create New Project"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/circle-ci/circle-ci-run.png' alt="Create New Project"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/circle-ci/circle-commit.png' alt="Create New Project"/>
<p></p>



**Below is an example of a Hyperexecute job that was triggered through the above pipeline:**
<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/circle-ci/successful_gitlab.png' alt="Create New Project"/>
