...
sidebarTitle: "Breeze"
keywords: ['breeze','integration','with','testmu']
---
...
![breeze integration](/assets/images/breeze-integration/1.webp)

**Step 4:** You need to specify your API token for authenticating your TestMu AI account to your Breeze instance.

![breeze integration api](/assets/images/breeze-integration/2.webp)
...
![breeze integration account](/assets/images/breeze-integration/3.webp)

**Step 6:** Select the tab for Integrations and copy the API token.

![breeze integration api](/assets/images/breeze-integration/4.webp)
...
![breeze integration access](/assets/images/breeze-integration/5.webp)
...
![real time testing](/assets/images/breeze-integration/7.webp)
...
![bug icon](/assets/images/breeze-integration/8.webp)

**Step 4:** After a screenshot is captured, you can annotate any issue or a task with an in-built image editor. Once you are done highlighting the bug, click on the button that says "Mark as Bug".

![mark as bug](/assets/images/breeze-integration/9.webp)
...
![breeze integration bug](/assets/images/breeze-integration/10.webp)
...
![breeze integration](/assets/images/breeze-integration/Capture15.webp)
...
![breeze integration todo](/assets/images/breeze-integration/11.webp)
...
![breeze integration remove](/assets/images/breeze-integration/13.webp)

> That was all you need to know for TestMu AI + Breeze Integration. Increase your productivity with our integrations. If you still have any questions for us, please feel free to let us know. Our experts are always available on <span className="doc__lt" onClick={() => window.openLTChatWidget()}>**chat**</span> to help you out with any roadblock regarding our product. Happy testing! 🙂
