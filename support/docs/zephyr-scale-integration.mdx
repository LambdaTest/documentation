...
1. Clone the [<BrandName /> Zephyr Scale GitHub repository](https://github.com/<BrandName />/junit-selenium-zephyr-scale-sample) and navigate to the cloned directory.

```js
git clone https://github.com/TestMu AI/junit-selenium-zephyr-scale-sample
