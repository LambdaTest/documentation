...
* * *
> First and foremost, you need to clone our GitHub repository for downloading the relevant code needed to integrate [Azure Pipelines with <BrandName />](https://github.com/<BrandName />/protractor-selenium-azure-sample).
