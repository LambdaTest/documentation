...
<a href="https://github.com/<BrandName />/LamdaTest_Tesbo_Demo" className="github__anchor"><img loading="lazy" src='/assets/images/icons/github.png' alt="Image" /> View on GitHub</a>
