...
---
<Warning>
All the code samples in this documentation can be found in the [WebDriverIO 5.6.2 <BrandName /> Repository on <span style={{display: 'inline-block', verticalAlign: 'middle'}}><img src='/assets/images/GitHub_icon/github-icon.webp' alt="Image" width="25" height="25" style={{display: 'inline', verticalAlign: 'middle'}} /></span> GitHub](https://github.com/LambdaTest/webdriverio-selenium). You can either download or clone the repository to quickly run your tests.
</Warning>
