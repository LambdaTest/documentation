...
keywords: [ "sso", "lambdatest sso", "google custom", "google workspace", "saml", "testmu ai google integration", "testmu ai google sso"]
---
...
![Navigate to Web and Mobile Apps](/assets/images/lambdatest-sso-google/add-custom-saml-app.png)
...
![Add custom SAML app](/assets/images/lambdatest-sso-google/custom-app-creation.png)
...
5. **Retrieve Google Identity Provider Details**: On the **Google Identity Provider details** page, you'll need to collect the following information for <BrandName /> configuration:
    ...
    **Important**: Keep this information secure and readily accessible, as you'll need to enter these details in <BrandName />'s SSO configuration.
    ...
    ![<BrandName /> Configuration Details](/assets/images/lambdatest-sso-google/sp-details.png)
...
![<BrandName /> SSO Settings](/assets/images/lambdatest-sso-google/sso-setup-lambdatest.png)
...
![Select Other SAML Provider](/assets/images/lambdatest-sso-google/idp-selector.png)
...
![<BrandName /> Configuration Details](/assets/images/lambdatest-sso-google/configure-idp.png)
...
![Configure Service Provider Details](/assets/images/lambdatest-sso-google/service-provider-detail.png)
...
13. **Configure Attribute Mapping**: Click **Add mapping** to establish the user attribute mappings required by <BrandName />:
    ...
    ![Configure Attribute Mapping](/assets/images/lambdatest-sso-google/attribute-mapping.png)

14. **Complete Google Workspace Setup**: Click **Finish** to finalize the SAML application configuration in Google Workspace.

![Enter app details](/assets/images/lambdatest-sso-google/app-detail-google.png)
...
![Turn On SAML App](/assets/images/lambdatest-sso-google/update-app-for-user-access.png)
...
![Upload Google Certificate and SSO URL](/assets/images/lambdatest-sso-google/certificate-upload.png)
...
![<BrandName /> SSO Login Page](/assets/images/lambdatest-sso-google/sp-initiated-sso.png)
...
![App Not Enabled Error](/assets/images/lambdatest-sso-google/app-not-enabled.png)
