...
<img loading="lazy" src='/assets/images/hyperexecute/knowledge-base/widgets/stage-trends.png' alt="job-trends" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/knowledge-base/widgets/stage-summary.png' alt="job-trends" className="doc_img"/>