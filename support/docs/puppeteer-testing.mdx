...
1. Clone the [<BrandName />-Puppeteer GitHub repository](https://github.com/<BrandName />/puppeteer-sample) and switch to the cloned directory.

```js
git clone https://github.com/TestMu AI/puppeteer-sample.git
cd puppeteer-sample
```
