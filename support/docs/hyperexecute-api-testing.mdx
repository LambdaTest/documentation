...
<img loading="lazy" src="/assets/images/hyperexecute/integration/products/api/1.png" alt="automation-dashboard" width="1920" height="868" className="doc_img"/>

#### scenario

<img loading="lazy" src="/assets/images/hyperexecute/integration/products/api/2.png" alt="automation-dashboard" width="1920" height="868" className="doc_img"/>

#### post

<img loading="lazy" src="/assets/images/hyperexecute/integration/products/api/3.png" alt="automation-dashboard" width="1920" height="868" className="doc_img"/>