...
<img loading="lazy" src='/assets/images/mobile-app-testing/insights-dashboard.webp' alt="Real "  className="doc_img" width="1600" height="415"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/build-and-test-case-summary.webp' alt="Real "  className="doc_img" width="1600" height="613"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/test-case-trend.webp' alt="Real "  className="doc_img" width="1600" height="609"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/issues-trend.webp' alt="Real "  className="doc_img" width="1600" height="611"/>
