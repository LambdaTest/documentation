...
>**Note:** All the code samples in this documentation can be found in the [<BrandName />'s Repository on GitHub](https://github.com/<BrandName />/MSTest-Selenium-Sample). You can either download or clone the repository to quickly run your tests.
...
**Step 1:** Clone the [<BrandName />’s MSTest-Selenium-Sample repository](https://github.com/<BrandName />/MSTest-Selenium-Sample) and navigate to the code directory as shown below:
```csharp
git clone https://github.com/TestMu AI/MSTest-Selenium-Sample
...
namespace SingleLTSelenium
{
    ...
    public class SingleLTTests
    {
        ...
        public void LT_ToDo_Test(String browser, String version, String os)
        {
            ...
            driver.Url = "https://testmu ai.github.io/sample-todo-app/";
