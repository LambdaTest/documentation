---
title: "How to Debug your Scenario Steps Errors"
...
<img loading="lazy" src="/assets/images/hyperexecute/knowledge-base/debugging-guide/scenario-errors/session.png" alt="Image" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/hyperexecute/knowledge-base/debugging-guide/scenario-errors/hub_error.png" alt="Image" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/hyperexecute/knowledge-base/debugging-guide/scenario-errors/stage_stuck.png" alt="Image" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/hyperexecute/knowledge-base/debugging-guide/scenario-errors/test_stuck.png" alt="Image" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/hyperexecute/knowledge-base/debugging-guide/scenario-errors/idle_timeout.png" alt="Image" className="doc_img"/> <br /> 
And when you click on the View Test button, you can see that the status of your test is Idle_Timeout.
<img loading="lazy" src="/assets/images/hyperexecute/knowledge-base/debugging-guide/scenario-errors/idle_timeout2.png" alt="Image" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/hyperexecute/knowledge-base/debugging-guide/scenario-errors/socket_error.png" alt="Image" className="doc_img"/>
