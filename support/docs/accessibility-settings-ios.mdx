...
<img loading="lazy" src='/assets/images/real-device-app-testing/accessibility-1.png' className="doc_img"/>

<Tabs className="docs__val">

<Tab value="display-text" title="Display and Text Size" default>
...
<Tab value="reduce-motion" title="Reduce Motion" default>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/accessibility-2.png' className="doc_img"/>
