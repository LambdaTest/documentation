...
<a href="https://github.com/<BrandName />/hyp-ci-cd-integration-sample/tree/Jenkins" className="github__anchor"><img loading="lazy" src='/assets/images/icons/github.png' alt="Image" /> View on GitHub</a>
</Tip>
