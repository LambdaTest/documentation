...
<img loading="lazy" src='/assets/images/real-device-app-testing/Acessiblity_Phone_selection.png' className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/Accessiblity_TalkBack_toggle.png' className="doc_img"/>
