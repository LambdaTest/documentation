...
sidebarTitle: Ruby
description: In this documentation, learn how integrate your Selenium Ruby automated tests with <BrandName />'s SmartUI.
...
```bash
git clone https://github.com/<BrandName />/smartui-ruby-selenium-sample
...
**Solutions**:
1. Check latest version on [RubyGems.org](https://rubygems.org/gems/testmu ai-selenium-driver)
2. Clear gem cache:
   ```bash
   gem cleanup
   ```
