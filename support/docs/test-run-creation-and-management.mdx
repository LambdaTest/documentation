...
<img loading="lazy" src='/assets/images/mobile-app-testing/test-runs-one.webp' alt="Real "  className="doc_img"/>

### Step 2: Add Tags
- Assign relevant Tags to categorize the test run.
- Click **Create Test Run** to proceed.

<img loading="lazy" src='/assets/images/test-run/2.png' alt="Real "  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/test-run/3.png' alt="Real "  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/test-run/4.png' alt="Real "  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/test-run/5.png' alt="Real "  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/test-run/6.png' alt="Real "  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/test-run/7.png' alt="Real "  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/test-run/8.png' alt="Real "  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/test-run/9.png' alt="Real "  className="doc_img"/>

- Attach supporting files or screenshots to the remarks for better context.

<img loading="lazy" src='/assets/images/test-run/10.png' alt="Real "  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/test-run/12.png' alt="Real "  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/test-run/11.png' alt="Real "  className="doc_img"/>

- During execution, manually update the status of test cases and test steps as needed.
<img loading="lazy" src='/assets/images/test-run/14.png' alt="Real "  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/test-run/13.png' alt="Real "  className="doc_img"/>
