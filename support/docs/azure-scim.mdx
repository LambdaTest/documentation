...
<img loading="lazy" src='/assets/images/testmu ai-scim/azure-ad/enterprise-applications.png' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />

**Step 5:** In the applications list, select application used for <BrandName /> SSO setup
<img loading="lazy" src='/assets/images/testmu ai-scim/azure-ad/search-testmu ai-sso.png' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />

**Step 6:** Select the Provisioning tab.
<img loading="lazy" src='/assets/images/testmu ai-scim/azure-ad/provisioning-tab.png' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />
...
<img loading="lazy" src='/assets/images/testmu ai-scim/azure-ad/credentials.png' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />

**Step 8:** Under the Mappings section, select Synchronize Azure Active Directory Users.
<img loading="lazy" src='/assets/images/testmu ai-scim/azure-ad/mapping-tab.png' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />
...
<img loading="lazy" src='/assets/images/testmu ai-scim/azure-ad/userName.png' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />
...
<img loading="lazy" src='/assets/images/testmu ai-scim/azure-ad/attribute-mapping.png' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />

- **Dynamic/Static assignment of custom attributes**: After custom attribute creation, we have to map them using “Add new mapping”

<img loading="lazy" src='/assets/images/testmu ai-scim/azure-ad/dynamic_1.png' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />

<img loading="lazy" src='/assets/images/testmu ai-scim/azure-ad/dynamic_2.png' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />
...
<img loading="lazy" src='/assets/images/testmu ai-scim/azure-ad/dynamic_3.png' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />
...
<img loading="lazy" src='/assets/images/testmu ai-scim/azure-ad/provisioning-on.png' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />
...
<img loading="lazy" src='/assets/images/testmu ai-scim/azure-ad/save.png' alt="Image" width="404" height="206"  className="doc_img img_center" /><br />
