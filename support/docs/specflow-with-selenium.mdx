...
>**Note:** All the code samples in this documentation can be found in the [<BrandName />'s Repository on GitHub](https://github.com/<BrandName />/SpecFlow-Selenium-Sample). You can either download or clone the repository to quickly run your tests.
...
**Step 1:** Clone the [<BrandName />’s SpecFlow-Selenium-Sample repository](https://github.com/<BrandName />/SpecFlow-Selenium-Sample) and navigate to the code directory as shown below:
```csharp
git clone https://github.com/TestMu AI/SpecFlow-Selenium-Sample
