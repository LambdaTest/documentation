...
sidebarTitle: Linking Automated Test Cases
...
<img loading="lazy" src='/assets/images/mobile-app-testing/automation-one.webp' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/automation-project-two.webp' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/automation-project-three.webp' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/select-bdd-scenarios.webp' alt="Real "  className="doc_img" width="1366" height="629"/>