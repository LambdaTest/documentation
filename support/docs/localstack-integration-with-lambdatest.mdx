---
title: "LocalStack Integrates With Lambdatest"
...
![add](/assets/images/localstack-integration/local-three.webp)

**Step 2:** Select the **API Keys** tab.  

![add](/assets/images/localstack-integration/local-four.webp)
...
![add](/assets/images/localstack-integration/localstack-one.webp)
...
```
![remove](/assets/images/localstack-integration/localstack-two.webp)
...
![remove](/assets/images/localstack-integration/localstack-three.webp)
...
![remove](/assets/images/localstack-integration/localstack-four.webp)
...
![remove](/assets/images/localstack-integration/localstack-five.webp)

Below is an example of a **HyperExecute** job that was triggered through the above pipeline:

![remove](/assets/images/localstack-integration/localstack-six.webp)
