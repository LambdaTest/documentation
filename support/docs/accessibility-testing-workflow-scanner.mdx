...
![automation-dashboard](/assets/images/accessibility-testing/workflow-scanner/1.png)

### Review Your Issues

- This will list down all of the issues after scanning all of your webpages that you have searched for.

![automation-dashboard](/assets/images/accessibility-testing/workflow-scanner/2.png)