---
title: "Ruby with Selenium: Tutorial to Run Your First Test on TestMu AI"
sidebarTitle: "Ruby"
...
All the code samples in this documentation can be found in the [<BrandName />'s Repository on GitHub](https://github.com/LambdaTest/ruby-selenium-sample.git). You can either download or clone the repository to quickly run your tests.
</Note>
