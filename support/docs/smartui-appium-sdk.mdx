...
<div className='bg-[#f2f2f2] border border-[#ddd] rounded-b-[4px] border-t-0'>
  <p className="text-[14px] font-normal leading-[1.5] m-0 p-[21px] text-center">We support all languages and frameworks that are compatible with Appium, so in case your favorite isn't in the table.<br/>Don't worry, you can still run the test. <span className='' onClick={() => window.openLTChatWidget()}>Contact Us</span> for any help.</p>
</div>
</div>
