...
<div className='lt_row lt_framework_list_row'>
  <div className='lt_col lt_framework_wrapper'>
    <img loading="lazy" src='/assets/images/getting-started/java-icon.webp' alt="Java" width="200" height="200" className='language-icon no-zoom' />
  ...
  <div className='lt_col lt_framework_wrapper'>
    <img loading="lazy" src='/assets/images/getting-started/color-js.webp' alt="Javascript" width="181" height="200" className='language-icon no-zoom' />
    <ul className='lt_framework_list'>
  ...
  <div className='lt_col lt_framework_wrapper'>
    <img loading="lazy" src='/assets/images/getting-started/python-icon.webp' alt="Python" width="200" height="200" className='language-icon no-zoom' />
    <ul className='lt_framework_list'>
  ...
  <div className='lt_col lt_framework_wrapper'>
     <img loading="lazy" src='/assets/images/getting-started/ruby-icon.webp' alt="Ruby" width="200" height="200" className='language-icon no-zoom' />
      <ul className='lt_framework_list'>
  ...
  <div className='lt_col lt_framework_wrapper'>
    <img loading="lazy" src='/assets/images/getting-started/c-sharp-icon.webp' alt="C#" width="200" height="200" className='language-icon no-zoom' />
    <ul className='lt_framework_list'>
