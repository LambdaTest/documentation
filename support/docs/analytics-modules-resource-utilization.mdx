...
keywords: ['analytics', 'concurrency trends', 'custom concurrency trends', 'resource utilization', 'parallel tests', 'insights widget']
---
...
**Step 1:** Log in to your [<BrandName /> account](https://accounts.lambdatest.com/login) and navigate to **Insights** from the left sidebar.
