...
Navigate to the [<BrandName /> AI Cloud GitHub App](https://github.com/apps/testmu ai-ai-cloud) on GitHub Marketplace and click **Install** to begin the installation process.

<img loading="lazy" src='/assets/images/kaneai-github-app/install-github-app.png' alt="Trigger KaneAI workflow" />
...
<img loading="lazy" src='/assets/images/kaneai-github-app/github-repository-selection.png' alt="Trigger KaneAI workflow" />
...
<img loading="lazy" src='/assets/images/kaneai-github-app/integration-success.png' alt="Trigger KaneAI workflow" />
...
1. Navigate to the [<BrandName /> AI Cloud GitHub App](https://github.com/apps/testmu ai-ai-cloud) on GitHub Marketplace
...
Create a `.testmu ai/config.yaml` file in the root directory of your repository with the following structure:

```yaml
# TestMu AI AI Cloud Configuration
...
- **Version Control**: Commit `.testmu ai/config.yaml` to your repository so all team members use consistent configuration
...
{/* <img loading="lazy" src='/assets/images/kaneai-github-app/7-rca-for-failed-tests.png' alt="AI RCA for Failed Tests" /> */}
