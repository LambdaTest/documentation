...
<Frame>
<img loading="lazy" src='/assets/images/selenium/guided-walkthrough/homepage-guide.gif' alt="Image" className="doc_img" style={{ width: '100%' }}/>
</Frame>
...
<Frame>
<img loading="lazy" src='/assets/images/selenium/guided-walkthrough/testPage.png' alt="Image" className="doc_img" style={{ width: '100%' }}/>
</Frame>
...
<Frame>
<img loading="lazy" src='/assets/images/selenium/guided-walkthrough/test.png' alt="Image" className="doc_img" style={{ width: '100%' }}/>
</Frame>
...
<Frame>
<img loading="lazy" src='/assets/images/selenium/guided-walkthrough/testSummary.png' alt="Image" className="doc_img" style={{ width: '100%' }}/>
</Frame>
...
<Frame>
<img loading="lazy" src='/assets/images/selenium/guided-walkthrough/commandLogsAndVideos.png' alt="Image" className="doc_img" style={{ width: '100%' }}/>
</Frame>
...
<Frame>
<img loading="lazy" src='/assets/images/selenium/guided-walkthrough/testVideo.png' alt="Image" className="doc_img" style={{ width: '100%' }}/>
</Frame>