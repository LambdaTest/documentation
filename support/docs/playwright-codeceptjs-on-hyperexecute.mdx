---
title: "Running Codecept Framework Tests on HyperExecute"
...
Download or Clone the code sample for the CodeceptJs from the LambdaTest GitHub repository to run the tests on the HyperExecute.
