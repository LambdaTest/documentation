...
<a href="https://github.com/<BrandName />/testmu ai-xcui" className="github__anchor"><img loading="lazy" src='/assets/images/icons/github.png' alt="Image" /> View on GitHub</a>
</Tip>
...
- Update this [dependency](https://swiftpackageindex.com/<BrandName />/testmu ai-xcui) in your test classes. You can do it as follows:
