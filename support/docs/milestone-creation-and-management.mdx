...
<img loading="lazy" src='/assets/images/milestones/1.png' alt="Real "  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/milestones/2.png' alt="Real "  className="doc_img"/>

### Step 3: Finalize the Milestone
- Review all entered details for accuracy.
- Click **Create Milestone** to finalize the creation.
<img loading="lazy" src='/assets/images/milestones/3.png' alt="Real "  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/milestones/4.png' alt="Real "  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/milestones/5.png' alt="Real "  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/milestones/6.png' alt="Real "  className="doc_img"/>
