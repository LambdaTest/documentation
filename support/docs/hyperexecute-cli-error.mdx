...
<img loading="lazy" src="/assets/images/hyperexecute/knowledge-base/debugging-guide/cli-errors/symlink.png" alt="Image" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/hyperexecute/knowledge-base/debugging-guide/cli-errors/snooper1.png" alt="Image" className="doc_img"/>

<img loading="lazy" src="/assets/images/hyperexecute/knowledge-base/debugging-guide/cli-errors/snooper.png" alt="Image" className="doc_img"/>

## Authentication Error

There may be cases where, when trying to connect to HyperExecute services, the CLI throws the following error:

<img loading="lazy" src="/assets/images/hyperexecute/knowledge-base/debugging-guide/cli-errors/auth.png" alt="Image" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/hyperexecute/knowledge-base/debugging-guide/cli-errors/auth1.png" alt="Image" className="doc_img"/>
