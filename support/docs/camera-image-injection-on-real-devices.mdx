...
<Tab value="bash" title="iOS >= version 13" default>
...
<Tab value="powershell" title="Android >= version 9" default>
...
<Tab value="powershell" title="Android >= version 13" default>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/media-injection/Step3.png' alt="Native Mobile App Testing"  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/media-injection/Stepfinal.png' alt="Native Mobile App Testing"  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/media-injection/Stepfinalx.png' alt="Native Mobile App Testing"  className="doc_img" width="1366" height="629"/>
