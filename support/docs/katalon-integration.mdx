---
title: "Using Katalon Studio with Real Devices"
...
<Check>
**- If you do not have any **.apk** or **.ipa** file, you can run your sample tests on Lambdatest by using our sample :link: [Android app](https://prod-mobile-artefacts.lambdatest.com/assets/docs/proverbial_android.apk) or sample :link: [iOS app](https://prod-mobile-artefacts.lambdatest.com/assets/docs/proverbial_ios.ipa).** <br />
...
![katalon integration](/assets/images/katalon-integration-realDevices/001.webp)
...
![katalon integration](/assets/images/katalon-integration-realDevices/002.webp)
...
![katalon integration](/assets/images/katalon-integration-realDevices/003.webp)

Now we can see that there are 2 icons:

The first one is the Katalon Spy and the next one is the Katalon Mobile Record.

![katalon integration](/assets/images/katalon-integration-realDevices/004.webp)
...
![katalon integration](/assets/images/katalon-integration-realDevices/005.webp)

### 5. Edit Configuration
Click on Edit Configuration

![katalon integration](/assets/images/katalon-integration-realDevices/006.webp)

#### a. Hub URL
Now we need to fill in the details for Remote Server URL that will be found on your App Automation Dashboard.

![katalon integration](/assets/images/katalon-integration-realDevices/007.webp)

Copy the Hub URL and add it to the Remote Server URL from the App Automation Dashboard.

![katalon integration](/assets/images/katalon-integration-realDevices/008.webp)
...
![katalon integration](/assets/images/katalon-integration-realDevices/009.webp)
...
![katalon integration](/assets/images/katalon-integration-realDevices/010.webp)
...
![katalon integration](/assets/images/katalon-integration-realDevices/011.webp)

 {/* We can easily fetch it from the App Live Dashboard and add it in the Cloud Application ID section:

![katalon integration](/assets/images/katalon-integration-realDevices/012.webp) */}

### 6. App ID
Now just add in your App ID and click Start

![katalon integration](/assets/images/katalon-integration-realDevices/013.webp)

### 7. Run Mobile Spy
The session now starts and it’ll look like this:

![katalon integration](/assets/images/katalon-integration-realDevices/014.webp)
...
![katalon integration](/assets/images/katalon-integration-realDevices/015.webp)
...
![katalon integration](/assets/images/katalon-integration-realDevices/016.webp)
...
![katalon integration](/assets/images/katalon-integration-realDevices/017.webp)
...
![katalon integration](/assets/images/katalon-integration-realDevices/018.webp)
...
![katalon integration](/assets/images/katalon-integration-realDevices/019.webp)
...
![katalon integration](/assets/images/katalon-integration-realDevices/020.webp)
...
![katalon integration](/assets/images/katalon-integration-realDevices/021.webp)

### 2. Test Executing
Now we can see that the test starts running. 

![katalon integration](/assets/images/katalon-integration-realDevices/022.webp)
...
![katalon integration](/assets/images/katalon-integration-realDevices/023.webp)
