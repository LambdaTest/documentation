...
keywords: ["local testing", "LambdaTest tunnel Features", "local testing for windows", "push issues to clubhouse", "local cross browser testing"]
---
...
![tunnel configuration for localhost testing on winws](/assets/images/local-testing-windows/local-windows-1.webp)
...
![extracting binary zip file](/assets/images/local-testing-windows/local-windows-2.webp)
...
```
![Access key for tunnel activation](/assets/images/local-testing-windows/local-windows-3.webp)
...
![start localhost testing on Windows](/assets/images/local-testing-windows/tunnel_launched.webp)
...
![Xampp Control Panel](/assets/images/local-testing-windows/local-windows-5.webp)
...
![realtime localhost testing](/assets/images/local-testing-windows/local-windows-6.webp)
...
![local testing configuration](/assets/images/local-testing-windows/local-windows-7.webp)

Once you press the **‘Start’**  button, your test will start and you will be navigated to your localhost URL.

![Starting Xampp](/assets/images/local-testing-windows/local-windows-8.webp)
...
![Localhost Testing on Android](/assets/images/local-testing-windows/local-windows-9.webp)
...
![Launching VM for localhost testing](/assets/images/local-testing-windows/local-windows-10.webp)
...
![Local testing on iOS](/assets/images/local-testing-windows/local-windows-11.webp)
...
![Configuration for localhost testing on iOS](/assets/images/local-testing-windows/local-windows-12.webp)
...
![Testing Local folder on LambdaTest](/assets/images/local-testing-windows/local-windows-13.webp)

**Step 2:**  Click on **‘Folder’**  button and copy the string on your system’s clipboard.

![access key to test locally hosted website](/assets/images/local-testing-windows/local-windows-14.webp)
...
![start local website testing](/assets/images/local-testing-windows/local-windows-15.webp)
...
![Access local folder for testing](/assets/images/local-testing-windows/folder.webp)
...
![Stopping tunnel](/assets/images/local-testing-windows/tunnel_stopped.webp)
...
![disconnecting LambdaTest tunnel](/assets/images/local-testing-windows/close tunnel.webp)
...
![Finding access key](/assets/images/local-testing-windows/creds.webp)
...
![REaltime Test for locally hosted webpages](/assets/images/local-testing-windows/local-windows-20.webp)
...
![Access key in profile](/assets/images/local-testing-windows/local-windows-21.webp)
