...
<img loading="lazy" src="/assets/images/appium-inspector/appium_inspector2.webp" alt="cmd" width="768" height="373" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/appium-inspector/appium_inspector1.webp" alt="cmd" width="768" height="373" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/appium-inspector/appium_inspector3.webp" alt="cmd" width="768" height="373" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/appium-inspector/appium_inspector4.webp" alt="cmd" width="768" height="373" className="doc_img"/>

### Step 4: Attach to Session
Once you have selected a session, click on Attach to Session.

<img loading="lazy" src="/assets/images/appium-inspector/appium_inspector5.webp" alt="cmd" width="768" height="373" className="doc_img"/>
