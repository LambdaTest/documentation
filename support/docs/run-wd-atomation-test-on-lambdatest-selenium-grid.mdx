...
>**Note:** All the code samples in this documentation can be found in the [<BrandName />'s Repository on GitHub](https://github.com/<BrandName />/wd-selenium-sample). You can either download or clone the repository to quickly run your tests.
...
**Step 1:** Clone the <BrandName />’s [wd-selenium-sample repository](https://github.com/<BrandName />/wd-selenium-sample) and navigate to the code directory as shown below:
```bash
git clone https://github.com/TestMu AI/wd-selenium-sample
...
module.exports = {
  ...
  run : function (browser) {
    return browser
      .get("https://testmu ai.github.io/sample-todo-app/").then(function(){
