---
title: Modules - Creation and Management
...
<img loading="lazy" src='/assets/images/mobile-app-testing/existing-modules-one.webp' alt="select-test-steps" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/existing-modules-two.webp' alt="create-modules-from-test-steps" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/modules-listing-page.png' alt="automation-dashboard" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/modules_creation_page.png' alt="modules-listing-page" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/modules_page.png' alt="module-page" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/modules_version_history.png' alt="modules-version-history" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/modules_version_comparision.png' alt="modules-version-comparision" className="doc_img"/>
