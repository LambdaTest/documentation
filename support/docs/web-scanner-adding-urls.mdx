...
keywords: ["lambdatest", "web scanner", "add urls", "csv import", "sitemap import"]
---
...
![Add URLs Manually](/assets/images/web-scanner/import-urls-manually.png)
...
![Import URLs via CSV File](/assets/images/web-scanner/import-urls-csv.png)
...
![Import URLs via Sitemap](/assets/images/web-scanner/import-urls-sitemap.png)
