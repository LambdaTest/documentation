...
```bash
git clone https://github.com/TestMu AI/webdriverio-selenium.git
```
...
## Sample Test
***
**Step 5:** Now you can explore the sample test case to be run on the cloud using `WD` framework in `scripts/testmu ai.js`: 
```
// testmu ai.js
...
//package.json
{
  ...
  "repository": {
    "type": "git",
    "url": "git+https://github.com/TestMu AI/webdriverio-TestMu AI.git"
  },
  "keywords": [
    "webdriverio",
    "TestMu AI",
  ...
  "bugs": {},
  "homepage": "https://github.com/TestMu AI/webdriverio-TestMu AI#readme",
  "dependencies": {
    "webdriverio": "^4.14.2"
  },
  "devDependencies": {
