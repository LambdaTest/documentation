...
keywords: ["lambdatest integrations", "smart ui integration", "smart ui integrations with ci/cd tools", "ci/cd tools", "continuous integration,continuous delivery", "continuous integration tools", "bitbucket ci cd"]
---
...
![Create New Project](/assets/images/smart-visual-testing/ci-cd-integration/bitbucket/1.png)

- Now click on the **Create Repository** button. You can either create a new repository or import your existing repository.

![Create New Project](/assets/images/smart-visual-testing/ci-cd-integration/bitbucket/2.png)
