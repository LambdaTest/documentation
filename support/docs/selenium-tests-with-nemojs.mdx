---
title: "Run Selenium Tests With NemoJS"
sidebarTitle: "NemoJS"
...
<Warning>
All the code samples in this documentation can be found in the [NemoJS LambdaTest Repository on <span style={{display: 'inline-block', verticalAlign: 'middle'}}><img src='/assets/images/GitHub_icon/github-icon.webp' alt="Image" width="25" height="25" style={{display: 'inline', verticalAlign: 'middle'}} /></span> GitHub](https://github.com/LambdaTest/Nemo-Lambdatest-sample). You can either download or clone the repository to quickly run your tests.
</Warning>
...
That’s all! You have successfully performed your Selenium tests with Nemo.js. In case you come across any doubts, feel free to reach out through our **24/7 chat support** or you can also drop a mail to [support@lambdatest.com](mailto:support@lambdatest.com). <br/>Happy testing!
