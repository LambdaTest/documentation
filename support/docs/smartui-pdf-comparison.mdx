...
<iframe
  ...
  title="Visual Regression Testing for PDF Files Using SmartUI | TestMu AI"
...
<Columns cols={2}>
  <Card title="API Upload" href="/support/docs/smartui-pdf-api-upload/">
    Upload PDFs using REST API for programmatic integration and automation.
  </Card>
  <Card title="CLI Upload" href="/support/docs/smartui-pdf-cli-upload/">
    Upload PDFs using command-line interface for quick testing and CI/CD integration.
  </Card>
  <Card title="Java SDK Upload" href="/support/docs/smartui-pdf-java-sdk/">
