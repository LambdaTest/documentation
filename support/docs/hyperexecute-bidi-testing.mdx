...
<a href="https://github.com/<BrandName />/hyperexecute-bidi-sample" className="github__anchor"><img loading="lazy" src='/assets/images/icons/github.png' alt="Image" /> View on GitHub</a>
</Tip>
...
https://github.com/TestMu AI/hyperexecute-bidi-sample/blob/main/yaml/hyperexecute-linux.yaml
```
