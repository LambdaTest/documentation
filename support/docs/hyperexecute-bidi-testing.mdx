...
sidebarTitle: "BiDi"
keywords: ['BiDi', 'WebDriver BiDi', 'lambdatest', 'framework on lambdatest', 'HyperExecute', 'automation testing']
---
...
```javascript wdio.lambdatest.config.js highlight={5}
...
testDiscovery:
  mode: local
  type: raw
  command: echo "test/specs/BrowsingContext.spec.js"

testRunnerCommand: npx wdio wdio.lambdatest.conf.js --spec=test/specs/BrowsingContext.spec.js

jobLabel: [HYP, BiDi, Linux]
```
...
<img loading="lazy" src="/assets/images/hyperexecute/frameworks/selenium/bidi/bidi.png" alt="Image" className="doc_img"/>
