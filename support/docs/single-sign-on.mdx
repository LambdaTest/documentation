...
keywords: [ "LambdaTest single sign on", "LambdaTest single sign-on","LambdaTest SSO"]
---
...
<Warning> SSO is supported in our Enterprise Plans. Please reach out to your account manager or [support@testmu.ai](mailto:support@testmu.ai) for questions.</Warning>
...
![Image](/assets/images/lambdatest-mfa/new-dashboard.webp)

**Step 2:**  Click on the **User Icon** on the top right and select **Organization Settings** from the dropdown.

![Image](/assets/images/lambdatest-mfa/org-settings-new.webp)

**Step 3:**  Head to the **Security** tab and click the **SSO** option.

![Image](/assets/images/lambdatest-mfa/sso-setup.webp)

You can contact the **Support Team**, who will help you enable the SSO feature for your <BrandName /> account. 


<Warning> That's all you need to know about Single sign-on(SSO) authentication feature.In case you have any questions please feel free to reach out to us via the <span className="doc__lt" onClick={() => window.openLTChatWidget()}>**24/7 chat support**</span> or email us over [support@testmu.ai](mailto:support@testmu.ai). </Warning>