...
keywords: ['sharding', 'Espresso', 'appium', 'real devices', 'lambdatest cloud platform', 'app automation', 'real time testing', 'appium automation', 'espresso sharding', 'hyperexecute']
---
...
```bash
curl -u "YOUR_LAMBDATEST_USERNAME:YOUR_LAMBDATEST_ACCESS_KEY" \
--location --request POST 'https://manual-api.lambdatest.com/app/uploadFramework' --form 'appFile=@"/Users/macuser/Downloads/ProverbialEspressoTest.apk"' --form 'type="espresso-android"'
```
  </Tab>
  <Tab title="Windows">
```powershell
...
```yaml SampleYamlFile.yaml highlight={16,22}
version: "0.2"
concurrency: 2
runson: android
autosplit: false
...
<img loading="lazy" src="/assets/images/app-automation/espresso_sharding.png" alt="cmd" width="768" height="373" className="doc_img"/>
- [LambdaTest HyperExecute](https://hyperexecute.lambdatest.com/hyperexecute)
<img loading="lazy" src="/assets/images/app-automation/espresso_cli.png" alt="cmd" width="768" height="373" className="doc_img"/>
