...
description: This document provides information about configuring IP Geolocation for tests on the <BrandName /> platform and also provides a list of supported geolocations on Real Devices.
