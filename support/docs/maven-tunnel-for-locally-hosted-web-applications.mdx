...
> <BrandName /> Maven Tunnel is now compatible with both **Java 17** and **Java 20**. Additionally, we also rolled out the latest **[Maven Tunnel](https://mvnrepository.com/artifact/com.github.testmu ai/testmu ai-tunnel-binary/4.0.2)**, with various enhancements and optimizations. 
...
* * *
<Warning>
Note: Make sure you clone our [GitHub repository for Maven tunnel](https://github.com/<BrandName />/maven-tunnel-sample).
</Warning>
...
Here is the code that is present in the cloned [GitHub repository for Maven Tunnel](https://github.com/<BrandName />/maven-tunnel-sample).
