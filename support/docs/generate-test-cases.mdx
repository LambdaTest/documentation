...
<img loading="lazy" src='/assets/images/mobile-app-testing/custom_instructions_project_settings.png' alt="custom-instructions-project-settings" width="1347" height="616" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/custom_instructions_org_settings.png' alt="custom-instructions-org-settings" width="1347" height="616" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/generate_scenarios_kaneai.png' alt="generate-scenarios-kaneai" width="1347" height="616" />
...
[<BrandName /> Jira Integration](/support/docs/jira-integration/#how-to-establish-integration-with-jira-from-your-testmu ai-account) / [<BrandName /> Azure DevOps Integration](/support/docs/link-ado-issues-with-test-manager/)
...
<img loading="lazy" src='/assets/images/mobile-app-testing/configure_generation_settings.png' alt="configure-generation-settings" width="1347" height="616" />
...
{/* <img loading="lazy" src='/assets/images/mobile-app-testing/conversation_layer_overview.png' alt="conversation-layer-overview" width="1347" height="616" /> */}

#### Conversational Workspace

When the Conversation Layer is active, the workspace is divided into two primary panels:

<img loading="lazy" src='/assets/images/mobile-app-testing/conversation_layer_workspace.png' alt="conversation-layer-workspace" width="1347" height="616" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/chat_interface_panel.png' alt="chat-interface-panel" width="1347" height="616" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/live_output_view.png' alt="live-output-view" width="1347" height="616" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/session_context_drawer.png' alt="session-context-drawer" width="1347" height="616" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/at_reference_autocomplete.png' alt="at-reference-autocomplete" width="1347" height="616" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/regeneration_settings.png' alt="regeneration-settings" width="1347" height="616" />
...
<img loading="lazy" src='/assets/images/mobile-app-testing/create_automate_test_cases.png' alt="create-test-cases" width="1347" height="616" />
...
{/* <img loading="lazy" src='/assets/images/mobile-app-testing/create_test_cases.png' alt="create-test-cases" width="1347" height="616" /> */}
...
{/* <img loading="lazy" src='/assets/images/mobile-app-testing/create_and_automate_test_cases.png' alt="create-and-automate-test-cases" width="1347" height="616" /> */}
...
<source src= '/assets/images/mobile-app-testing/ai-test-case-generator-walkthrough.mp4' type="video/mp4" />
</video>
