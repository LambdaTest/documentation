...
<img loading="lazy" src='/assets/images/mobile-app-testing/multiple-test-cases.webp' alt="Real " className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/manual_test_case_creation/new_test_case.png' alt=" " className="doc_img"/>
...
<img loading="lazy" src='/assets/images/test-manager/test-cases/test-case-summary.png' alt=" " className="doc_img"/>
...
<img loading="lazy" src='/assets/images/test-manager/test-cases/test-steps-page.png' alt=" "  className="doc_img"/>

The Test Manager offers a comprehensive Steps section with a rich text editor and these features:

<img loading="lazy" src='/assets/images/test-manager/test-cases/add-new-step.png' alt=" " className="doc_img"/>
...
<img loading="lazy" src='/assets/images/test-manager/test-cases/save-test-case.png' alt=" "  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/manual_test_case_creation/executed_runs.png' alt=" " className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/manual_test_case_creation/planned_runs.png' alt=" " className="doc_img"/>
