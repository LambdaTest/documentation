...
<img loading="lazy" src='/assets/images/hyperexecute/features/rerun/1.png' alt="Image"  className="doc_img"/>
<br /><br />
...
<img loading="lazy" src='/assets/images/hyperexecute/features/rerun/2.png' alt="Image"  className="doc_img"/>
