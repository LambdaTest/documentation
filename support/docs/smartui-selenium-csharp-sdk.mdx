...
sidebarTitle: C#
description: In this documentation, learn how integrate your Selenium C# automated tests with <BrandName />'s SmartUI.
...
```bash
git clone https://github.com/<BrandName />/smartui-csharp-sample
