...
<Note>
**Note**: From November 2, 2020 onwards, we have deprecated our existing tunnel binary. In order to setup the new version, you can refer to [new tunnel binary for macOS](/support/docs/local-testing-macos/).
</Note>
