...
keywords: ["lambdatest", "web scanner", "overview", "visual testing", "accessibility testing"]
---
...
![Web Scanner Dashboard](/assets/images/web-scanner/web-scanner-dashboard.png)
...
![Accessibility Scan Example](/assets/images/web-scanner/accessibility-scan-example.png)
