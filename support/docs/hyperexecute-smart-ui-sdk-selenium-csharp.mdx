...
<a href="https://github.com/<BrandName />/hyperexecute-smartui-sdk-selenium-csharp" className="github__anchor"><img loading="lazy" src='/assets/images/icons/github.png' alt="Image" /> View on GitHub</a>
