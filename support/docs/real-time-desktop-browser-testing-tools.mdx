...
<img loading="lazy" src='/assets/images/real-time-testing/web-browser/screenshot.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/web-browser/recording.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/web-browser/gallery.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/web-browser/mark-bug.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/web-browser/resolution.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/web-browser/scaling.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/web-browser/ip-geolocation.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/web-browser/upload.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/web-browser/chrome-extension.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/web-browser/accessibility.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/web-browser/settings.png' alt="Image" className="doc_img"/>
 
## Switch
Efficiently switch between different devices, browsers, and their OS versions without ending the current test session.

<img loading="lazy" src='/assets/images/real-time-testing/web-browser/switch.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/web-browser/on-screen-keyboard.png' alt="Image" className="doc_img"/>

## End Session
Conclude your testing session by clicking on the End Session button.

<img loading="lazy" src='/assets/images/real-time-testing/web-browser/end-session.png' alt="Image" className="doc_img"/>
