...
sidebarTitle: TestNG
description: Your guide to running tests using TestNG on <BrandName />'s Selenium Grid of 3000+ real devices and desktop browsers.
keywords: ['java selenium', 'testng selenium', 'testng', 'testng tutorial', 'testng selenium framework', 'java selenium tutorial', 'java selenium webdriver', 'java selenium', 'java selenium testing']
...
In this topic, you will learn how to configure and run tests using **TestNG** on <BrandName />'s <a href="https://www.lambdatest.com/selenium-automation">Selenium testing cloud platform</a>.
...
All the code samples in this documentation can be found on **<BrandName />'s Github Repository**. You can either download or clone the repository to quickly run your tests. <a href="https://github.com/<BrandName />/Java-TestNG-Selenium" className="github__anchor"><img loading="lazy" src='/assets/images/icons/github.png' alt="Image" /> View on GitHub</a>
...
**Step 1:** Clone the <BrandName />’s [Java-TestNG-Selenium](https://github.com/<BrandName />/Java-TestNG-Selenium) repository and navigate to the code directory as shown below:

```bash
git clone https://github.com/<BrandName />/Java-TestNG-Selenium
...
<suite thread-count="3" name="LambaTestSuite" parallel="tests">
  ...
  <parameter name="platform" value="WIN8"/>
    <classes>
      <class name="<BrandName />.TestNGToDo"/>
    </classes>
  </test> {/* Test */}
