...
<a href="https://github.com/<BrandName />/k6-browser-tests-sample" className="github__anchor"><img loading="lazy"
<Warning>
src={require('../assets/images/icons/github.png').default} alt="Image"/> View on GitHub</a>
</Warning>
...
1. Clone the [k6-browser-tests-sample GitHub repository](https://github.com/<BrandName />/k6-browser-tests-sample) and
   switch to the cloned directory.

```sh
git clone https://github.com/TestMu AI/k6-browser-tests-sample.git
