...
keywords: ['LambdaTest automation','LambdaTest environment variables','LambdaTest setup']
...
<img loading="lazy" src='/assets/images/environment-variables/dashboard-access-key.webp' alt="Image" width="1919" height="878" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/environment-variables/environment-variable-2.webp' alt="Image" width="1363" height="544" className="doc_img"/>

**Step 2**: You will find your Username & Access Key.

<img loading="lazy" src='/assets/images/hyperexecute/knowledge-base/env-variable/environment-variables-3.webp' alt="Image" width="521" height="268" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/environment-variables/environment-variables-4.webp' alt="Image" width="1365" height="722" className="doc_img"/>
