---
title: "Generating Multiple Lighthouse Reports Using Lambda Hooks"
sidebarTitle: "Generate Multiple Lighthouse Reports"
keywords: ['generate lighthouse reports in selenium', 'generate lighthouse reports with lambda hooks', 'lighthouse reports lambdatest']
...
<img loading="lazy" src='/assets/images/uploads/lreports_se.png' alt="Image" width="1347" height="565" className="doc_img"/>