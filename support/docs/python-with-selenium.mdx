...
>**Note:** All the code samples in this documentation can be found in the [<BrandName />'s Repository on GitHub](https://github.com/<BrandName />/python-selenium-sample). You can either download or clone the repository to quickly run your tests.
...
**Step 1:** Clone the <BrandName />’s [python-selenium-sample repository](https://github.com/<BrandName />/python-selenium-sample) and navigate to the code directory as shown below:
```bash
git clone https://github.com/TestMu AI/python-selenium-sample
