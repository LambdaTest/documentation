...
description: In this documentation, learn how integrate your WebdriverIO automated tests with <BrandName />'s SmartUI.
...
```bash
git clone https://github.com/<BrandName />/smartui-wdio-sample
