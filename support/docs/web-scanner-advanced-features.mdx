...
keywords: ["lambdatest", "web scanner", "advanced features", "authentication", "basic auth", "form selectors", "dedicated proxy", "geolocation", "tunnel", "local testing"]
---
...
![Advanced Configurations for Visual Scan](/assets/images/web-scanner/visual-scan-advanced-settings.png)
...
![Login Configurations Modal](/assets/images/web-scanner/accessibility-scan-advanced-options.png)
