...
>**Note:** All the code samples in this documentation can be found in the [<BrandName />'s Repository on GitHub](https://github.com/<BrandName />/nightwatch-selenium-sample). You can either download or clone the repository to quickly run your tests.
...
**Step 1:** Clone the <BrandName />’s [nightwatch-selenium-sample repository](https://github.com/<BrandName />/nightwatch-selenium-sample) and navigate to the code directory as shown below:
```bash
git clone https://github.com/TestMu AI/nightwatch-selenium-sample
...
https://github.com/TestMu AI/nightwatch-selenium-sample/blob/master/tests/googleTest.js
```
...
https://github.com/TestMu AI/nightwatch-selenium-sample/blob/master/nightwatch.conf.js
```
<Warning>
