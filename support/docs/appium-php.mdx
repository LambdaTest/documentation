...
sidebarTitle: PHP
description: Now you can run your automation scripts using Appium with PHP on <BrandName /> online grid of 3000+ real desktop browsers and real operating systems.
