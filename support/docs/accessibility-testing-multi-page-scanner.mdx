...
![automation-dashboard](/assets/images/accessibility-testing/multi-page-scanner/1.png)
...
![automation-dashboard](/assets/images/accessibility-testing/multi-page-scanner/2.png)

### Review Your Issues

- This will list down all of the issues after scanning all the listed webpages.

![automation-dashboard](/assets/images/accessibility-testing/multi-page-scanner/3.png)

- You can also filter out your issues list by selecting any specific page.

![automation-dashboard](/assets/images/accessibility-testing/multi-page-scanner/4.png)
