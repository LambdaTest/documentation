---
title: "Running Protractor Framework Tests on HyperExecute"
sidebarTitle: "Protractor"
keywords: ['Protractor', 'Protractor selenium', 'Protractor JavaScript Selenium', 'Protractor automation testing', 'selenium webdriver Protractor', 'selenium Protractor testing tutorial', 'Protractor JavaScript Selenium framework', 'lambdatest Protractor', 'frameworks on lambdatest', 'hyperexecute', 'hyperexecute Protractor testing', 'hyperexecute automation testing', 'HyperExecute Selenium automation']
---
...
Download or Clone the code sample for the Protractor from the LambdaTest GitHub repository to run the tests on the HyperExecute.
...
<img loading="lazy" src="/assets/images/hyperexecute/frameworks/selenium/testng/cmd_1.png" alt="Protractor HyperExecute Terminal Logs" width="1920" height="868" className="doc_img"/>

<img loading="lazy" src="/assets/images/hyperexecute/frameworks/selenium/testng/cmd_2.png" alt="Protractor HyperExecute Terminal Logs" width="1920" height="868" className="doc_img"/>
