...
<img loading="lazy" src='/assets/images/hyperexecute/knowledge-base/test-chains/1.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/knowledge-base/test-chains/2.png' alt="Image" className="doc_img"/>
