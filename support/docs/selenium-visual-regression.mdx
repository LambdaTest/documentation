...
description: Master Selenium Visual Regression testing with <BrandName />. Detect visual deviations early in your web applications to ensure a seamless user experience.
...
1. Please clone the following sample Github repo (`https://github.com/<BrandName />/smartui-node-sample`).
