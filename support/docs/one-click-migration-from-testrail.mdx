...
<img loading="lazy" src='/assets/images/mobile-app-testing/csv-import/import-testrail-one.webp' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/necessary-details.webp' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/multiple-projects.webp' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/email-notification.webp' alt="Real "  className="doc_img" width="1366" height="629"/>

5. The email will contain a **GO TO TEST MANAGER** button, which redirects you to the project section. 

<img loading="lazy" src='/assets/images/mobile-app-testing/go-to-test-manager.webp' alt="Real "  className="doc_img" width="1366" height="629"/>

6. The imported project(s) will appear at the top, where you can click on it for a detailed project analysis. 

<img loading="lazy" src='/assets/images/mobile-app-testing/imported-projects.webp' alt="Real "  className="doc_img" width="1366" height="629"/>