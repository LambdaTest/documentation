...
<img loading="lazy" src='/assets/images/kane-ai/kaneai-author-app-test/author-app-one.png' alt="Image" />

**Step 2:** A modal would appear from the side. Upload the app you want to test. 
<img loading="lazy" src='/assets/images/kane-ai/kaneai-author-app-test/author-app-two.png' alt="Image"/>

**Step 3:** Choose your preferred device and the OS version.
<img loading="lazy" src='/assets/images/kane-ai/kaneai-author-app-test/author-app-three.png' alt="Image"/>

**Step 4:** You can also select advanced configurations from the Advanced Settings option. 
<img loading="lazy" src='/assets/images/kane-ai/kaneai-author-app-test/author-app-five.png' alt="Image"/>

**Step 5:** Once done, click on **Start Testing** to get started. 
<img loading="lazy" src='/assets/images/kane-ai/kaneai-author-app-test/author-app-four.png' alt="Image"/>
...
<img loading="lazy" src='/assets/images/kane-ai/kaneai-author-app-test/kaneai-app-test-authoring.png' alt="Image"/>
...
<img loading="lazy" src='/assets/images/kane-ai/kaneai-author-app-test/mobile-app-manual-interaction.png' alt="Image"/>
...
<img loading="lazy" src='/assets/images/kane-ai/kaneai-author-browser-tests/mobile-browser-save.png' alt="Image" />
...
<img loading="lazy" src='/assets/images/kane-ai/kaneai-author-app-test/app-test-summary.png'  alt="Image" />
