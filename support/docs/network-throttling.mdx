...
To configure network throttling in automation, we have used the [<BrandName /> TestNG GitHub repository](https://github.com/<BrandName />/Java-TestNG-Selenium) to run our automation tests. You would just have to define network throttle capabilities in your automation scripts.
