...
<img loading="lazy" src='/assets/images/mobile-app-testing/bulk_copy_testcases.jpeg' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/add_folder_bulk_action.jpeg' alt="Real "  className="doc_img" width="1366" height="629"/>

4. Add the Name of the Folder to be created.

<img loading="lazy" src='/assets/images/mobile-app-testing/add_folder_name_bulk_action.jpeg' alt="Real "  className="doc_img" width="1366" height="629"/>

5. After selecting or creating the target folder, click on the **Copy** button to complete the process.

<img loading="lazy" src='/assets/images/mobile-app-testing/added_folder_bulk_action.jpeg' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/bulk_copy_ack.jpeg' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/bulk_copy_res.jpeg' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/bulk_move_testcases.jpeg' alt="Real "  className="doc_img" width="1366" height="629"/>

2. In the next dropdown menu, select **Project** and **Target Folder** of your choice and click on **Move Test Cases**.

<img loading="lazy" src='/assets/images/mobile-app-testing/select_folder_bulk_move.jpeg' alt="Real "  className="doc_img" width="1600" height="723"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/bulk_move_ack.jpeg' alt="Real "  className="doc_img" width="1600" height="724"/>
