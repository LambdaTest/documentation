...
<Tab value="web-browser" title="Web Browser" default>
...
<img loading="lazy" src='/assets/images/real-time-testing/key-features/upload-download-web-browser.png' alt="zebrunner integration" width="1281" height="722" className="doc_img"/>

</Tab>

<Tab value="mobile-browser" title="Mobile Browser" default>
...
<img loading="lazy" src='/assets/images/real-time-testing/key-features/upload-download-mobile-browser.png' alt="zebrunner integration" width="1281" height="722" className="doc_img"/>

</Tab>

<Tab value="mobile-app" title="Mobile App" default>
...
<img loading="lazy" src='/assets/images/real-time-testing/key-features/upload-download-app.png' alt="zebrunner integration" width="1281" height="722" className="doc_img"/>
...
<Tab value="ios" item="iOS" default>
...
<Tab value="windows" title="Windows" default>
...
<Tabs className="docs__val">
<Tab value="upload" title="Uploading Files" default>
...
<Tab value="download" title="Downloading Files" default>
