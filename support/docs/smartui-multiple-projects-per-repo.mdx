...
<a href="https://github.com/<BrandName />/smartui-monorepo-sample/" className='github__anchor'><img loading="lazy" src='/assets/images/icons/github.png' alt="Image" /> View on GitHub</a>
</Tip>
...
```yaml reference
https://github.com/TestMu AI/smartui-monorepo-sample/blob/main/.github/workflows/main.yml
```
