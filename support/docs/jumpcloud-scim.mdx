...
- The SSO connection must be already established with <BrandName />. Learn how to [create a SSO Connection with <BrandName />](/support/docs/lambdatest-sso-self-serve).
...
- **Step 1:** Sign in to your <BrandName /> account. Don't have an account, [register for free](https://accounts.lambdatest.com/register).
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/1.png)

- **Step 2:** Head to **Settings** > **Organization Settings** from the dropdown.
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/2.png)
...
- **Step 3:** Go to <BrandName /> [Authentication & SSO settings](https://accounts.lambdatest.com/auth/sso) and click on Setup SSO. Head to the **Authentication and SSO** tab and click and copy the **SCIM Base URL and Bearer Token** option.
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/3.png)
...
- **Step 4:** Log in to JumpCloud. Go to [JumpCloud Admin Console](https://console.jumpcloud.com/login/admin). Log in with your admin credentials. Sign in to the Jump-cloud. Select SSO Applications, then select Get Started.
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/4.png)

- **Step 5:** Search for SCIM and then click on "**Create Custom Integration**" and then click next.
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/5.png)
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/6.png)

- **Step 6:** Check the box for "**Manage Single Sign-On (SSO)"** and then click "**Start**."
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/7.png)

- **Step 7:** Enter the name for **Display Label**, then click the **Save Application** and click  **configure Application**.
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/8.png)
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/9.png)

- **Step 8:** Go to <BrandName /> [**Authentication & SSO**](https://accounts.lambdatest.com/auth/sso) settings and click on **Setup SSO**.
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/10.png)

- Enter the **Connection Name** and Click on Add New Connection. and Select your **Identity Provider**.
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/11.png)
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/12.png)
...
- **Step 9:** Copy the required SSO details from <BrandName />, including:
  ...
  - Subject Name
  - Login URL
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/13.png)
...
- Copy the **Metadata URL** from JumpCloud.
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/14.png)
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/15.png)
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/16.png)
...
- **Step 12:** Go to <BrandName /> Dashboard and go **SSO connection**. Copy **Bearer Token** and **SCIM Base URL**.
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/17.png)

- **Step 13:**  Go **Identity Management** and paste **SCIM Base URL** and **Bearer Token**. and then click Save button.
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/18.png)
...
- **Step 14:** Enter email that does not exist on <BrandName /> platform and provide test email details, and click **Test Connection** and activate button.
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/19.png)
  ![jira-self-hosted-integration](/assets/images/lambdatest-scim/jumpcloud-scim/20.png)