...
﻿---
id: smart-ui-cypress
title: Getting started with SmartUI using Cypress On <BrandName />
sidebarTitle: Cypress
description: Master Visual UI Testing with Cypress on <BrandName /> Automation Cloud across 40+ browser versions through this comprehensive documentation.
...
```json title="/cypress-project/testmu ai-config.json"
{
  "lambdatest_auth": {
