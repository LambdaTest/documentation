---
title: "Running TestNG Framework Tests on HyperExecute"
sidebarTitle: "TestNG"
keywords: ['TestNG', 'TestNG selenium', 'TestNG Java Selenium', 'TestNG automation testing', 'selenium webdriver TestNG', 'selenium TestNG testing tutorial', 'TestNG Java Selenium framework', 'lambdatest TestNG', 'frameworks on lambdatest', 'hyperexecute', 'hyperexecute TestNG testing', 'hyperexecute automation testing', 'HyperExecute Selenium automation']
---
...
<img loading="lazy" src="/assets/images/hyperexecute/frameworks/selenium/testng/cmd_1.png" alt="TestNG HyperExecute Terminal Logs" width="1920" height="868" className="doc_img"/>

<img loading="lazy" src="/assets/images/hyperexecute/frameworks/selenium/testng/cmd_2.png" alt="TestNG HyperExecute Terminal Logs" width="1920" height="868" className="doc_img"/>
...
```yaml HyperExecute AutoSplit YAML
...
<img loading="lazy" src="/assets/images/hyperexecute/frameworks/selenium/testng/dashboard2.png" alt="automation-dashboard" width="1920" height="868" className="doc_img"/>
