...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-browser/device-control.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-browser/screenshot.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-browser/recordings.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-browser/gallery.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-browser/mark-bug.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-browser/ip-geolocation.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-browser/network-throttling.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-browser/settings.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-browser/switch.png' alt="Image" className="doc_img"/>

## End Session
By clicking on the end session button, you can close your current test session.

<img loading="lazy" src='/assets/images/real-time-testing/mobile-browser/end-session.png' alt="Image" className="doc_img"/>
