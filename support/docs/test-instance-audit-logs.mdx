...
<img loading="lazy" src='/assets/images/mobile-app-testing/test-runs/view_execution_logs.png' alt="Real "  className="doc_img"/>

<img loading="lazy" src='/assets/images/mobile-app-testing/test-runs/audit_logs.png' alt="Real "  className="doc_img"/> 
...
<img loading="lazy" src='/assets/images/mobile-app-testing/test-runs/audit_logs_step_preview.png' alt="Real "  className="doc_img"/>
