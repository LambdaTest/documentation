...
<img loading="lazy" src='/assets/images/hyperexecute/cloud/azure/jumphost/1.png' alt="Image"  className="doc_img"/>

**Step 2:** Go to the **search bar** on the top of your screen and search for your managed applications. 

<img loading="lazy" src='/assets/images/hyperexecute/cloud/azure/jumphost/2.png' alt="Image"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/cloud/azure/jumphost/3.png' alt="Image"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/cloud/azure/jumphost/4.png' alt="Image"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/cloud/azure/jumphost/5.png' alt="Image"  className="doc_img"/>
