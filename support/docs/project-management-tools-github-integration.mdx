...
hide_title: true
sidebarTitle: GitHub
description: <BrandName /> provides integrations with GitHub to help you log bugs directly from the middle of your test session on <BrandName /> to your GitHub repository.
