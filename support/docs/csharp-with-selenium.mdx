...
<a href="https://github.com/<BrandName />/CSharp-Selenium-Sample" className="github__anchor"><img loading="lazy" src='/assets/images/icons/github.png' alt="Image" /> View on GitHub</a>
...
Clone the [<BrandName /> CSharp Selenium GitHub repository](https://github.com/<BrandName />/CSharp-Selenium-Sample) and navigate to the code directory.

```
git clone https://github.com/TestMu AI/CSharp-Selenium-Sample
        ...
        class SingleTest
        {
            public static void execute()
            {
                ...
                try
                {
                    ...
                    driver.Navigate().GoToUrl("https://testmu ai.github.io/sample-todo-app/");
