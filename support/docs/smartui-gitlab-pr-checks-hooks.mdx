...
![GitLab integration setup in LambdaTest](/assets/images/smart-visual-testing/ci-cd-integration/gitlab/1.png)
...
![GitLab CI/CD Variables configuration](/assets/images/smart-visual-testing/ci-cd-integration/gitlab/2.png)
...
![GitLab Pipelines page showing SmartUI test results](/assets/images/smart-visual-testing/ci-cd-integration/gitlab/pipeline_gitlabtab.png)
...
![GitLab merge request showing SmartUI PR check status](/assets/images/smart-visual-testing/ci-cd-integration/gitlab/Gitlab_pr_check_dashboard.png)
