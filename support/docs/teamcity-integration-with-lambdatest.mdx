...
![Create a new project on TeamCity](/assets/images/teamcity-integration/teamcity.webp)
...
![Create a new VCS root using the below form](/assets/images/teamcity-integration/teamcity-1.webp)
...
![Now, create a build configuration](/assets/images/teamcity-integration/teamcity-2.webp)

**Step 7:** Go to Build Step page and add a build step as below.

![Go to Build Step page](/assets/images/teamcity-integration/teamcity-3.webp)
...
![Create two environment variables](/assets/images/teamcity-integration/teamcity-4.webp)
...
![Go to Project Dashboard and Run your project](/assets/images/teamcity-integration/teamcity-5.webp)
