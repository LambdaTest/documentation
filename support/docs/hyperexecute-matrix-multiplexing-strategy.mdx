...
<img loading="lazy" src='/assets/images/hyperexecute/features/matrix/hyp_matrix.png' alt="Image"  className="doc_img" width="1232" height="534" style={{ width:'700px', height:'auto'}}/>
