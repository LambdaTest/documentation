...
hide_title: false
sidebarTitle: Accessibility Web Score
description: Learn about <BrandName />'s Accessibility Score - a unified metric that measures the accessibility health of your website or application workflow through severity-weighted calculations.
keywords:
- accessibility score
