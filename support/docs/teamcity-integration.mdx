...
> Clone our [GitHub repository for TeamCity](https://github.com/<BrandName />/protractor-selenium-teamcity-sample.git) to execute your first parallel test of TeamCity + <BrandName /> Integration.
