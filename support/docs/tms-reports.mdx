...
<img loading="lazy" src='/assets/images/mobile-app-testing/Reports/Reports-listing-page.png' alt="Reports Overview" className="doc_img"/>

There are two type of Reports that you can create here:

<img loading="lazy" src='/assets/images/mobile-app-testing/Reports/select-report-type.png' alt="Reports Overview" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Reports/runs-based-execution-report.png' alt="Reports Overview" className="doc_img"
  style={{ width: '60%', height: 'auto'}}/>

### 2. Filter By Date: 
This option allows you to see all test results that were generated within a specific date range.

<img loading="lazy" src='/assets/images/mobile-app-testing/Reports/date-based-execution-report.png' alt="Reports Overview" className="doc_img"
  style={{ width: '60%', height: 'auto'}}/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Reports/execution-report.png' alt="Reports Overview" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/Reports/traciability-report.png' alt="Reports Overview" className="doc_img"/>

The report data can be filtered using Test, Issue, and Run metadata.

<img loading="lazy" src='/assets/images/mobile-app-testing/Reports/traciablity-filters.png' alt="Reports Overview" className="doc_img"/>
