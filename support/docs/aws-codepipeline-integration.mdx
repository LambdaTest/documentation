...
* A GitHub repository. Here is our sample GitHub repository for [AWS CodePipeline](https://github.com/<BrandName />/protractor-selenium-awscodepipeline-sample.git).
...
>**Note:** Find the sample code from our [GitHub repository for AWS CodePipeline](https://github.com/<BrandName />/protractor-selenium-awscodepipeline-sample).
