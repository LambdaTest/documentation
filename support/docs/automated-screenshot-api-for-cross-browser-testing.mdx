...
keywords: ["automated screenshot api", "automated screenshot generation", "screenshot api", "automated screenshots", "screenshot testing", "bulk screenshot testing"]
---
...
<a href="/support/api-doc/projects/create-project">Open API Document For Automated Screenshot Testing</a>
</div>
