...
<video className="right-side" width="100%" controls>
...
<iframe 
  src="https://app.storylane.io/demo/nghrqs7qgczc?embed=inline" 
  title="Projects Demo" 
...
<CardGroup cols={2}>
  <Card title="Tosca using Commander" href="/support/docs/tosca-integration-with-hyperexecute-using-commander/">
    Optimize and accelerate end-to-end testing for your entire digital landscape using Tosca.
  </Card>

  <Card title="Tosca using DEX" href="/support/docs/tosca-integration-with-hyperexecute-using-dex/">
    Perform end-to-end testing using Tosca DEX with HyperExecute.
  </Card>

  <Card title="Tosca for SAP" href="/support/docs/tosca-integration-with-hyperexecute-for-sap/">
    Use Tosca for SAP to integrate with HyperExecute.
  </Card>

  <Card title="JMeter" href="/support/docs/hyperexecute-run-jmeter-tests/">
