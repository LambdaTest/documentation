...
<img loading="lazy" src='/assets/images/mobile-app-testing/generate_with_ai_button.png' alt="generate-with-ai" width="1347" height="616"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/first_prompt_tets_cases_generation.png' alt="first_prompt_tets_cases_generation" width="1347" height="616"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/recording_button_test_cases_generation.png' alt="recording_button_test_cases_generation" width="1347" height="616"  className="doc_img"/>

- Click the tick icon to confirm, or the cross to discard.
<img loading="lazy" src='/assets/images/mobile-app-testing/test_cases_generation_through_recording.png' alt="test_cases_generation_through_recording" width="1347" height="616"  className="doc_img"/>

#### Upload Files: 
- Click on the **pin** icon 📎, then select `Upload from device`.
- You can select a maximum of 10 files from your device.

<img loading="lazy" src='/assets/images/mobile-app-testing/upload_from_device_test_cases_generation.png' alt="upload_from_device_test_cases_generation" width="1347" height="616"  className="doc_img"/>

- Uploaded files will appear within the input box.

<img loading="lazy" src='/assets/images/mobile-app-testing/uploaded_files_test_cases_generation.png' alt="uploaded_files_test_cases_generation" width="1347" height="616"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/link_jira_test_cases_generation.png' alt="link_jira_test_cases_generation" width="1347" height="616"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/jira_id_test_cases_generation.png' alt="jira_id_test_cases_generation" width="1347" height="616"  className="doc_img"/>

- The linked issue will then appear inside the input box.

<img loading="lazy" src='/assets/images/mobile-app-testing/linked_jira_view_test_cases_generation.png' alt="linked_jira_view_test_cases_generation" width="1347" height="616"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/ai_thinking_suggestions_test_cases_generation.png' alt="ai_thinking_suggestions_test_cases_generation" width="1347" height="616"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/ai_suggested_testcases.png' alt="ai_suggested_testcases" width="1347" height="616"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/edit_suggested_test_cases.png' alt="edit_suggested_test_cases" className="doc_img"/>

<img loading="lazy" src='/assets/images/mobile-app-testing/edit_suggested_test_cases_steps.png' alt="edit_suggested_test_cases_steps" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/edit_test_cases_generation_prompt.png' alt="edit_test_cases_generation_prompt" width="1347" height="616"  className="doc_img"/>

Click on regenerate after updating the input.

<img loading="lazy" src='/assets/images/mobile-app-testing/regenerate_test_cases_generation.png' alt="regenerate_test_cases_generation" width="1347" height="616"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/save_generated_test_cases.png' alt="save_generated_test_cases" width="1347" height="616"  className="doc_img"/>

<img loading="lazy" src='/assets/images/mobile-app-testing/test_cases_generation_ack.png' alt="test_cases_generation_ack" width="1347" height="616"  className="doc_img"/>
