...
keywords: ['command annotations lambdatest', 'command annotations']
...
<img loading="lazy" src='/assets/images/command-annotations/com_ano_db.png' alt="command annotations" width="2560" height="976" className="doc_img"/>
