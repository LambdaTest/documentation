...
**`mode: remote`** <span style={{border: '1px solid #bf3989', color: '#bf3989', borderRadius: '1em', padding: '0.1em 0.5em', fontWeight: 'bold', fontSize: '0.8em', marginLeft: '0.5em', verticalAlign: 'middle', display: 'inline-block'}}>NEW</span>
...
<img loading="lazy" src='/assets/images/hyperexecute/yaml/project.png' alt="project-hyperexecute" className="doc_img "/><br/><br/>
...
<img loading="lazy" src='/assets/images/hyperexecute/yaml/scenario-1.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/yaml/scenario-2.jpeg' alt="Image" className="doc_img"/>
...
The value for `${name}` in the above command can be passed through the vars command either by the [CLI](/support/docs/hyperexecute-cli-run-tests-on-hyperexecute-grid/#--vars) as mentioned below or through [YAML](/support/docs/deep-dive-into-hyperexecute-yaml/#vars).
  ...
  <img loading="lazy" src='/assets/images/hyperexecute/getting_started/guided-walkthrough/17.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/yaml/testRunnerExecutor.png' alt="Image" className="doc_img"/>
