...
<iframe width="100%" height="400px" src="https://www.youtube.com/embed/WWLAeftaj-4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
-   Ensure that you have integrated Katalon Studio with <BrandName />. Follow the steps on this [page](/support/docs/katalon-integration-with-lambdatest) to do so.
...
1. You must generate a command from Katalon to run it through the command line. To do so:
   ...
   <img loading="lazy" src='/assets/images/hyperexecute/integration/products/katalon/katalon1.png' alt="Image"  className="doc_img"/>
   ...
   <img loading="lazy" src='/assets/images/hyperexecute/integration/products/katalon/katalon2.png' alt="Image"  className="doc_img"/>
