...
<Tabs className="docs__val">
  <Tab title="Android">
    ...
    https://github.com/LambdaTest/TestMu AI-HyperExecute-Playwright-Appium-Sample/blob/main/playwright-android-real-device.js
    ```
  </Tab>

  <Tab title="iOS">
    ```javascript title="playwright-ios-real-device.js" reference
    https://github.com/LambdaTest/TestMu AI-HyperExecute-Playwright-Appium-Sample/blob/main/playwright-ios-real-device.js
    ```
  </Tab>
</Tabs>
...
<Tabs className="docs__val">
  <Tab title="Android">
    ...
    https://github.com/LambdaTest/TestMu AI-HyperExecute-Playwright-Appium-Sample/blob/main/hyperexecute_android.yaml
    ```
  </Tab>

  <Tab title="iOS">
    ```yaml title="hyperexecute_ios.yaml" reference
    https://github.com/LambdaTest/TestMu AI-HyperExecute-Playwright-Appium-Sample/blob/main/hyperexecute_ios.yaml
    ```
  </Tab>
</Tabs>
