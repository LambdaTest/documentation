...
#### 2. **I am not able to open HyperExecute on MacOS because the developer is not verified. What do I do?**
  ...
  <img loading="lazy" src='/assets/images/hyperexecute/faq/he-faq-1.png' alt="Image"  className="doc_img"/>
...
#### 3. **Is there a way where I can follow all of the steps in my test run on HyperExecute?**
  ...
  <img loading="lazy" src='/assets/images/hyperexecute/faq/cli-log.png' alt="Image"  className="doc_img"/>
