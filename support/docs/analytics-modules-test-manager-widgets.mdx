...
The Test Manager Widgets module is currently in  <span className="border-2 border-[#bf3989] text-[#bf3989] rounded-full px-2 py-0 font-bold text-[0.8em] mx-[0.2em] align-middle inline-block text-xs">BETA</span>. If you have any feedback or suggestions, please feel free to reach out to us at [support@testmu.ai](mailto:support@testmu.ai).
</Info>


<img loading="lazy" src='/assets/images/analytics/tms-widgets-dashboard.webp' alt="Test Manager Snapshot" width="768" height="373" className="doc_img"/>
