...
description: Use <BrandName /> Accessibility DevTools to detect and report accessibility issues with automation, following WCAG guidelines, in your cypress tests for version 9 and above
...
<a href="https://github.com/testmu ai/<BrandName />-accessibility-cypress-v9" target="_blank" className="github__anchor"><img loading="lazy" src='/assets/images/icons/github.png' alt="Image" /> View on GitHub</a>
</Tip>

Configure the desired capabilities based on your test requirements. For example:

```yaml reference title="testmu ai-config.json"
  https://github.com/<BrandName />/testmu ai-accessibility-cypress-v9/blob/main/testmu ai-config.json
```
