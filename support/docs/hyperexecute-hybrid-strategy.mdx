...
<img loading="lazy" src='/assets/images/hyperexecute/features/hybrid/hyp_hybrid.png' alt="Image"  className="doc_img" width="1232" height="534" style={{ width:'700px', height:'auto'}}/>
