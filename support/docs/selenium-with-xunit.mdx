...
```
git clone https://github.com/TestMu AI/CSharp-xUnit-Selenium
...
3. Navigate to *[config.json](https://github.com/<BrandName />/CSharp-xUnit-Selenium/blob/master/XUnit-<BrandName />/config.json/)* using VS Code. Replace this code in the *config.json* file in your project.
