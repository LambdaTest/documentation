...
keywords: ['cypress cli', 'cypress cli commands', 'cypress command line', 'cypress lambdatest']
---
...
<img loading="lazy" src='/assets/images/cypressten/1.PNG' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/cypressten/2.png' alt="Image" width="710" height="224" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/cypressten/build_stop.png' alt="Image" width="710" height="224" className="doc_img"/>

- `--session_id`

<img loading="lazy" src='/assets/images/cypressten/id_build_stop.png' alt="Image" width="710" height="224" className="doc_img"/>