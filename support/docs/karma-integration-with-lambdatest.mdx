---
title: "Karma Test Runner Integration With TestMu AI"
sidebarTitle: "Karma Test Runner"
keywords: ['karma selenium', 'karma integration with lambdatest', 'lambdatest integrations', 'testacular', 'lambdatest app marketplace']
...
---
<Note>
All the code samples in this documentation can be found in the [Karma LambdaTest Repository on <span style={{display: 'inline-block', verticalAlign: 'middle'}}><img src='/assets/images/GitHub_icon/github-icon.webp' alt="Image" width="25" height="25" style={{display: 'inline', verticalAlign: 'middle'}} /></span> GitHub](https://github.com/LambdaTest/angular-karma-sample). You can either download or clone the repository to quickly run your tests.
</Note>
