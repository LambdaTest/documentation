...
`git clone https://github.com/TestMu AI/angular-karma-sample && cd angular-karma-sample`
...
Below is a sample config file for integrating Karma test runner with <BrandName />. You can use the sample file to test your own automation test suite by replacing the environment variables according to your need. All the code used for the demonstration of this topic can be find in our [GitHub repository for Karma](https://github.com/<BrandName />/angular-karma-sample).
