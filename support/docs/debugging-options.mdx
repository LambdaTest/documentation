---
title: "Debugging Options for Automation Testing"
sidebarTitle: "Debugging Options"
keywords: ['debug log options', 'debugging options', 'debugging options lambdatest', 'debugging options automation testing', 'debugging options selenium testing', 'debugging options appium testing']
---
---
