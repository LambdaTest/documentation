...
![](/assets/images/accessibility-testing/schedule-scan/6.png)
...
![](/assets/images/accessibility-testing/schedule-scan/7.png)

<Warning> Once the changes are saved, the updated scan name and schedule will reflect in the Scheduled Tests section. The next scan on date and time will be automatically adjusted based on the new recurrence settings.</Warning>
