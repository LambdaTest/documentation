...
sidebarTitle: LambdaTest Azure DevOps App
...
<img loading="lazy" src='/assets/images/test-manager-ado-app/1-search-app-ado-marketplace.png' alt="Search <BrandName /> App in Azure DevOps Marketplace" className="doc_img" width="1366" height="629"/>

<img loading="lazy" src='/assets/images/test-manager-ado-app/2-install-app.png' alt="Install <BrandName /> Azure DevOps App" className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/test-manager-ado-app/3-choose-organization.png' alt="Choose Azure DevOps Organization" className="doc_img" width="1366" height="629"/>

<img loading="lazy" src='/assets/images/test-manager-ado-app/4-final-screen.png' alt="Installation Complete Screen" className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/test-manager-ado-app/5-authenticate-with-credentials.png' alt="Authenticate with <BrandName /> Credentials" className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/test-manager-ado-app/6-link-test-case.png' alt="Link Test Cases to Work Item" className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/test-manager-ado-app/7-search-test-case.png' alt="Search and Select Test Cases" className="doc_img" width="1366" height="629"/>

Once linked, the Test Case will be visible in the Test Cases section.

<img loading="lazy" src='/assets/images/test-manager-ado-app/8-view-linked-test-case.png' alt="View Linked Test Cases" className="doc_img" width="1366" height="629"/>

6. Go to **Execution History** to view all the executions of the test cases that are linked to the Azure DevOps work item.

<img loading="lazy" src='/assets/images/test-manager-ado-app/9-view-execution-history.png' alt="View Test Case Execution History" className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/test-manager-ado-app/10-create-test-cases.png' alt="Create New Test Cases" className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/test-manager-ado-app/enter-input-requirements.png' alt="Enter Input Requirements for AI Generation" className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/test-manager-ado-app/11-generate-with-ai.png' alt="AI Generated Test Cases Review" className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/test-manager-ado-app/12-test-cases-post-generation.png' alt="View Saved Test Cases After Generation" className="doc_img" width="1366" height="629"/>
