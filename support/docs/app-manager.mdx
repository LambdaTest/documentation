...
keywords: ['lambdaTest', 'testmu ai app manager', 'mobile app version control', 'manage mobile app builds', 'Accessibility Testing Settings', 'TestMu AI app storage', 'test .apk .aab .ipa files']
---
...
<img loading="lazy" src='/assets/images/real-device-app-testing/APP_MANAGER_CTA.png' className="doc_img"/>

**Step 3:** This will open the **App Manager** in a new tab. 
<img loading="lazy" src='/assets/images/real-device-app-testing/APP_MANAGER_MAIN_SCREEN.png' className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/APP_MANAGER_FILE_UPLOAD.png' className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/APP_MANAGER_FILTER_SEARCH_BAR.png' className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/APP_MANAGER_APP_CARD.png' className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/APP_MANAGER_VERSION_CONTROL.png' className="doc_img"/>
---
...
<img loading="lazy" src='/assets/images/real-device-app-testing/App_Manager_r1.png' className="doc_img"/>
- Inside Version Details, you’ll see an option to enter release notes.
<img loading="lazy" src='/assets/images/real-device-app-testing/App_Manager_r2.png' className="doc_img"/>
- Once added, a notes icon appears on the version. On hover, the release note is shown directly from the App Card. 
<img loading="lazy" src='/assets/images/real-device-app-testing/App_Manager_r3.png' className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/APP_MANAGER_RUN_TEST.png' className="doc_img"/>
