...
<img loading="lazy" src='/assets/images/hyperexecute/features/artifacts-reports/reports.gif' alt="Image"  className="doc_img"/>

Here is the sample report generated.

<img loading="lazy" src='/assets/images/hyperexecute/features/artifacts-reports/report4.png' alt="Image"  className="doc_img"/>
