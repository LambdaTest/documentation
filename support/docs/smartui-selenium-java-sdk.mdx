...
sidebarTitle: Java
description: In this documentation, learn how integrate your Selenium Java automated tests with <BrandName />'s SmartUI.
...
```bash
git clone https://github.com/<BrandName />/smartui-java-testng-sample
```
