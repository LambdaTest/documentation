...
![cmd](/assets/images/smart-visual-testing/github-app-landing.png)

3. Click on the `OAuth` as your preferred authentication.
4. Click on **Install**.

![cmd](/assets/images/smart-visual-testing/smartui-github-integration.png)
...
![cmd](/assets/images/smart-visual-testing/github-app-installed.png)
...
![cmd](/assets/images/smart-visual-testing/github-app-sample.png)

## GitHub App Feedback State

Here is an example of **Successful** feedback app state:
![cmd](/assets/images/smart-visual-testing/approved-state-1.png)

Here is an example of **Failed** feedback app state:
![cmd](/assets/images/smart-visual-testing/failed-state-1.png)
