---
title: "Migrate from SauceLabs to HyperExecute"
...
<img loading="lazy" src='/assets/images/hyperexecute/knowledge-base/sl_hyp_migration/1.png' alt="automation-dashboard"  width="1920" height="868" className="doc_img"/>
