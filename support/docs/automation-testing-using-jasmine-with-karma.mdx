...
* * *
You need to clone our [GitHub repository](https://github.com/<BrandName />/protractor-selenium-sample) which demonstrates a [sample of Karma-Jasmine](https://github.com/<BrandName />/karma-jasmine-sample).
...
* * *
Navigate to the directory where you cloned the [sample of Karma-Jasmine](https://github.com/<BrandName />/karma-jasmine-sample) and run the following command.
