---
title: "Python with Selenium: Tutorial to Run Your First Test on TestMu AI"
sidebarTitle: "Python"
...
---
This post will help you in getting started with configuring and running your Python-based automation test scripts on [TestMu AI Selenium cloud platform](https://www.lambdatest.com/selenium-automation).  
...
<Note>
**Note:** All the code samples in this documentation can be found in the [TestMu AI's Repository on GitHub](https://github.com/LambdaTest/python-selenium-sample). You can either download or clone the repository to quickly run your tests.
</Note>
...
**Step 1:** Clone the TestMu AI [python-selenium-sample repository](https://github.com/LambdaTest/python-selenium-sample) and navigate to the code directory as shown below:
```bash
