...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-app/device-control.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-app/app-controls.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-app/screenshot.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-app/recording.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-app/gallery.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-app/mark-bug.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-app/ip-geolocation.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-app/gps-geolocation.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-app/network-throttling.png' alt="Image" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-time-testing/mobile-app/settings.png' alt="Image" className="doc_img"/>
 
## Switch
Easily switch between different devices, browsers, and OS versions without ending your current test session.

<img loading="lazy" src='/assets/images/real-time-testing/mobile-app/switch.png' alt="Image" className="doc_img"/>

## End Session
By clicking on the end session button, you can close your current test session.

<img loading="lazy" src='/assets/images/real-time-testing/mobile-app/end-session.png' alt="Image" className="doc_img"/>
