...
<img loading="lazy" src='/assets/images/debug-espresso-test/5.png' alt="Image" width="1347" Height="610" className="doc_img"/> <br />
...
<img loading="lazy" src="/assets/images/debug-espresso-test/4.png" alt="Image" width="1347" Height="610" className="doc_img"/> <br />
