...
<video
  ...
  src="../assets/videos/hyperexecute/integration/products/slack/1.mp4"
></video>
...
<video
  controls
  className="w-full aspect-video rounded-xl"
  src="../assets/videos/hyperexecute/integration/products/slack/2.mp4"
></video>
...
<video
  controls
  className="w-full aspect-video rounded-xl"
  src="../assets/videos/smart-ui/slack-integration/slack-integration.mp4"
></video>

- Once you save that configuration, you will start receiving the custom notifications in Slack!

![add slack-notification](/assets/videos/smart-ui/slack-integration/slack-notification.png)
...
<video
  controls
  className="w-full aspect-video rounded-xl"
  src="../assets/videos/hyperexecute/integration/products/slack/4.mp4"
></video>