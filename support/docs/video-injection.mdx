...
description: Inject video content in your tests with <BrandName /> to simulate video inputs for automated testing, enhancing your app's multimedia capabilities.
