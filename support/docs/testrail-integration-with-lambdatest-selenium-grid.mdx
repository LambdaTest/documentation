...
2. Project Dependencies
    ...
    * Clone our [GitHub repository for Selenium & TestRail](https://github.com/<BrandName />/Java-TestNG-Selenium-TestRail).
...
***
**Step 1:**  Clone our [GitHub repository for Selenium & TestRail](https://github.com/<BrandName />/Java-TestNG-Selenium-TestRail).
