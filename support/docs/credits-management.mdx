...
<BrandName /> supports a **credit management system** as an add‑on over your
active subscriptions for <BrandName /> products. Many products include
additional **AI features** that are powered by credits. This guide explains how
credits work, how to view usage, and how admins can control consumption.
...
<BrandName /> **SmartUI Visual AI** simulates human perception for visual
regression. Rather than flagging every pixel change, it highlights **meaningful,
human‑relevant** differences between baseline and new screenshots. [Learn
more](/support/docs/smartui-visual-ai/).
...
<Warning> This ensures fair usage—you are charged only for **actual output** produced by the AI.</Warning>

---

## FAQs
<Accordion title="**Q: What happens when my credits run out?**">
...
<Accordion title="**Q: Who can view balances and transactions?**">

Users with the **Admin** role in your <BrandName /> organization.
</Accordion>

<Accordion title="**Q: Do unused credits expire?**">
...
<Accordion title="**Q: Why were credits refunded after generation?**">

When fewer scenarios than the selected Max Scenarios are generated, the difference is **credited back automatically**.
</Accordion>

<Accordion title="**Q: Can I cap my organization’s usage?**">

Yes, set **Soft** and **Hard** limits (Admins only).
</Accordion>

<Accordion title="**Q: Does the platform offer AI FinOps tools to control and manage AI testing costs?**">
