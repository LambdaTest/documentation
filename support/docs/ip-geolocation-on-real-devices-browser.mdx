...
<img loading="lazy" src='/assets/images/real-device-browser-testing/Real_device_browser_selection.jpg' className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-browser-testing/Real_device_Browser_geolocation.jpg' className="doc_img"/>
