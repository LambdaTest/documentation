...
<img loading="lazy" src="/assets/images/hyperexecute/frameworks/Detox/Detox_cmd.png" alt="TestNG HyperExecute Terminal Logs" width="1920" height="868" className="doc_img"/>
...
<img loading="lazy" src="/assets/images/hyperexecute/frameworks/Detox/Detox_dashboard.png" alt="TestNG HyperExecute Terminal Logs" width="1920" height="868" className="doc_img"/>
...
For any query or doubt, please feel free to contact us via <span className="doc__lt" onClick={() => window.openLTChatWidget()}>**24×7 chat support**</span> or you can also drop a mail to **support@testmu.ai**.
</Note>