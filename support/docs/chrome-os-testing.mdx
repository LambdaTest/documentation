...
<Columns cols={2}>
  <Card title="ChromeOS Web Browser Testing" icon="panel-left-close" href="/support/docs/hyperexecute-running-your-first-job/">
    Guidebook about the features offered for testing your webapps in ChromeOS
  </Card>
  <Card title="ChromeOS App Testing" icon="panel-right-close" href="/support/docs/hyperexecute-cli-run-tests-on-hyperexecute-grid/">
