...
>**Note:** All the code samples in this documentation can be found in the [Behat <BrandName /> Repository on  GitHub](https://github.com/<BrandName />/behat-selenium-sample). You can either download or clone the repository to quickly run your tests.
...
**Step 1:** Clone the <BrandName />’s [Behat-Selenium-sample repository](https://github.com/<BrandName />/behat-selenium-sample) and navigate to the code directory as shown below:
```bash
git clone https://github.com/TestMu AI/behat-selenium-sample
