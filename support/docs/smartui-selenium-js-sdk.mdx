...
description: In this documentation, learn how integrate your Selenium JavaScript automated tests with <BrandName />'s SmartUI.
...
```bash
git clone https://github.com/<BrandName />/smartui-node-sample
