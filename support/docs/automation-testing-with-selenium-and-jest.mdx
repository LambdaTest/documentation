...
>**Note:** All the code samples in this documentation can be found in the [<BrandName />'s Repository on GitHub](https://github.com/<BrandName />/jest-selenium-webdriver-sample). You can either download or clone the repository to quickly run your tests.
...
**Step 1:** Clone the <BrandName />’s [jest-selenium-webdriver-sample repository](https://github.com/<BrandName />/jest-selenium-webdriver-sample) and navigate to the code directory as shown below:
```bash
git clone https://github.com/TestMu AI/jest-selenium-webdriver-sample
...
describe('webdriver', () => {
  ...
  beforeAll(async () => {
    ...
    await driver.get(`https://testmu ai.github.io/sample-todo-app/`);
  }, 30000);
