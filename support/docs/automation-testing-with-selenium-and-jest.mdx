---
title: "Jest with Selenium: Tutorial to Run Your First Test on LambdaTest"
sidebarTitle: "Jest Library"
keywords: ['jest selenium', 'jest automation', 'selenium javascript', 'jest testing tutorial', 'javascript selenium framework']
---
