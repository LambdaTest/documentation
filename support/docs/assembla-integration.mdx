...
keywords: [ "Lambdatest integrations", "push issues to clubhouse", "free cross browser testing tool", "cross platform testing tools", "check browser compatibility online", "Lambdatest assembla integration", "integrate assembla with Lambdatest", "create issue in assembla from Lambdatest", "assembla integration with Lambdatest", "create assembla issues from Lambdatest", "bug tracking tools", "project management tools" ]
---
...
<Info> Assembla Integration with Lambdatest is available for freemium as well as premium plan.</Info>
...
<video
  ...
  src="/assets/images/integrations/assembla/1.mp4"
></video>
...
<Info>
 ...
 ![assembla](/assets/images/integrations/assembla/2.png)
...
<video
  controls
  className="w-full aspect-video rounded-xl"
  src="/assets/images/integrations/assembla/3.mp4"
></video>
...
<video
  controls
  className="w-full aspect-video rounded-xl"
  src="/assets/images/integrations/assembla/4.mp4"
></video>
