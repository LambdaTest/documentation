...
>**Note:** All the code samples in this documentation can be found in the [<BrandName />'s Repository on GitHub](https://github.com/<BrandName />/protractor-selenium-sample). You can either download or clone the repository to quickly run your tests.
...
**Step 1:** Clone the <BrandName />’s [protractor-selenium-sample repository](https://github.com/<BrandName />/protractor-selenium-sample) and navigate to the code directory as shown below:
```bash
git clone https://github.com/TestMu AI/protractor-selenium-sample
...
describe('Add todo Lists', function () {
    ...
    it('Add Customer Test', function () {
        ...
        browser.get('https://testmu ai.github.io/sample-todo-app/');
