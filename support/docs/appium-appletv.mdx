...
keywords: ['python appium', 'appletv', 'python appium tutorial', 'real devices', 'lambdatest cloud platform', 'app automation', 'real time testing', 'appium automation', 'apple tv automation', 'tvos testing']
---
...
<GitHubButton url="https://github.com/LambdaTest/LT-appium-appletv" />
</Check>
...
- If you do not have any **.ipa** file, you can run your sample tests on LambdaTest by using our sample 🔗 [AppleTV app](https://prod-mobile-artefacts.lambdatest.com/assets/docs/apple-tv-sample-app.ipa).
