...
keywords: [ "sso", "lambdatest sso", "oidc", "openid connect", "identity provider", "managed sso", "azure ad", "google workspace", "okta" ]
---
...
<Note> **Note**: If you don't have SSO enabled for your <BrandName /> organization, please contact our support team at [support@testmu.ai](mailto:support@testmu.ai) </Note>
...
![Azure App Registration](/assets/images/lambdatest-sso-oidc/app-registration.png)
...
![Azure App Registration](/assets/images/lambdatest-sso-oidc/app-registration-2.png)
...
![Azure App Client Register](/assets/images/lambdatest-sso-oidc/app-client-secret-create.png)

3. **Copy Secret Value**: 
   - **Important**: Copy the secret value immediately - it won't be shown again
   - Store this securely as you'll need it for <BrandName /> configuration

![Azure Client Secret](/assets/images/lambdatest-sso-oidc/app-client-secret.png)

<Warning> **Important**: Store the client secret securely as you'll need it for <BrandName /> configuration. Most providers only show the secret once. </Warning>
...
![Azure Redirect URI](/assets/images/lambdatest-sso-oidc/app-redirect.png)
...
![Azure Metadata URL](/assets/images/lambdatest-sso-oidc/app-oidc-metadata.png)

<Warning> **Verify Well-Known URL**: Test the URL in your browser to ensure it returns valid JSON configuration. </Warning>
