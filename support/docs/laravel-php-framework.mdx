...
>**Note:** All the code samples in this documentation can be found in the [<BrandName />'s Repository on  GitHub](https://github.com/<BrandName />/php-laravel-dusk-todo). You can either download or clone the repository to quickly run your tests.
...
**Step 1:** Clone the <BrandName />’s [php-laravel-dusk-todo](https://github.com/<BrandName />/php-laravel-dusk-todo) and navigate to the code directory as shown below:
```bash
git clone https://github.com/TestMu AI/php-laravel-dusk-todo
