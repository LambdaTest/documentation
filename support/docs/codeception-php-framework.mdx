...
>**Note:** All the code samples in this documentation can be found in the [Codeception <BrandName /> Repository on  GitHub](https://github.com/<BrandName />/codeception-selenium-sample). You can either download or clone the repository to quickly run your tests.
...
**Step 1:** Clone the <BrandName />’s [codeception-selenium-sample repository](https://github.com/<BrandName />/codeception-selenium-sample) and navigate to the code directory as shown below:
```bash
git clone https://github.com/TestMu AI/codeception-selenium-sample
...
modules:
    enabled:
        - WebDriver:
            url: 'https://testmu ai.github.io/sample-todo-app/'
