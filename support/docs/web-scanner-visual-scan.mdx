...
keywords: ["lambdatest", "web scanner", "visual ui scan", "smartui config"]
---
...
![Visual Scan Purpose](/assets/images/web-scanner/visual-scan-config-purpose.png)
...
![Visual Scan Default Settings](/assets/images/web-scanner/visual-scan-default-settings.png)
...
![Visual Scan Advanced Options](/assets/images/web-scanner/visual-scan-advanced-options.png)
...
**Note:**
 ...
 Using a SmartUI config bypasses manual browser, resolution, and delay selections, even in the "Edit Config" mode.
</Warning>
...
![Visual Build](/assets/images/web-scanner/visual-build.png)

### Build Status
Easily track the state of each screenshot — **Approved**, **Changes Found**, **New**, **Under Review**, and more.

![Build Status View](/assets/images/web-scanner/threedot-visual.png)

### Three-Dot Menu Options
Access additional functions for your build:

![Three Dot Menu](/assets/images/web-scanner/history-page.png)
...
2. **Edit Scan Config**  
   ...
   ![Edit Scan Config](/assets/images/web-scanner/editscan-visual.png)

   ![Edit Scan Schedule](/assets/images/web-scanner/editscan-schedule.png)
