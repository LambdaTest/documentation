...
description: Learn Puppeteer Visual Regression Set up SmartUI, run tests on <BrandName /> Cloud across 40+ browsers. Step-by-step guide for seamless testing.
...
1. Please clone the following sample GitHub repo (`https://github.com/<BrandName />/puppeteer-sample`).

```bash
git clone https://github.com/<BrandName />/puppeteer-sample.git
```
