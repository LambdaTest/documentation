...
sidebarTitle: "Storybook Integration"
...
Install required NPM modules for `TestMu AI SmartUI StoryBook CLI` in your **Frontend** project.
...
![cmd](/assets/images/smart-visual-testing/smartui-project-token.png)
...
#### Custom Viewport Configuration <span style={{border: '1px solid #bf3989', color: '#bf3989', borderRadius: '1em', padding: '0.1em 0.5em', fontWeight: 'bold', fontSize: '0.8em', marginLeft: '0.5em', verticalAlign: 'middle', display: 'inline-block'}}>NEW</span>
...
![cmd](/assets/images/smart-visual-testing/smartui-storybook-results.webp)
