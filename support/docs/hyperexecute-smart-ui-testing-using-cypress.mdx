---
title: "SmartUI Tests in HyperExecute using Cypress"
...
![cmd](/assets/images/hyperexecute/integration/lt-products/smart-ui/cypress/1.png)

- Click on **Compare** button to compare the changes made.

![cmd](/assets/images/hyperexecute/integration/lt-products/smart-ui/cypress/2.png)
