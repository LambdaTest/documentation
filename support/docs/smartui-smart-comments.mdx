...
![Comment icon on screenshot](/assets/images/smart-visual-testing/smart-comments/comment_icon.png)

**Comment indicators:**
- Comment icon with count in the screenshot header
- Comment count badge showing total comments for that screenshot

![Comment tag in screenshot header](/assets/images/smart-visual-testing/smart-comments/commenttag_screenshotheader.png)

### 2. Build Level

Comments can be viewed at the build level, showing the total count of comments across all screenshots in the build.

![Comment tag at build level](/assets/images/smart-visual-testing/smart-comments/commenttag_build.png)
...
![Comment drawer with all comments](/assets/images/smart-visual-testing/smart-comments/comment_drawer.png)
---
...
![Comment textbox in screenshot drawer](/assets/images/smart-visual-testing/smart-comments/firstcomment_textbox.png)
...
![Comment posted successfully](/assets/images/smart-visual-testing/smart-comments/firstcomment_posted.png)
...
![Optional comment in Accept modal](/assets/images/smart-visual-testing/smart-comments/optionalcomment_accept.png)
...
![Optional comment in Accept All modal](/assets/images/smart-visual-testing/smart-comments/optionalcomment_acceptall.png)

#### Reject Modal

Add comments when rejecting screenshots:

![Optional comment in Reject modal](/assets/images/smart-visual-testing/smart-comments/optionalcomment_reject.png')
...
![Comment box in bulk operations](/assets/images/smart-visual-testing/smart-comments/optionalcomment_customselection.png)
...
![Auto-saved draft in textbox](/assets/images/smart-visual-testing/smart-comments/autosaveddraft_textbox.png)

If you write a comment in the Accept modal but close it, the draft is saved.

**2. Draft in Reject Modal:**
![Auto-saved draft in Reject modal](/assets/images/smart-visual-testing/smart-comments/autoasveddraft_reject.png)

**3. Draft in Multiselect:**
![Auto-saved draft in multiselect](/assets/images/smart-visual-testing/smart-comments/autosaveddraft_multiselect.png)
...
<Note>
NOTE
Drafts are session-based and will be cleared when you refresh the page or start a new session.
</Note>
...
![Using @mention in comments](/assets/images/smart-visual-testing/smart-comments/at_mention.png)
...
![Threaded comment reply](/assets/images/smart-visual-testing/smart-comments/firstthreadcomment_textbox_posted.png)
...
![Unresolved comments state](/assets/images/smart-visual-testing/smart-comments/unresolved_state.png)
...
![Resolved comments state](/assets/images/smart-visual-testing/smart-comments/resolved_state.png)
...
![Comments in screenshot drawer](/assets/images/smart-visual-testing/smart-comments/commenttag_screenshotdrawer.png)
...
Comments are mapped to Screenshot IDs. When a screenshot is overwritten, the new screenshot has a different ID, so comments don't carry over.
</Note>
...
<Tabs>
<Tab ttitle='Use Mentions Strategically'>
