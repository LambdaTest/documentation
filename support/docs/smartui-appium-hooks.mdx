...
![Profile](/assets/images/smart-visual-testing/screenshot.webp)

### Cropped Screenshot

![Profile](/assets/images/smart-visual-testing/cropped_ss.jpg)
...
### For capturing full page screenshot in Native Apps <span style={{border: '1px solid #bf3989', color: '#bf3989', borderRadius: '1em', padding: '0.1em 0.5em', fontWeight: 'bold', fontSize: '0.8em', marginLeft: '0.5em', verticalAlign: 'middle', display: 'inline-block'}}>NEW</span>
...
<Tabs >
<Tab title ='Screenshots Not Captured' default>
