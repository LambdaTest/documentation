---
title: "Bamboo CI Integration with HyperExecute"
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/bamboo/1.png' alt="Image"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/bamboo/2.png' alt="Image"  className="doc_img"/>

- Now click on **Create Plan** button.

<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/bamboo/3.png' alt="Image"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/bamboo/4.png' alt="Image"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/bamboo/5.png' alt="Image"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/bamboo/6.png' alt="Image"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/bamboo/7.png' alt="Image"  className="doc_img"/>

- Select the **Script** option from the provided Task Types.

<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/bamboo/8.png' alt="Image"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/bamboo/9.png' alt="Image"  className="doc_img"/>

- Add the Task and click on **Create** button.

<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/bamboo/10.png' alt="Image"  className="doc_img"/>

- Configure the pipeline as per your need in the **Trigger** tab or leave it to *Default*

<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/bamboo/11.png' alt="Image"  className="doc_img"/>

- Click on **Actions** -> **Enable Plan** button.

<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/bamboo/12.png' alt="Image"  className="doc_img"/>

- Click on **Run** -> **Run plan** button.

<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/bamboo/13.png' alt="Image"  className="doc_img"/>

- Test will get triggered and start executing. You can check the activity status of your Job here.

<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/bamboo/14.png' alt="Image"  className="doc_img"/>

### Step 6: Check the Output

- Logs of the Job Build

<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/bamboo/15.png' alt="Image"  className="doc_img"/>

- Result on HyperExecute Dashboard

<img loading="lazy" src='/assets/images/hyperexecute/integration/ci-cd/bamboo/16.png' alt="Image"  className="doc_img"/>
