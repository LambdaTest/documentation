...
>**Note:** All the code samples in this documentation can be found in the [<BrandName />'s Repository on GitHub](https://github.com/<BrandName />/CSharp-NUnit-Selenium). You can either download or clone the repository to quickly run your tests.
...
**Step 1:** Clone the <BrandName />’s [CSharp-NUnit-Selenium repository](https://github.com/<BrandName />/CSharp-NUnit-Selenium) and navigate to the code directory as shown below:
```bash
git clone https://github.com/TestMu AI/CSharp-NUnit-Selenium
        ...
        {
            {
                ...
                driver.Value.Navigate().GoToUrl("https://testmu ai.github.io/sample-todo-app/");
