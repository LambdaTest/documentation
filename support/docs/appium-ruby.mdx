...
<GitHubButton url="https://github.com/LambdaTest/LT-appium-ruby" />
</Check>
...
```ruby title="ios.py" highlight={4,5,15}
require 'rubygems'
require 'appium_lib'
...
```ruby title="android.py" highlight={4,5,15}
require 'rubygems'
require 'appium_lib'
...
```ruby title="iOS(.ipa)" highlight={9}
 caps = {
            "LT:Options" => {
                :deviceName => "iPhone 13 Pro",  
                :platformName => "iOS",
...
<Accordion title="For Windows Users">
