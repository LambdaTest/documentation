...
keywords: ["lambdatest", "web scanner", "getting started", "schedule scan"]
---
...
![Web Scanner](/assets/images/web-scanner/unified-dashboard-controls.png)
...
![Schedule Scan Button](/assets/images/web-scanner/schedule-scan-button.png)
...
![Scan Creation Wizard Step 1](/assets/images/web-scanner/wizard-step-1-overview.png)
...
![Add URLs Manually](/assets/images/web-scanner/wizard-step-3-manual-url.png)

![Add URLs via Sitemap](/assets/images/web-scanner/wizard-step-3-sitemap-url.png)
...
![Scan Creation Wizard Step 4](/assets/images/web-scanner/wizard-step-4-schedule.png)
...
![Scheduled Scan on Dashboard](/assets/images/web-scanner/scheduled-scan-on-dashboard.png)
