...
keywords: ["smart ui testing in lambdatest", "smart ui testing in hyperexecute", "visual  ui testing,image to image comparison", "free cross browser testing tool", "regression testing tool", "perform visual ui testing online", "compare image to image", "internet explorer 9 browser test", "test on samsung a7 online", "test on mac 10.11 el capitan online", "apple mac el capitan virtual machine"]
---
...
![automation-dashboard](/assets/images/hyperexecute/integration/lt-products/smart-ui/playwright/1.png)

- This will redirect you the SmartUI dashboard where you can see all the images you have pushed for the testing.

![automation-dashboard](/assets/images/hyperexecute/integration/lt-products/smart-ui/playwright/2.png)
...
![automation-dashboard](/assets/images/hyperexecute/integration/lt-products/smart-ui/playwright/3.png)
...
![automation-dashboard](/assets/images/hyperexecute/integration/lt-products/smart-ui/playwright/4.png)
...
![automation-dashboard](/assets/images/hyperexecute/integration/lt-products/smart-ui/playwright/5.png)