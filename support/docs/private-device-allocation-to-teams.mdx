...
keywords: ['private device', 'private decive allocation to teams', 'real device', 'virtual device']
---
...
<Tab value="bulk" title="Bulk Distribute" default>
...
<Tab value="single" title="Uni Distribute" default>
