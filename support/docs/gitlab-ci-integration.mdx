...
Below is a sample config file for integrating GitLab CI with <BrandName />. You can use the sample file to test your own automation test suite by replacing the environment variables according to your need. All the code used for the demonstration of this topic can be find in our [GitHub repository](https://github.com/<BrandName />/protractor-selenium-sample-gitlab).
