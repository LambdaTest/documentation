...
<a href="https://github.com/<BrandName />/smartui-java-playwright-sample" className='github__anchor'><img loading="lazy" src='/assets/images/icons/github.png' alt="Image" /> View on GitHub</a>
</Tip>
...
```java reference
https://github.com/TestMu AI/smartui-java-playwright-sample/blob/main/src/test/java/com/testmu ai/SmartUISDKPlaywrightCloud.java
```
