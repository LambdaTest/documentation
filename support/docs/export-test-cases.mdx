...
<img loading="lazy" src='/assets/images/mobile-app-testing/bulk_export_testcases.jpeg' alt="export test cases "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/select-specifc-fields-export.png' alt="export test cases "  className="doc_img" width="1366" height="629"/>

This is how your exported CSV file would look like :

<img loading="lazy" src='/assets/images/mobile-app-testing/exported_csv.jpeg' alt="exported CSV "  className="doc_img" width="1366" height="629"/>
