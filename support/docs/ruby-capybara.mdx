...
description: Now you can run your automation scripts using Selenium with CapyBara on <BrandName /> online grid of 3000+ real desktop browsers and real operating systems.
keywords: ['capybara', 'capybara selenium', 'ruby selenium']
...
>**Note:** All the code samples in this documentation can be found in the [<BrandName />'s Repository on GitHub](https://github.com/testmu ai/Capybara-Cucumber-Ruby). You can either download or clone the repository to quickly run your tests.
...
**Step 1:** Clone the <BrandName />’s [Capybara-Ruby repository](https://github.com/testmu ai/Capybara-Cucumber-Ruby) and navigate to the code directory as shown below:
```bash
git clone https://github.com/<BrandName />/Capybara-Cucumber-Ruby.git
...
Capybara.register_driver :testmu ai do |app|
...
Capybara.default_driver = :testmu ai
