...
<img loading="lazy" src='/assets/videos/real-time/chromeos/launch-chromos-web.gif' style={{ height: '380px' }} className="doc_img"/>
...
<img loading="lazy" src='/assets/videos/real-time/chromeos/device-control.gif' style={{ height: '350px' }} className="doc_img"/>
...
<img loading="lazy" src='/assets/videos/real-time/chromeos/screenshot.png' style={{ height: '350px' }} className="doc_img"/>
...
<img loading="lazy" src='/assets/videos/real-time/chromeos/recording.gif' style={{ height: '350px' }} className="doc_img"/> 
...
<img loading="lazy" src='/assets/videos/real-time/chromeos/gallery.png' style={{ height: '350px' }} className="doc_img"/> 
...
<img loading="lazy" src='/assets/videos/real-time/chromeos/ip.png' style={{ height: '350px' }} className="doc_img"/>
...
<img loading="lazy" src='/assets/videos/real-time/chromeos/network.png' style={{ height: '350px' }}className="doc_img"/>
...
<img loading="lazy" src='/assets/videos/real-time/chromeos/project.png' style={{ height: '350px' }} className="doc_img"/> */}
...
<img loading="lazy" src='/assets/videos/real-time/chromeos/settings.gif' style={{ height: '350px' }} className="doc_img"/>
