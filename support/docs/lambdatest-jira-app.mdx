...
﻿---
id: testmu ai-jira-app
title: <BrandName /> Jira App
hide_title: true
sidebarTitle: <BrandName /> Jira App
description: Efficiently manage your tests with <BrandName /> Jira App, seamlessly integrating Test Manager capabilities into your Jira environment to enhance collaboration.
