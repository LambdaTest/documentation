---
title: "Running Capybara Framework Tests on HyperExecute"
sidebarTitle: "Capybara"
keywords: ['Capybara', 'Capybara selenium', 'Capybara automation testing', 'selenium webdriver Capybara', 'selenium Capybara testing tutorial', 'Capybara Selenium framework', 'lambdatest Capybara', 'frameworks on lambdatest', 'hyperexecute', 'hyperexecute Capybara testing', 'hyperexecute Capybara testing', 'hyperexecute automation testing', 'HyperExecute Selenium automation']
---
...
Download or Clone the code sample for the Capybara from the LambdaTest GitHub repository to run the tests on the HyperExecute.
