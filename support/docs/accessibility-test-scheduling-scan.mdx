...
![](/assets/images/accessibility-testing/schedule-scan/1.png)
...
![](/assets/images/accessibility-testing/schedule-scan/2.png)
...
![alt text](/assets/images/accessibility-testing/schedule-scan/3.2.png)

</Tab>

<Tab title="Add URLs Manually">
  - In the Add Pages field, input individual URLs. - Click Add for each URL.

![alt text](/assets/images/accessibility-testing/schedule-scan/3.1.png)

</Tab>

<Tab title="Upload URLs via CSV">
  - Prepare a CSV file with the list of URLs. - Click Upload CSV to import the
  file.

![alt text](/assets/images/accessibility-testing/schedule-scan/3.3.png)
...
![alt text](/assets/images/accessibility-testing/schedule-scan/3.4.png)
...
![alt text](/assets/images/accessibility-testing/schedule-scan/4.png)
...
![alt text](/assets/images/accessibility-testing/schedule-scan/5.png)
...
![alt text](/assets/images/accessibility-testing/schedule-scan/6.png)
