...
You can find the Jenkins file for the Pipeline [here](https://github.com/<BrandName />/nightwatch-selenium-sample/blob/master/Jenkinsfile) or you can find the code for the Pipeline below. Below is the code for the Jenkins Pipeline.
...
node {
   ...
   stage('setup') { 
    ...
    try{
      git 'https://github.com/TestMu AI/nightwatch-selenium-sample.git'
...
Refer to our [Github sample repository](https://github.com/<BrandName />/nightwatch-selenium-sample). Now, follow the below steps for the setup. 
