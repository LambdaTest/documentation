...
![add](/assets/images/redmine-integration/Screenshot-284.webp)
...
![api token](/assets/images/redmine-integration/Screenshot-292.webp)
...
![select a domain](/assets/images/redmine-integration/111111.webp)
...
![api access key](/assets/images/redmine-integration/Screenshot-307-1.webp)
</Warning>

**Step 5:** Then enter your **'Domain'** and paste the **'API Token'** into the field provided at Lambdatest & press the **'Install'** button.   

![install](/assets/images/redmine-integration/Screenshot-308.webp)   
...
![bug logging](/assets/images/redmine-integration/img1.webp)
...
![start](/assets/images/redmine-integration/img2.webp)
...
![screenshot](/assets/images/redmine-integration/Screenshot-296.webp)

**Step 4:** After a screenshot is captured, you can annotate any issue or a task with an **in-built image editor**. Once you are done highlighting the bug, click on the button that says **'Mark as Bug'**.

![mark as bug](/assets/images/redmine-integration/img3.webp)
...
![status](/assets/images/redmine-integration/Screenshot-287.webp)

**Step 2**: Mark the **‘Default value’** checkbox as checked and click on **‘Save’**.

![save](/assets/images/redmine-integration/Screenshot-288.webp)
...
![set as default](/assets/images/redmine-integration/Screenshot-289.webp)
...
![create issue](/assets/images/redmine-integration/Screenshot-290.webp)
...
![issue tracking](/assets/images/redmine-integration/issue-tracking.webp)

**Step 8:** To view the log bug details, navigate to **'Issues'**.

![issues](/assets/images/redmine-integration/issues.webp)

**Step 9:** Then click on the subject's name by navigating to **'Subject'**, that you have assigned while creating your ticket.

![subject](/assets/images/redmine-integration/subject.webp)
...
![data](/assets/images/redmine-integration/defect.webp)
...
![remove](/assets/images/redmine-integration/Screenshot-323.webp)
