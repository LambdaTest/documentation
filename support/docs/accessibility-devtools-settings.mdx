...
<Warning> Click on your **profile icon** >> **Settings** button.</Warning>

![automation-dashboard](/assets/images/accessibility-testing/settings/1.png)
...
![automation-dashboard](/assets/images/accessibility-testing/settings/4.png)
...
![automation-dashboard](/assets/images/accessibility-testing/settings/5.png)
...
![automation-dashboard](/assets/images/accessibility-testing/settings/6.png)
...
<Warning>**Note :** By default, this option is activated.</Warning>

- Toggle to activate / deactivate the option.
- This option ensures that your tests are consistently saved on the dashboard.

![automation-dashboard](/assets/images/accessibility-testing/settings/3.png)
