---
title: "Running NUnit Framework Tests on HyperExecute"
sidebarTitle: "NUnit"
keywords: ['NUnit', 'NUnit selenium', 'NUnit C# Selenium', 'NUnit automation testing', 'selenium webdriver NUnit', 'selenium NUnit testing tutorial', 'NUnit C# Selenium framework', 'lambdatest NUnit', 'frameworks on lambdatest', 'hyperexecute', 'hyperexecute NUnit testing', 'hyperexecute automation testing']
---
...
Download or Clone the code sample for the NUnit from the LambdaTest GitHub repository to run the tests on the HyperExecute.
...
<img loading="lazy" src="/assets/images/hyperexecute/frameworks/selenium/testng/cmd_1.png" alt="NUnit HyperExecute Terminal Logs" width="1920" height="868" className="doc_img"/>

<img loading="lazy" src="/assets/images/hyperexecute/frameworks/selenium/testng/cmd_2.png" alt="NUnit HyperExecute Terminal Logs" width="1920" height="868" className="doc_img"/>
