...
<img loading="lazy" src='/assets/images/integrating-mattermost-with-testmu ai/go-to-integrations.webp' alt="Select 'Integrations' " width="1923" height="863" />

**Step 3:** Hover to the 'Mattermost' block under "Communications" category, and click on "**Add**" button that appears.

<img loading="lazy" src='/assets/images/integrating-mattermost-with-testmu ai/hover-to-mattermost-and-click.webp' alt="Hover to the 'Mattermost' "  width="1024" height="472" />
...
<img loading="lazy" src='/assets/images/integrating-mattermost-with-testmu ai/Copy-the-incoming-webhook.webp' alt="copy the webhook URL"  width="1921" height="746" />
...
<img loading="lazy" src='/assets/images/integrating-mattermost-with-testmu ai/paste-the-webhook.webp' alt="Enter your **webhook URL" width="1921" height="869" />
...
<img loading="lazy" src='/assets/images/integrating-mattermost-with-testmu ai/Intergration-successful-message.webp' alt="Mattermost will be integrated"  width="510" height="157" />

**Step 7:** Voila! Go to Integrations tab again and you will see a Mattermost under "My Integrations".  
<img loading="lazy" src='/assets/images/integrating-mattermost-with-testmu ai/integration-successful-from-top.webp' alt="you will see a Mattermost under My Integrations"  width="1922" height="865" />
...
<img loading="lazy" src='/assets/images/integrating-mattermost-with-testmu ai/integration-successful-list.webp' alt="Green Tick"  width="1922" height="863" />
...
<img loading="lazy" src='/assets/images/integrating-mattermost-with-testmu ai/real-time-testing-1.webp' alt="Enter the URL of the web-app"  width="1348" height="609" />
...
<img loading="lazy" src='/assets/images/integrating-mattermost-with-testmu ai/select-mark-as-bug.webp' alt="Launch Tests" width="1920" height="865" />
...
<img loading="lazy" src='/assets/images/integrating-mattermost-with-testmu ai/highlight-and-mark-as-bug.webp' alt="A screenshot will be captured and appear on your screen"  width="1920" height="853" />
...
<img loading="lazy" src='/assets/images/integrating-mattermost-with-testmu ai/assign-and-create-issue.webp' alt="send the bug directly to Mattermost workspace" width="750" height="793" />
...
<img loading="lazy" src='/assets/images/integrating-mattermost-with-testmu ai/Bug-marked-message.webp' alt="Image"  width="484" height="178" />
...
<img loading="lazy" src='/assets/images/integrating-mattermost-with-testmu ai/issue-marked-in-mattermost-channel.webp' alt="Image" width="1904" height="845" />
...
<img loading="lazy" src='/assets/images/integrating-mattermost-with-testmu ai/remove-from-list.webp' alt="Image"  width="1920" height="848" />
