...
**Step 1:** Clone the <BrandName /> [python-selenium-sample repository](https://github.com/LambdaTest/python-selenium-sample) and navigate to the code directory as shown below:
```bash
