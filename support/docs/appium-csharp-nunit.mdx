...
sidebarTitle: "NUnit"
keywords: ['appium','csharp','c#','framework on testmu ai','NUNit','app testing','real devices']
---
...
<GitHubButton url="https://github.com/LambdaTest/LT-appium-csharp-nunit" />
</Check>
...
```csharp title="NUnitAppiumTests.cs" highlight={16,17,50,51}
using System;
