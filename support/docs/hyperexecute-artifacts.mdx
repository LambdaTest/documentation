...
<img loading="lazy" src='/assets/images/hyperexecute/features/artifacts-reports/artifacts.gif' alt="Image"  className="doc_img"/>

Here is the sample artifact generated.

<img loading="lazy" src='/assets/images/hyperexecute/features/artifacts-reports/artifact4.png' alt="Image"  className="doc_img"/>