...
<img loading="lazy" src='/assets/images/mobile-app-testing/rdapptesting/Startingstep.png' alt="Native Mobile App Testing"  className="doc_img" width="1366" height="629"/>

**Step 2**: Choose the OS version of your choice. ( Android or iOS )

<img loading="lazy" src='/assets/images/mobile-app-testing/rdapptesting/osofyourchoice.png' alt="Native Mobile App Testing"  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/rdapptesting/androidlaunch3.png' alt="Native Mobile App Testing"  className="doc_img" width="1366" height="629"/>

In the case of **iOS**, you can install from the App Store, Test Flight or from App Center. 

<img loading="lazy" src='/assets/images/mobile-app-testing/rdapptesting/ioslaunch3.png' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/rdapptesting/choosedeviceregion.png' alt="Real Device Region Feature"  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/rdapptesting/tunnellast.png' alt="Real Device Tunnel"  className="doc_img" width="1366" height="629"/>
