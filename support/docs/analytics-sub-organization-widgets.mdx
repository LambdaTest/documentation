...
The <span className="border-2 border-[#bf3989] text-[#bf3989] rounded-full px-2 py-0 font-bold text-[0.8em] ml-[0.5em] align-middle inline-block text-xs">BETA</span> features are available for limited users only. If you wish to try them out, please reach out to our [24/7 customer support](mailto:support@testmu.ai).
</Note>
