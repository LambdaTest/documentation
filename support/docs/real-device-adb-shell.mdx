---
title: Execute ADB shell commands
...
<img loading="lazy" src='/assets/images/real-device-app-testing/adbmanual.webp' alt="ADB Shell Access"  className="doc_img" width="1366" height="629"/>
