...
keywords: ['xcuitest', 'xcui result bundle', 'xcuitest report', 'xcuitest logs', 'lambdatest xcuitest', 'xcui xcresult', 'app testing', 'real devices', 'xcresult', 'xcui results', 'ios test results']
---
...
<img loading="lazy" src="/assets/images/real-device-app-testing/XCUI_image.png" alt="xcui-result-bundles" width="768" height="373" className="doc_img"/>
