...
<img loading="lazy" src='/assets/images/mobile-app-testing/firebase/vaibhavrox.png' alt="Real "  className="doc_img" width="1366" height="450"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/firebase/1photo.png' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/firebase-application-upload-steps.png' alt="Real "  className="doc_img" width="1366" height="629"/>

**Connect with credentials -** 
<img loading="lazy" src='/assets/images/mobile-app-testing/firebase/Animeshrox.png' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/firebase/3photo.png' alt="Real "  className="doc_img" width="1366" height="629"/>
<img loading="lazy" src='/assets/images/mobile-app-testing/firebase/1blurryblurry.png' alt="Real "  className="doc_img" width="1366" height="629"/>
<img loading="lazy" src='/assets/images/mobile-app-testing/firebase/2blurryblurry.png' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/firebase/6photo.png' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/firebase/Noblurlaststep.png' alt="Real "  className="doc_img" width="1366" height="629"/>



## Key Actions Overview 

<img loading="lazy" src='/assets/images/mobile-app-testing/firebase/Buttonexplanation.png' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/firebase/Noteaddemail.png' alt="Real "  className="doc_img" width="1366" height="450"/>
</Note>
