...
2. Open your testing project in Xcode.
 ...
 <img loading="lazy" src='/assets/images/troubleshoot-ios-testing/project-file.webp' alt="Integrating <BrandName /> With Testsigma" width="1281" height="722" className="doc_img"/>

3. Head to **File** and click **Show in Finder** option to open the .app file once your build runs successfully.

 <img loading="lazy" src='/assets/images/troubleshoot-ios-testing/show-in-finder.webp' alt="Integrating <BrandName /> With Testsigma" width="1281" height="722" className="doc_img"/>

4. Compress the `.app` file into a `.zip` file.

 <img loading="lazy" src='/assets/images/troubleshoot-ios-testing/zip-file.webp' alt="Integrating <BrandName /> With Testsigma" width="1281" height="722" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/troubleshoot-ios-testing/6.webp' alt="Integrating <BrandName /> With Testsigma" width="1281" height="722" className="doc_img"/>
</Note>
