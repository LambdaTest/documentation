---
title: "Running Vanilla Framework Tests on HyperExecute"
...
Download or Clone the code sample for the VanillaJs from the LambdaTest GitHub repository to run the tests on the HyperExecute.
