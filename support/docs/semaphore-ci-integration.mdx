...
Here is a sample config file for integrating your <BrandName /> account with your Semaphore CI instance. You can also find the below code at our [GitHub repository of Semaphore](https://github.com/<BrandName />/protractor-selenium-semaphore-sample).
