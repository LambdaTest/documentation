---
title: "Step 2: How to Associate the Test Cases"
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/products/azure-test-plan/step2/step1.png' alt="Image" className="doc_img" />

**Step 2:** Navigate to the Team Explorer view.

<img loading="lazy" src='/assets/images/hyperexecute/integration/products/azure-test-plan/step2/step2.png' alt="Image" className="doc_img" />
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/products/azure-test-plan/step2/step3.png' alt="Image" className="doc_img" />
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/products/azure-test-plan/step2/step4.png' alt="Image" className="doc_img" />

**Step 5:** Once connected, click on the **Test** menu, then **Test Explorer**.

<img loading="lazy" src='/assets/images/hyperexecute/integration/products/azure-test-plan/step2/step5.png' alt="Image" className="doc_img" />

**Step 6:** Inside the Test Explorer, select any test, right click and select **Associate to Test Case**.

<img loading="lazy" src='/assets/images/hyperexecute/integration/products/azure-test-plan/step2/step6.png' alt="Image" className="doc_img" />
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/products/azure-test-plan/step2/step7.png' alt="Image" className="doc_img" />
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/products/azure-test-plan/step2/step8.png' alt="Image" className="doc_img" />

Associated test cases will look like this:

<img loading="lazy" src='/assets/images/hyperexecute/integration/products/azure-test-plan/step2/step9.png' alt="Image" className="doc_img" />