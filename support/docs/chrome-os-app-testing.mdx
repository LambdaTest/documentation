...
<img loading="lazy" src='/assets/videos/real-time/chromeos-app/launch-chrome-app.gif' style={{ height: '380px' }} className="doc_img"/>
...
<img loading="lazy" src='/assets/videos/real-time/chromeos-app/device-control.gif' style={{ height: '350px' }} className="doc_img"/> 
...
<img loading="lazy" src='/assets/videos/real-time/chromeos-app/app-control.png' style={{ height: '350px' }} className="doc_img"/>
...
<img loading="lazy" src='/assets/videos/real-time/chromeos-app/screenshot.gif' style={{ height: '350px' }} className="doc_img"/>
...
<img loading="lazy" src='/assets/videos/real-time/chromeos-app/record-session.gif' style={{ height: '350px' }} className="doc_img"/>
...
<img loading="lazy" src='/assets/videos/real-time/chromeos-app/gallery.gif' style={{ height: '350px' }} className="doc_img"/>
...
<img loading="lazy" src='/assets/videos/real-time/chromeos-app/mark-bug.gif' style={{ height: '350px' }} className="doc_img"/>
...
<img loading="lazy" src='/assets/videos/real-time/chromeos-app/ip-location.png' style={{ height: '350px' }} className="doc_img"/>
...
<img loading="lazy" src='/assets/videos/real-time/chromeos-app/network.png' style={{ height: '350px' }} className="doc_img"/>
...
<img loading="lazy" src='/assets/videos/real-time/chromeos-app/projects.png' style={{ height: '350px' }} className="doc_img"/> */}
...
<img loading="lazy" src='/assets/videos/real-time/chromeos-app/setting.png' style={{ height: '350px' }} className="doc_img"/>
...
<img loading="lazy" src='/assets/videos/real-time/chromeos-app/switch.gif' style={{ height: '350px' }} className="doc_img"/>
...
<img loading="lazy" src='/assets/videos/real-time/chromeos-app/advance-tool.gif' style={{ height: '350px' }} className="doc_img"/>
