...
<video
  ...
  src="/assets/images/access-management/access-license-panel.mp4"
></video>
...
<video
  controls
  className="w-full aspect-video rounded-xl"
  src="/assets/images/access-management/allocate-licenses.mp4"
></video>
...
<Warning> The freed-up license will be available for reassignment. To assign it to another user, follow the [Assigning a License to a User](/support/docs/kaneai-test-manager-access-management/#assigning-a-license-to-a-user) steps. </Warning>

<video
  controls
  className="w-full aspect-video rounded-xl"
  src="/assets/images/access-management/revoke-license.mp4"
></video>