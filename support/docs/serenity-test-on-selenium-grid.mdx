---
title: "Selenium With Serenity BDD Tutorial"
...
<GitHubButton url="https://github.com/LambdaTest/Serenity-Selenium-Sample" />
</Check>
...
Below is the `LambdaTestSerenityDriver.java` file that shows the integration of Serenity with <BrandName />.

```java LambdaTestSerenityDriver.java
