...
```bash
git clone https://github.com/TestMu AI/junit-selenium-sample.git
...
"> 📁 **Sample File**: [`SmartuiPdfLocalTest.java`](https://github.com/<BrandName />/junit-selenium-sample/blob/master/src/test/java/com/smartuiPdf/SmartuiPdfLocalTest.java)
...
"> 📁 **Sample File**: [`SmartuiPdfCloudTest.java`](https://github.com/<BrandName />/junit-selenium-sample/blob/master/src/test/java/com/smartuiPdf/SmartuiPdfCloudTest.java)
