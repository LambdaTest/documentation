...
## 1. Cypress Detailed Command Logs for Enhanced Debugging <span style={{ backgroundColor: '#4CAF50', color: 'white', padding: '2px 8px', borderRadius: '12px', fontSize: '14px' }}>New Release</span>
...
<img loading="lazy" src='/assets/images/hyperexecute/release-notes/detailed-cypress-logs.png' alt="HyperExecute" />

<Note>
📕 Learn how to enable [Detailed Command Logs](/support/docs/cypress-detailed-command-logs/) for your Cypress tests.
</Note>

## 2. Parameterized Report Email Handling in YAML <span style={{ backgroundColor: '#FFC107', color: 'white', padding: '2px 8px', borderRadius: '12px', fontSize: '14px' }}>Enhancement</span>
...
## 3. Browser and Selenium Updates for Linux, Windows, and macOS <span style={{ backgroundColor: '#4CAF50', color: 'white', padding: '2px 8px', borderRadius: '12px', fontSize: '14px' }}>New Release</span>
