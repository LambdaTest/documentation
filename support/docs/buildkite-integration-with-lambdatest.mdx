---
title: "Triggering tests from Buildkite CI/CD to Lambdatest"
...
![Create pipeline in Buildkite](/assets/images/buildkite-integration/create-pipeline.png)
...
![Connect repository. Add name and description.](/assets/images/buildkite-integration/connect-repository.png)
...
![Add username and accesskey](/assets/images/buildkite-integration/username-accesskey.png)
...
![Add steps](/assets/images/buildkite-integration/add-steps.png)
...
![Add agent](/assets/images/buildkite-integration/agent.png)
...
![Create and run a build](/assets/images/buildkite-integration/create-build.png)

![Build details on Automation Dashboard](/assets/images/buildkite-integration/dashboard.png)
...
![settings page](/assets/images/buildkite-integration/yaml/1.png)
...
![settings page](/assets/images/buildkite-integration/yaml/2.png)
...
![settings page](/assets/images/buildkite-integration/yaml/3.png)
