...
<a href="https://github.com/<BrandName />/LT-detox" className="github__anchor"><img loading="lazy" src='/assets/images/icons/github.png' alt="Image" /> View on GitHub</a>
</Tip>
...
https://github.com/TestMu AI/LT-detox/blob/main/yaml/hyperexecute.yaml
```
