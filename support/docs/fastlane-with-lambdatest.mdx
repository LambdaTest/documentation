...
keywords: [ "fastlane plugin", "lambdatest integrations with ci/cd tools", "continuous integration", "lambdatest fastlane plugin", ]
---
...
![add](/assets/images/fastlane/lambdatest_creds.png)
