...
<img loading="lazy" src="/assets/images/selenium/live-interaction1.png" alt="cmd" width="768" height="373" className="doc_img"/>

<img loading="lazy" src="/assets/images/selenium/live-interaction2.png" alt="cmd" width="768" height="373" className="doc_img"/>
