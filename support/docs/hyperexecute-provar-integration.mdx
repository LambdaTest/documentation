...
<img loading="lazy" src='/assets/images/hyperexecute/integration/products/provar/1.png' alt="provide access to <BrandName /> account" width="1280" height="684" className="doc_img"/>

- Click on **Test Settings** >> **Browser Providers** section. Click on the **+** symbol to add a new Browser Provider.

<img loading="lazy" src='/assets/images/hyperexecute/integration/products/provar/2.png' alt="provide access to <BrandName /> account" width="1280" height="684" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/products/provar/3.png' alt="provide access to <BrandName /> account" width="1280" height="684" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/integration/products/provar/4.png' alt="provide access to <BrandName /> account" width="1280" height="684" className="doc_img" />