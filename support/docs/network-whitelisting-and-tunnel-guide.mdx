...
<Warning> These are Inbound and Outbound with respect to user's network. </Warning>
...
<Warning> Refer to [<BrandName /> Public IP](/support/docs/lambdatest-public-ip/) for list for the IP addresses. </Warning>
