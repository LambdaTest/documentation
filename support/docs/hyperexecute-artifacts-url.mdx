...
<img loading="lazy" src='/assets/images/hyperexecute/features/artifacts-reports/0.png' alt="Image"  className="doc_img"/>

### For a Single file

If you only have one file as an _Artifact_, then a preview of the file will be opened on your browser. 

<img loading="lazy" src='/assets/images/hyperexecute/features/artifacts-reports/1.png' alt="Image"  className="doc_img"/>

### For Multiple files

If you have multiple files as an _Artifact_, then you will get an option to download all the files directly.

<img loading="lazy" src='/assets/images/hyperexecute/features/artifacts-reports/4.png' alt="Image"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/features/artifacts-reports/3.png' alt="Image"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/features/artifacts-reports/5.png' alt="Image"  className="doc_img"/>
...
<img loading="lazy" src='/assets/images/hyperexecute/features/artifacts-reports/6.png' alt="Image"  className="doc_img"/>
