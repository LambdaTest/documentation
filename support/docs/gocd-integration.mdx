...
1. Copy the YAML configuration file from our [GitHub repository for GoCD](https://github.com/<BrandName />/nightwatch-gocd-sample/blob/master/nightwatch-gocd-sample.gocd.yaml).
...
**Step 3:** Provide the [<BrandName /> GitHub repository for GoCD](https://github.com/<BrandName />/nightwatch-gocd-sample) as the repository URL. Test you connection and provide a label for this repository. In our case, we have provided the label as Sample-Pipeline, you may keep something else for your instance.
