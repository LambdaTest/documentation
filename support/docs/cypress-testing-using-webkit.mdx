---
title: "Cypress Testing Using WebKit"
sidebarTitle: "Cypress Testing Using WebKit"
keywords: ['cypress webkit', 'cypress webkit testing', 'cypress safari', 'cypress lambdatest']
---
...
Before we get started, make sure to clone the **LambdaTest's sample Cypress Cloud repo**, used in this document. [View on GitHub](https://github.com/LambdaTest/Cypress-Cloud)
