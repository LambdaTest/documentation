...
<a href="https://github.com/<BrandName />/Java-TestNG-Selenium" className="github__anchor" target="_blank"><img loading="lazy" src='/assets/images/icons/github.png' alt="Image" /> View on GitHub</a>
</Tip>

```bash
git clone https://github.com/TestMu AI/java-testng-selenium
