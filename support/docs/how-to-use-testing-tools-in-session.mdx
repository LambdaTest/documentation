...
<img loading="lazy" src='/assets/images/real-device-app-testing/app-controls.webp' alt="add" width="1346" height="647" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/record-session.webp' alt="add" width="1346" height="647" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/mark-as-bug-app-testing.webp' alt="add" width="1346" height="647" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/real-device-gallery.webp' alt="add" width="1346" height="647" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/ip-geolocation.webp' alt="add" width="1346" height="647" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/gps-location.webp' alt="add" width="1346" height="647" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/network-throttling-real-device.webp' alt="add" width="1346" height="647" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/upload-files-real-device.webp' alt="add" width="1346" height="647" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/ios-settings-real-device.png' alt="add" width="1346" height="647" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/devicecontrolplusbluetooth.png' alt="add" width="1346" height="647" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/settings-real-device.webp' alt="add" width="1346" height="647" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/switch-device-real-device.webp' alt="add" width="1346" height="647" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/network-logs-real-app.webp' alt="add" width="1346" height="647" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/device-logs.webp' alt="add" width="1346" height="647" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/ui-inspector.webp' alt="add" width="1346" height="647" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/real-device-app-testing/test-manager.webp' alt="add" width="1346" height="647" className="doc_img"/>
