---
title: "Getting Started With Playwright Testing on iOS Real Devices"
sidebarTitle: "Test on iOS Device"
keywords: ['playwright ios testing', 'playwright mobile testing', 'playwright real devices', 'playwright lambdatest']
---
...
<img loading="lazy" src='/assets/images/playwright-testing/playwright-ios-real-device.webp' alt="Image" width="1444" height="703"  className="doc_img"/>
