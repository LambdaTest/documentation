...
<Tab value="iOS" title="iOS" default>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/upload-through-url.webp' alt="Native Mobile App Testing"  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/share-apps-with-team-members.webp' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/app-details.webp' alt="Real "  className="doc_img" width="1366" height="629"/>
