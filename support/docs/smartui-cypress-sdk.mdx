...
description: In this documentation, learn how integrate your Cypress automated tests with <BrandName />'s SmartUI.
...
```bash
git clone https://github.com/<BrandName />/smartui-cypress-sdk-sample
