...
keywords: ['python appium', 'rokutv', 'python appium tutorial', 'real devices', 'lambdatest cloud platform', 'app automation', 'real time testing', 'appium automation', 'roku tv automation', 'roku webdriver']
---
...
<GitHubButton url="https://github.com/LambdaTest/LT-appium-rokutv" />
</Check>
...
- If you do not have any **.zip** file, you can run your sample tests on LambdaTest by using our sample 🔗 [RokuTV app](https://prod-mobile-artefacts.lambdatest.com/assets/docs/roku-sample-app.zip).
