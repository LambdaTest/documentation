...
## Sample Test Case 
***
All the code samples in this documentation can be found in the [AngularJS <BrandName /> Repository on GitHub](https://github.com/<BrandName />/angular-karma-sample). You can either download or clone the repository to quickly run your tests.
...
**Step 4:** Clone the <BrandName />’s [angular-karma-sample repository](https://github.com/<BrandName />/angular-karma-sample) and navigate to the code directory as shown below:
```bash
git clone https://github.com/TestMu AI/angular-karma-sample
...
## Run Your First Test
***
Navigate to the directory where you cloned the [sample of Karma-Angular](https://github.com/<BrandName />/angular-karma-sample) and run the following command.
```bash
