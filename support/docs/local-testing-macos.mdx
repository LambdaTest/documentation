...
![tunnel configuration for testing on macos](/assets/images/local-testing-macos/local-mac-1.webp)
...
![extracting the binary zip file](/assets/images/local-testing-macos/local-mac-2.webp)
...
![Establishing Tunnel Connection](/assets/images/local-testing-macos/local-mac-3.webp)
...
![Xampp Starting](/assets/images/local-testing-macos/w11.webp)
...
![Realtime Testing with LambdaTest](/assets/images/local-testing-macos/local-mac-5.webp)
...
![Realtime Testing on macOS](/assets/images/local-testing-macos/local-mac-6.webp)

Once you press the **‘Start’**  button, your test will start and you will be navigated to your localhost URL.

![loalhost testing on macos](/assets/images/local-testing-macos/local-mac-7.webp)
...
![ssh tunnel configuration](/assets/images/local-testing-macos/local-mac-8.webp)

**Step 2:**  Click on **‘Folder’**  button and copy the string on your system’s clipboard.

![setting up localhost testing for mac machine](/assets/images/local-testing-macos/local-mac-9.webp)
...
![localhost realtime testing](/assets/images/local-testing-macos/local-mac-10.webp)
...
![local page testing environment](assets/images/local-testing-macos/folder2.webp)
...
![stopping ssh tunnel](/assets/images/local-testing-macos/local-mac-12.webp)
...
![Terminate tunnel connection](/assets/images/local-testing-macos/local-mac-13.webp)
...
![Generating Access Key](/assets/images/local-testing-macos/local-mac-14.webp)
...
![access key for tunnel](/assets/images/local-testing-macos/local-mac-15.webp)

You can also find your Access Key by going to **‘Settings’**  in the left navigation menu and routing to **‘Profile’**.

![Access key in account settings](/assets/images/local-testing-macos/local-mac-16.webp)
