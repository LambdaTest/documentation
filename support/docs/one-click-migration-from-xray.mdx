...
sidebarTitle: "One Click Migration from X-Ray"
---
...
<img loading="lazy" src='/assets/images/xray-migration/enter-credentials.png' alt="enter-xray-credentials" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/xray-migration/migration-results.png' alt="migration-results" width="1366" height="629"/>
...
<Info>
**Test Data Migration:** Test Data from X-Ray steps is migrated as a single textarea custom field at the test case level, with textual data consolidated together. This is because Test Manager does not currently support a step-level Test Data field.
</Info>
