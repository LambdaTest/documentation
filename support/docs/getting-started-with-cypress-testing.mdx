...
hide_title: true
description: In this documentation, learn how to perform end-to-end Cypress testing on the <BrandName /> Automation Cloud across 40+ browser versions.
...
```bash
git clone https://github.com/<BrandName />/Cypress-Cloud.git
cd Cypress-Cloud
```
