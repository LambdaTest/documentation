...
<img loading="lazy" src='/assets/images/analytics/test-case-health-snapshot.webp' alt="cmd" width="800" height="400" className="doc_img"/>
...
<img loading="lazy" src='/assets/images/analytics/test-cases-view.webp' alt="cmd" width="800" height="400" className="doc_img"/>
