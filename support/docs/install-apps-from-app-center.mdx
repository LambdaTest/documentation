...
<img loading="lazy" src='/assets/images/mobile-app-testing/install-from-app-center.webp' alt="Real "  className="doc_img" width="1366" height="629"/>
...
<img loading="lazy" src='/assets/images/mobile-app-testing/api-token.webp' alt="Real "  className="doc_img" width="1366" height="629"/>
