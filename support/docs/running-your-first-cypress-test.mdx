...
To demonstrate Cypress testing on the <BrandName /> platform, we will use the [Cypress Cloud repo](https://github.com/<BrandName />/Cypress-Cloud) in the demo below.

**Step-1:** Clone the [<BrandName />-Cypress Cloud](https://github.com/<BrandName />/Cypress-Cloud) GitHub repo and switch to the cloned directory.
